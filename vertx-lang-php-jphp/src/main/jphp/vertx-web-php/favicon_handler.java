...
public class FaviconHandler extends BaseWrapper<FaviconHandler>{
  ...
  this.handle = function(event) {
    ...
    if (__args.length === 1 && typeof __args[0] === 'object' && __args[0]._jdel) {
      j_faviconHandler.handle(event._jdel);
...
FaviconHandler.create = function() {
  ...
  if (__args.length === 0) {
    ...
    return utils.convReturnVertxGen(FaviconHandler, JFaviconHandler.create(__args[0]));
  }else if (__args.length === 1 && typeof __args[0] ==='number') {
    return utils.convReturnVertxGen(FaviconHandler, JFaviconHandler.create(__args[0]));
  }else if (__args.length === 2 && typeof __args[0] === 'string' && typeof __args[1] ==='number') {
    return utils.convReturnVertxGen(FaviconHandler, JFaviconHandler.create(__args[0], __args[1]));
  } else throw new TypeError('function invoked with invalid arguments');
};
