...
public class RockerTemplateEngine extends BaseWrapper<RockerTemplateEngine>{
  ...
  this.render = function() {
    ...
    if (__args.length === 3 && typeof __args[0] === 'object' && __args[0]._jdel && typeof __args[1] === 'string' && typeof __args[2] === 'function') {
      j_rockerTemplateEngine.render(__args[0]._jdel, __args[1], function(ar) {
      if (ar.succeeded()) {
      ...
      j_rockerTemplateEngine.render(__args[0]._jdel, __args[1], __args[2], function(ar) {
      if (ar.succeeded()) {
  ...
  this.isCachingEnabled = function() {
    var __args = arguments;
    if (__args.length === 0) {
      return j_rockerTemplateEngine.isCachingEnabled();
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.setExtension = function(extension) {
    ...
    if (__args.length === 1 && typeof __args[0] === 'string') {
      j_rockerTemplateEngine.setExtension(extension);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.setMaxCacheSize = function(maxCacheSize) {
    ...
    if (__args.length === 1 && typeof __args[0] ==='number') {
      j_rockerTemplateEngine.setMaxCacheSize(maxCacheSize);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
...
RockerTemplateEngine._jclass = utils.getJavaClass("io.vertx.ext.web.templ.RockerTemplateEngine");
RockerTemplateEngine._jtype = {
  accept: function(obj) {
...
RockerTemplateEngine._create = function(jdel) {
  var obj = Object.create(RockerTemplateEngine.prototype, {});
  RockerTemplateEngine.apply(obj, arguments);
  return obj;
}
/**
 ...
 @memberof module:vertx-web-js/rocker_template_engine
