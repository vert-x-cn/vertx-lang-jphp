...
public class FreeMarkerTemplateEngine extends BaseWrapper<FreeMarkerTemplateEngine>{
  ...
  this.render = function() {
    ...
    if (__args.length === 3 && typeof __args[0] === 'object' && __args[0]._jdel && typeof __args[1] === 'string' && typeof __args[2] === 'function') {
      j_freeMarkerTemplateEngine.render(__args[0]._jdel, __args[1], function(ar) {
      if (ar.succeeded()) {
      ...
      j_freeMarkerTemplateEngine.render(__args[0]._jdel, __args[1], __args[2], function(ar) {
      if (ar.succeeded()) {
  ...
  this.isCachingEnabled = function() {
    var __args = arguments;
    if (__args.length === 0) {
      return j_freeMarkerTemplateEngine.isCachingEnabled();
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.setExtension = function(extension) {
    ...
    if (__args.length === 1 && typeof __args[0] === 'string') {
      j_freeMarkerTemplateEngine.setExtension(extension);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.setMaxCacheSize = function(maxCacheSize) {
    ...
    if (__args.length === 1 && typeof __args[0] ==='number') {
      j_freeMarkerTemplateEngine.setMaxCacheSize(maxCacheSize);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
