...
public class LanguageHeader extends BaseWrapper<LanguageHeader>{
  ...
  this.parameter = function(key) {
    ...
    if (__args.length === 1 && typeof __args[0] === 'string') {
      return j_languageHeader.parameter(key);
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.isMatchedBy = function(matchTry) {
    ...
    if (__args.length === 1 && typeof __args[0] === 'object' && __args[0]._jdel) {
      return j_languageHeader.isMatchedBy(matchTry._jdel);
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.subtag = function() {
    ...
    if (__args.length === 0) {
      ...
      return j_languageHeader.subtag(__args[0]);
    } else throw new TypeError('function invoked with invalid arguments');
  };
