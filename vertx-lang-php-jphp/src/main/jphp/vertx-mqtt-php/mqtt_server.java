...
public class MqttServer extends BaseWrapper<MqttServer>{
  ...
  this.listen = function() {
    ...
    if (__args.length === 0) {
      ...
      j_mqttServer.listen(__args[0]);
      return that;
    }  else if (__args.length === 1 && typeof __args[0] === 'function') {
      j_mqttServer.listen(function(ar) {
      if (ar.succeeded()) {
      ...
      j_mqttServer.listen(__args[0], __args[1]);
      return that;
    }  else if (__args.length === 2 && typeof __args[0] ==='number' && typeof __args[1] === 'function') {
      j_mqttServer.listen(__args[0], function(ar) {
      if (ar.succeeded()) {
      ...
      j_mqttServer.listen(__args[0], __args[1], function(ar) {
      if (ar.succeeded()) {
  ...
  this.endpointHandler = function(handler) {
    ...
    if (__args.length === 1 && typeof __args[0] === 'function') {
      j_mqttServer.endpointHandler(function(jVal) {
  ...
  this.exceptionHandler = function(handler) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'function') {
      j_mqttServer.exceptionHandler(function(jVal) {
  ...
  this.close = function() {
    ...
    if (__args.length === 0) {
      ...
      j_mqttServer.close(function(ar) {
      if (ar.succeeded()) {
        __args[0](null, null);
      } else {
        __args[0](null, ar.cause());
...
MqttServer.create = function() {
  ...
  if (__args.length === 1 && typeof __args[0] === 'object' && __args[0]._jdel) {
    return utils.convReturnVertxGen(MqttServer, JMqttServer.create(__args[0]._jdel));
  }else if (__args.length === 2 && typeof __args[0] === 'object' && __args[0]._jdel && (typeof __args[1] === 'object' && __args[1] != null)) {
    return utils.convReturnVertxGen(MqttServer, JMqttServer.create(__args[0]._jdel, __args[1] != null ? new MqttServerOptions(new JsonObject(Java.asJSONCompatible(__args[1]))) : null));
  } else throw new TypeError('function invoked with invalid arguments');
};
