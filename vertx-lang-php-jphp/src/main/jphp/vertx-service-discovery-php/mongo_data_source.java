...
public class MongoDataSource extends BaseWrapper<MongoDataSource>{
...
MongoDataSource.createRecord = function(name, location, metadata) {
  ...
  if (__args.length === 3 && typeof __args[0] === 'string' && (typeof __args[1] === 'object' && __args[1] != null) && (typeof __args[2] === 'object' && __args[2] != null)) {
    return utils.convReturnDataObject(JMongoDataSource.createRecord(name, utils.convParamJsonObject(location), utils.convParamJsonObject(metadata)));
...
MongoDataSource.getMongoClient = function() {
  ...
  if (__args.length === 3 && typeof __args[0] === 'object' && __args[0]._jdel && (typeof __args[1] === 'object' && __args[1] != null) && typeof __args[2] === 'function') {
    JMongoDataSource.getMongoClient(__args[0]._jdel, utils.convParamJsonObject(__args[1]), function(ar) {
    if (ar.succeeded()) {
    ...
    JMongoDataSource.getMongoClient(__args[0]._jdel, function(jVal) {
    ...
    JMongoDataSource.getMongoClient(__args[0]._jdel, utils.convParamJsonObject(__args[1]), utils.convParamJsonObject(__args[2]), function(ar) {
    if (ar.succeeded()) {
