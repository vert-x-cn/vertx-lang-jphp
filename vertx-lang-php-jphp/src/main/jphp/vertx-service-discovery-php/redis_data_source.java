...
public class RedisDataSource extends BaseWrapper<RedisDataSource>{
...
RedisDataSource.createRecord = function(name, location, metadata) {
  ...
  if (__args.length === 3 && typeof __args[0] === 'string' && (typeof __args[1] === 'object' && __args[1] != null) && (typeof __args[2] === 'object' && __args[2] != null)) {
    return utils.convReturnDataObject(JRedisDataSource.createRecord(name, utils.convParamJsonObject(location), utils.convParamJsonObject(metadata)));
...
RedisDataSource.getRedisClient = function() {
  ...
  if (__args.length === 3 && typeof __args[0] === 'object' && __args[0]._jdel && (typeof __args[1] === 'object' && __args[1] != null) && typeof __args[2] === 'function') {
    JRedisDataSource.getRedisClient(__args[0]._jdel, utils.convParamJsonObject(__args[1]), function(ar) {
    if (ar.succeeded()) {
    ...
    JRedisDataSource.getRedisClient(__args[0]._jdel, function(jVal) {
    ...
    JRedisDataSource.getRedisClient(__args[0]._jdel, utils.convParamJsonObject(__args[1]), utils.convParamJsonObject(__args[2]), function(ar) {
    if (ar.succeeded()) {
