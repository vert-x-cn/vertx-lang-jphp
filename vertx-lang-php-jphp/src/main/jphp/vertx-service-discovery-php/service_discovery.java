...
public class ServiceDiscovery extends BaseWrapper<ServiceDiscovery>{
  ...
  this.getReference = function(record) {
    ...
    if (__args.length === 1 && (typeof __args[0] === 'object' && __args[0] != null)) {
      return utils.convReturnVertxGen(ServiceReference, j_serviceDiscovery.getReference(record != null ? new Record(new JsonObject(Java.asJSONCompatible(record))) : null));
  ...
  this.getReferenceWithConfiguration = function(record, configuration) {
    ...
    if (__args.length === 2 && (typeof __args[0] === 'object' && __args[0] != null) && (typeof __args[1] === 'object' && __args[1] != null)) {
      return utils.convReturnVertxGen(ServiceReference, j_serviceDiscovery.getReferenceWithConfiguration(record != null ? new Record(new JsonObject(Java.asJSONCompatible(record))) : null, utils.convParamJsonObject(configuration)));
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.release = function(reference) {
    ...
    if (__args.length === 1 && typeof __args[0] === 'object' && __args[0]._jdel) {
      return j_serviceDiscovery.release(reference._jdel);
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.registerServiceImporter = function() {
    ...
    if (__args.length === 2 && typeof __args[0] === 'object' && __args[0]._jdel && (typeof __args[1] === 'object' && __args[1] != null)) {
      return utils.convReturnVertxGen(ServiceDiscovery, j_serviceDiscovery.registerServiceImporter(__args[0]._jdel, utils.convParamJsonObject(__args[1])));
      ...
      return utils.convReturnVertxGen(ServiceDiscovery, j_serviceDiscovery.registerServiceImporter(__args[0]._jdel, utils.convParamJsonObject(__args[1]), function(ar) {
      if (ar.succeeded()) {
        __args[2](null, null);
      } else {
  ...
  this.registerServiceExporter = function() {
    var __args = arguments;
    if (__args.length === 2 && typeof __args[0] === 'object' && __args[0]._jdel && (typeof __args[1] === 'object' && __args[1] != null)) {
      return utils.convReturnVertxGen(ServiceDiscovery, j_serviceDiscovery.registerServiceExporter(__args[0]._jdel, utils.convParamJsonObject(__args[1])));
    }  else if (__args.length === 3 && typeof __args[0] === 'object' && __args[0]._jdel && (typeof __args[1] === 'object' && __args[1] != null) && typeof __args[2] === 'function') {
      return utils.convReturnVertxGen(ServiceDiscovery, j_serviceDiscovery.registerServiceExporter(__args[0]._jdel, utils.convParamJsonObject(__args[1]), function(ar) {
      if (ar.succeeded()) {
        __args[2](null, null);
      } else {
        __args[2](null, ar.cause());
  ...
  this.publish = function(record, resultHandler) {
    ...
    if (__args.length === 2 && (typeof __args[0] === 'object' && __args[0] != null) && typeof __args[1] === 'function') {
      j_serviceDiscovery.publish(record != null ? new Record(new JsonObject(Java.asJSONCompatible(record))) : null, function(ar) {
      if (ar.succeeded()) {
  ...
  this.unpublish = function(id, resultHandler) {
    ...
    if (__args.length === 2 && typeof __args[0] === 'string' && typeof __args[1] === 'function') {
      j_serviceDiscovery.unpublish(id, function(ar) {
      if (ar.succeeded()) {
  ...
  this.getRecord = function() {
    var __args = arguments;
    if (__args.length === 2 && (typeof __args[0] === 'object' && __args[0] != null) && typeof __args[1] === 'function') {
      j_serviceDiscovery.getRecord(utils.convParamJsonObject(__args[0]), function(ar) {
      if (ar.succeeded()) {
      ...
      j_serviceDiscovery.getRecord(function(jVal) {
  ...
  this.getRecords = function() {
    var __args = arguments;
    if (__args.length === 2 && (typeof __args[0] === 'object' && __args[0] != null) && typeof __args[1] === 'function') {
      j_serviceDiscovery.getRecords(utils.convParamJsonObject(__args[0]), function(ar) {
      if (ar.succeeded()) {
      ...
      j_serviceDiscovery.getRecords(function(jVal) {
      var jRet = __args[0](utils.convReturnDataObject(jVal));
      return jRet;
    }, function(ar) {
      if (ar.succeeded()) {
  ...
  this.update = function(record, resultHandler) {
    var __args = arguments;
    if (__args.length === 2 && (typeof __args[0] === 'object' && __args[0] != null) && typeof __args[1] === 'function') {
      j_serviceDiscovery.update(record != null ? new Record(new JsonObject(Java.asJSONCompatible(record))) : null, function(ar) {
      if (ar.succeeded()) {
        resultHandler(utils.convReturnDataObject(ar.result()), null);
      } else {
        resultHandler(null, ar.cause());
...
ServiceDiscovery.create = function() {
  var __args = arguments;
  if (__args.length === 1 && typeof __args[0] === 'object' && __args[0]._jdel) {
    return utils.convReturnVertxGen(ServiceDiscovery, JServiceDiscovery.create(__args[0]._jdel));
  }else if (__args.length === 2 && typeof __args[0] === 'object' && __args[0]._jdel && (typeof __args[1] === 'object' && __args[1] != null)) {
    return utils.convReturnVertxGen(ServiceDiscovery, JServiceDiscovery.create(__args[0]._jdel, __args[1] != null ? new ServiceDiscoveryOptions(new JsonObject(Java.asJSONCompatible(__args[1]))) : null));
  }else if (__args.length === 2 && typeof __args[0] === 'object' && __args[0]._jdel && typeof __args[1] === 'function') {
    return utils.convReturnVertxGen(ServiceDiscovery, JServiceDiscovery.create(__args[0]._jdel, function(jVal) {
    __args[1](utils.convReturnVertxGen(ServiceDiscovery, jVal));
  }));
  }else if (__args.length === 3 && typeof __args[0] === 'object' && __args[0]._jdel && (typeof __args[1] === 'object' && __args[1] != null) && typeof __args[2] === 'function') {
    return utils.convReturnVertxGen(ServiceDiscovery, JServiceDiscovery.create(__args[0]._jdel, __args[1] != null ? new ServiceDiscoveryOptions(new JsonObject(Java.asJSONCompatible(__args[1]))) : null, function(jVal) {
...
ServiceDiscovery.releaseServiceObject = function(discovery, svcObject) {
  ...
  if (__args.length === 2 && typeof __args[0] === 'object' && __args[0]._jdel && typeof __args[1] !== 'function') {
    JServiceDiscovery.releaseServiceObject(discovery._jdel, utils.convParamTypeUnknown(svcObject));
  } else throw new TypeError('function invoked with invalid arguments');
};
