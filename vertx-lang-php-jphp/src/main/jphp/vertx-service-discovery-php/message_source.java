...
public class MessageSource extends BaseWrapper<MessageSource>{
...
MessageSource.createRecord = function() {
  ...
  if (__args.length === 2 && typeof __args[0] === 'string' && typeof __args[1] === 'string') {
    return utils.convReturnDataObject(JMessageSource.createRecord(__args[0], __args[1]));
  }else if (__args.length === 3 && typeof __args[0] === 'string' && typeof __args[1] === 'string' && typeof __args[2] === 'string') {
    return utils.convReturnDataObject(JMessageSource.createRecord(__args[0], __args[1], __args[2]));
    ...
    return utils.convReturnDataObject(JMessageSource.createRecord(__args[0], __args[1], __args[2], utils.convParamJsonObject(__args[3])));
...
MessageSource.getConsumer = function() {
  ...
  if (__args.length === 3 && typeof __args[0] === 'object' && __args[0]._jdel && (typeof __args[1] === 'object' && __args[1] != null) && typeof __args[2] === 'function') {
    JMessageSource.getConsumer(__args[0]._jdel, utils.convParamJsonObject(__args[1]), function(ar) {
    if (ar.succeeded()) {
    ...
    JMessageSource.getConsumer(__args[0]._jdel, function(jVal) {
