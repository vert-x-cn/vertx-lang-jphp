...
public class ServiceReference extends BaseWrapper<ServiceReference>{
  ...
  this.getAs = function(x) {
    ...
    if (__args.length === 1 && typeof __args[0] === 'function') {
      return utils.get_jtype(__args[0]).wrap(j_serviceReference.getAs(utils.get_jclass(x)));
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.cachedAs = function(x) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'function') {
      return utils.get_jtype(__args[0]).wrap(j_serviceReference.cachedAs(utils.get_jclass(x)));
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.isHolding = function(object) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] !== 'function') {
      return j_serviceReference.isHolding(utils.convParamTypeUnknown(object));
    } else throw new TypeError('function invoked with invalid arguments');
  };
