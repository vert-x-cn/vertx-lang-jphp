...
public class ConfigRetriever extends BaseWrapper<ConfigRetriever>{
  ...
  this.getConfig = function(completionHandler) {
    ...
    if (__args.length === 1 && typeof __args[0] === 'function') {
      j_configRetriever.getConfig(function(ar) {
      if (ar.succeeded()) {
  ...
  this.listen = function(listener) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'function') {
      j_configRetriever.listen(function(jVal) {
...
ConfigRetriever.create = function() {
  ...
  if (__args.length === 1 && typeof __args[0] === 'object' && __args[0]._jdel) {
    return utils.convReturnVertxGen(ConfigRetriever, JConfigRetriever.create(__args[0]._jdel));
  }else if (__args.length === 2 && typeof __args[0] === 'object' && __args[0]._jdel && (typeof __args[1] === 'object' && __args[1] != null)) {
    return utils.convReturnVertxGen(ConfigRetriever, JConfigRetriever.create(__args[0]._jdel, __args[1] != null ? new ConfigRetrieverOptions(new JsonObject(Java.asJSONCompatible(__args[1]))) : null));
  } else throw new TypeError('function invoked with invalid arguments');
};
...
ConfigRetriever.getConfigAsFuture = function(retriever) {
  var __args = arguments;
  if (__args.length === 1 && typeof __args[0] === 'object' && __args[0]._jdel) {
    return utils.convReturnVertxGen(Future, JConfigRetriever.getConfigAsFuture(retriever._jdel), undefined);
  } else throw new TypeError('function invoked with invalid arguments');
};
