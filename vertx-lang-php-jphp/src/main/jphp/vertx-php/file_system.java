...
public class FileSystem extends BaseWrapper<FileSystem>{
  ...
  this.copy = function() {
    ...
    if (__args.length === 3 && typeof __args[0] === 'string' && typeof __args[1] === 'string' && typeof __args[2] === 'function') {
      j_fileSystem.copy(__args[0], __args[1], function(ar) {
      if (ar.succeeded()) {
        __args[2](null, null);
      } else {
      ...
      j_fileSystem.copy(__args[0], __args[1], __args[2] != null ? new CopyOptions(new JsonObject(Java.asJSONCompatible(__args[2]))) : null, function(ar) {
      if (ar.succeeded()) {
        __args[3](null, null);
      } else {
  ...
  this.move = function() {
    var __args = arguments;
    if (__args.length === 3 && typeof __args[0] === 'string' && typeof __args[1] === 'string' && typeof __args[2] === 'function') {
      j_fileSystem.move(__args[0], __args[1], function(ar) {
      if (ar.succeeded()) {
        __args[2](null, null);
      } else {
        __args[2](null, ar.cause());
      ...
      j_fileSystem.move(__args[0], __args[1], __args[2] != null ? new CopyOptions(new JsonObject(Java.asJSONCompatible(__args[2]))) : null, function(ar) {
      if (ar.succeeded()) {
        __args[3](null, null);
      } else {
        __args[3](null, ar.cause());
  ...
  this.props = function(path, handler) {
    ...
    if (__args.length === 2 && typeof __args[0] === 'string' && typeof __args[1] === 'function') {
      ...
      if (ar.succeeded()) {
        handler(utils.convReturnVertxGen(FileProps, ar.result()), null);
      } else {
        handler(null, ar.cause());
      }
    });
  ...
  this.propsBlocking = function(path) {
    ...
    if (__args.length === 1 && typeof __args[0] === 'string') {
      return utils.convReturnVertxGen(FileProps, j_fileSystem.propsBlocking(path));
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.lpropsBlocking = function(path) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'string') {
      return utils.convReturnVertxGen(FileProps, j_fileSystem.lpropsBlocking(path));
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.readFileBlocking = function(path) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'string') {
      return utils.convReturnVertxGen(Buffer, j_fileSystem.readFileBlocking(path));
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.open = function(path, options, handler) {
    ...
    if (__args.length === 3 && typeof __args[0] === 'string' && (typeof __args[1] === 'object' && __args[1] != null) && typeof __args[2] === 'function') {
      j_fileSystem.open(path, options != null ? new OpenOptions(new JsonObject(Java.asJSONCompatible(options))) : null, function(ar) {
      if (ar.succeeded()) {
        handler(utils.convReturnVertxGen(AsyncFile, ar.result()), null);
      } else {
        handler(null, ar.cause());
      }
    });
  ...
  this.openBlocking = function(path, options) {
    ...
    if (__args.length === 2 && typeof __args[0] === 'string' && (typeof __args[1] === 'object' && __args[1] != null)) {
      return utils.convReturnVertxGen(AsyncFile, j_fileSystem.openBlocking(path, options != null ? new OpenOptions(new JsonObject(Java.asJSONCompatible(options))) : null));
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.fsProps = function(path, handler) {
    ...
    if (__args.length === 2 && typeof __args[0] === 'string' && typeof __args[1] === 'function') {
      ...
      if (ar.succeeded()) {
        handler(utils.convReturnVertxGen(FileSystemProps, ar.result()), null);
      } else {
        handler(null, ar.cause());
      }
    });
  ...
  this.fsPropsBlocking = function(path) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'string') {
      return utils.convReturnVertxGen(FileSystemProps, j_fileSystem.fsPropsBlocking(path));
    } else throw new TypeError('function invoked with invalid arguments');
  };
...
FileSystem._create = function(jdel) {
  var obj = Object.create(FileSystem.prototype, {});
  FileSystem.apply(obj, arguments);
  return obj;
}
