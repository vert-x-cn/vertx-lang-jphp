...
public class HttpClientRequest extends BaseWrapper<HttpClientRequest>{
  ...
  this.exceptionHandler = function(handler) {
    ...
    if (__args.length === 1 && (typeof __args[0] === 'function' || __args[0] == null)) {
      j_httpClientRequest.exceptionHandler(handler == null ? null : function(jVal) {
  ...
  this.write = function() {
    ...
    if (__args.length === 1 && typeof __args[0] === 'object' && __args[0]._jdel) {
      j_httpClientRequest.write(__args[0]._jdel);
      return that;
    }  else if (__args.length === 1 && typeof __args[0] === 'string') {
      j_httpClientRequest.write(__args[0]);
      return that;
    }  else if (__args.length === 2 && typeof __args[0] === 'string' && typeof __args[1] === 'string') {
      j_httpClientRequest.write(__args[0], __args[1]);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.setWriteQueueMaxSize = function(maxSize) {
    ...
    if (__args.length === 1 && typeof __args[0] ==='number') {
      j_httpClientRequest.setWriteQueueMaxSize(maxSize);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.drainHandler = function(handler) {
    var __args = arguments;
    if (__args.length === 1 && (typeof __args[0] === 'function' || __args[0] == null)) {
      j_httpClientRequest.drainHandler(handler);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.handler = function(handler) {
    var __args = arguments;
    if (__args.length === 1 && (typeof __args[0] === 'function' || __args[0] == null)) {
      j_httpClientRequest.handler(handler == null ? null : function(jVal) {
      handler(utils.convReturnVertxGen(HttpClientResponse, jVal));
    });
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.endHandler = function(endHandler) {
    var __args = arguments;
    if (__args.length === 1 && (typeof __args[0] === 'function' || __args[0] == null)) {
      j_httpClientRequest.endHandler(endHandler);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.setFollowRedirects = function(followRedirects) {
    ...
    if (__args.length === 1 && typeof __args[0] ==='boolean') {
      j_httpClientRequest.setFollowRedirects(followRedirects);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.setChunked = function(chunked) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] ==='boolean') {
      j_httpClientRequest.setChunked(chunked);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.setRawMethod = function(method) {
    ...
    if (__args.length === 1 && typeof __args[0] === 'string') {
      j_httpClientRequest.setRawMethod(method);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.setHost = function(host) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'string') {
      j_httpClientRequest.setHost(host);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.putHeader = function(name, value) {
    ...
    if (__args.length === 2 && typeof __args[0] === 'string' && typeof __args[1] === 'string') {
      j_httpClientRequest.putHeader(name, value);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.continueHandler = function(handler) {
    var __args = arguments;
    if (__args.length === 1 && (typeof __args[0] === 'function' || __args[0] == null)) {
      j_httpClientRequest.continueHandler(handler);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.sendHead = function() {
    ...
    if (__args.length === 0) {
      ...
      j_httpClientRequest.sendHead(function(jVal) {
  ...
  this.end = function() {
    ...
    if (__args.length === 0) {
      ...
      j_httpClientRequest.end(__args[0]);
    }  else if (__args.length === 1 && typeof __args[0] === 'object' && __args[0]._jdel) {
      j_httpClientRequest.end(__args[0]._jdel);
    }  else if (__args.length === 2 && typeof __args[0] === 'string' && typeof __args[1] === 'string') {
      j_httpClientRequest.end(__args[0], __args[1]);
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.setTimeout = function(timeoutMs) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] ==='number') {
      j_httpClientRequest.setTimeout(timeoutMs);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.pushHandler = function(handler) {
    ...
    if (__args.length === 1 && typeof __args[0] === 'function') {
      j_httpClientRequest.pushHandler(function(jVal) {
      handler(utils.convReturnVertxGen(HttpClientRequest, jVal));
    });
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.reset = function() {
    ...
    if (__args.length === 0) {
      ...
      return j_httpClientRequest.reset(__args[0]);
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.connectionHandler = function(handler) {
    var __args = arguments;
    if (__args.length === 1 && (typeof __args[0] === 'function' || __args[0] == null)) {
      j_httpClientRequest.connectionHandler(handler == null ? null : function(jVal) {
      handler(utils.convReturnVertxGen(HttpConnection, jVal));
    });
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.writeCustomFrame = function() {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'object' && __args[0]._jdel) {
      j_httpClientRequest.writeCustomFrame(__args[0]._jdel);
      return that;
    }  else if (__args.length === 3 && typeof __args[0] ==='number' && typeof __args[1] ==='number' && typeof __args[2] === 'object' && __args[2]._jdel) {
      j_httpClientRequest.writeCustomFrame(__args[0], __args[1], __args[2]._jdel);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
...
HttpClientRequest._create = function(jdel) {
  var obj = Object.create(HttpClientRequest.prototype, {});
  HttpClientRequest.apply(obj, arguments);
  return obj;
}
