...
public class HttpServerRequest extends BaseWrapper<HttpServerRequest>{
  ...
  this.exceptionHandler = function(handler) {
    ...
    if (__args.length === 1 && (typeof __args[0] === 'function' || __args[0] == null)) {
      j_httpServerRequest.exceptionHandler(handler == null ? null : function(jVal) {
  ...
  this.handler = function(handler) {
    var __args = arguments;
    if (__args.length === 1 && (typeof __args[0] === 'function' || __args[0] == null)) {
      j_httpServerRequest.handler(handler == null ? null : function(jVal) {
  ...
  this.getHeader = function(headerName) {
    ...
    if (__args.length === 1 && typeof __args[0] === 'string') {
      return j_httpServerRequest.getHeader(headerName);
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.getParam = function(paramName) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'string') {
      return j_httpServerRequest.getParam(paramName);
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.bodyHandler = function(bodyHandler) {
    var __args = arguments;
    if (__args.length === 1 && (typeof __args[0] === 'function' || __args[0] == null)) {
      j_httpServerRequest.bodyHandler(bodyHandler == null ? null : function(jVal) {
  ...
  this.uploadHandler = function(uploadHandler) {
    var __args = arguments;
    if (__args.length === 1 && (typeof __args[0] === 'function' || __args[0] == null)) {
      j_httpServerRequest.uploadHandler(uploadHandler == null ? null : function(jVal) {
  ...
  this.getFormAttribute = function(attributeName) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'string') {
      return j_httpServerRequest.getFormAttribute(attributeName);
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.customFrameHandler = function(handler) {
    ...
    if (__args.length === 1 && typeof __args[0] === 'function') {
      j_httpServerRequest.customFrameHandler(function(jVal) {
