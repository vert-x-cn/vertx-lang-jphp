...
public class CommandLine extends BaseWrapper<CommandLine>{
  ...
  this.getOptionValue = function(name) {
    ...
    if (__args.length === 1 && typeof __args[0] === 'string') {
      return utils.convReturnTypeUnknown(j_commandLine.getOptionValue(name));
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.getArgumentValue = function() {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'string') {
      return utils.convReturnTypeUnknown(j_commandLine.getArgumentValue(__args[0]));
  ...
  this.isFlagEnabled = function(name) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'string') {
      return j_commandLine.isFlagEnabled(name);
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.isOptionAssigned = function(option) {
    ...
    if (__args.length === 1 && (typeof __args[0] === 'object' && __args[0] != null)) {
      return j_commandLine.isOptionAssigned(option != null ? new Option(new JsonObject(Java.asJSONCompatible(option))) : null);
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.getRawValues = function(option) {
    var __args = arguments;
    if (__args.length === 1 && (typeof __args[0] === 'object' && __args[0] != null)) {
      return j_commandLine.getRawValues(option != null ? new Option(new JsonObject(Java.asJSONCompatible(option))) : null);
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.getRawValuesForOption = function(option) {
    var __args = arguments;
    if (__args.length === 1 && (typeof __args[0] === 'object' && __args[0] != null)) {
      return j_commandLine.getRawValuesForOption(option != null ? new Option(new JsonObject(Java.asJSONCompatible(option))) : null);
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.getRawValuesForArgument = function(argument) {
    var __args = arguments;
    if (__args.length === 1 && (typeof __args[0] === 'object' && __args[0] != null)) {
      return j_commandLine.getRawValuesForArgument(argument != null ? new Argument(new JsonObject(Java.asJSONCompatible(argument))) : null);
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.getRawValueForOption = function(option) {
    var __args = arguments;
    if (__args.length === 1 && (typeof __args[0] === 'object' && __args[0] != null)) {
      return j_commandLine.getRawValueForOption(option != null ? new Option(new JsonObject(Java.asJSONCompatible(option))) : null);
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.acceptMoreValues = function(option) {
    var __args = arguments;
    if (__args.length === 1 && (typeof __args[0] === 'object' && __args[0] != null)) {
      return j_commandLine.acceptMoreValues(option != null ? new Option(new JsonObject(Java.asJSONCompatible(option))) : null);
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.getRawValueForArgument = function(arg) {
    var __args = arguments;
    if (__args.length === 1 && (typeof __args[0] === 'object' && __args[0] != null)) {
      return j_commandLine.getRawValueForArgument(arg != null ? new Argument(new JsonObject(Java.asJSONCompatible(arg))) : null);
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.isArgumentAssigned = function(arg) {
    var __args = arguments;
    if (__args.length === 1 && (typeof __args[0] === 'object' && __args[0] != null)) {
      return j_commandLine.isArgumentAssigned(arg != null ? new Argument(new JsonObject(Java.asJSONCompatible(arg))) : null);
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.isSeenInCommandLine = function(option) {
    var __args = arguments;
    if (__args.length === 1 && (typeof __args[0] === 'object' && __args[0] != null)) {
      return j_commandLine.isSeenInCommandLine(option != null ? new Option(new JsonObject(Java.asJSONCompatible(option))) : null);
    } else throw new TypeError('function invoked with invalid arguments');
  };
...
CommandLine.create = function(cli) {
  ...
  if (__args.length === 1 && typeof __args[0] === 'object' && __args[0]._jdel) {
    return utils.convReturnVertxGen(CommandLine, JCommandLine.create(cli._jdel));
  } else throw new TypeError('function invoked with invalid arguments');
};
