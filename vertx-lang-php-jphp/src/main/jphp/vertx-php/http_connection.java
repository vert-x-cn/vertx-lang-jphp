...
public class HttpConnection extends BaseWrapper<HttpConnection>{
  ...
  this.setWindowSize = function(windowSize) {
    ...
    if (__args.length === 1 && typeof __args[0] ==='number') {
      j_httpConnection.setWindowSize(windowSize);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.goAwayHandler = function(handler) {
    ...
    if (__args.length === 1 && (typeof __args[0] === 'function' || __args[0] == null)) {
      j_httpConnection.goAwayHandler(handler == null ? null : function(jVal) {
  ...
  this.shutdownHandler = function(handler) {
    var __args = arguments;
    if (__args.length === 1 && (typeof __args[0] === 'function' || __args[0] == null)) {
      j_httpConnection.shutdownHandler(handler);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.shutdown = function() {
    ...
    if (__args.length === 0) {
      ...
      j_httpConnection.shutdown(__args[0]);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.closeHandler = function(handler) {
    ...
    if (__args.length === 1 && typeof __args[0] === 'function') {
      j_httpConnection.closeHandler(handler);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.updateSettings = function() {
    ...
    if (__args.length === 1 && (typeof __args[0] === 'object' && __args[0] != null)) {
      j_httpConnection.updateSettings(__args[0] != null ? new Http2Settings(new JsonObject(Java.asJSONCompatible(__args[0]))) : null);
      return that;
    }  else if (__args.length === 2 && (typeof __args[0] === 'object' && __args[0] != null) && typeof __args[1] === 'function') {
      j_httpConnection.updateSettings(__args[0] != null ? new Http2Settings(new JsonObject(Java.asJSONCompatible(__args[0]))) : null, function(ar) {
      if (ar.succeeded()) {
        __args[1](null, null);
      } else {
  ...
  this.remoteSettingsHandler = function(handler) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'function') {
      j_httpConnection.remoteSettingsHandler(function(jVal) {
      handler(utils.convReturnDataObject(jVal));
    });
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  ...
  this.ping = function(data, pongHandler) {
    ...
    if (__args.length === 2 && typeof __args[0] === 'object' && __args[0]._jdel && typeof __args[1] === 'function') {
      j_httpConnection.ping(data._jdel, function(ar) {
      if (ar.succeeded()) {
        pongHandler(utils.convReturnVertxGen(Buffer, ar.result()), null);
      } else {
  ...
  this.pingHandler = function(handler) {
    var __args = arguments;
    if (__args.length === 1 && (typeof __args[0] === 'function' || __args[0] == null)) {
      j_httpConnection.pingHandler(handler == null ? null : function(jVal) {
  ...
  this.exceptionHandler = function(handler) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'function') {
      j_httpConnection.exceptionHandler(function(jVal) {
...
HttpConnection._create = function(jdel) {
  var obj = Object.create(HttpConnection.prototype, {});
  HttpConnection.apply(obj, arguments);
  return obj;
}
