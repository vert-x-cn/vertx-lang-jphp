...
public class NetServer extends BaseWrapper<NetServer>{
  ...
  this.connectHandler = function(handler) {
    ...
    if (__args.length === 1 && (typeof __args[0] === 'function' || __args[0] == null)) {
      return utils.convReturnVertxGen(NetServer, j_netServer.connectHandler(handler == null ? null : function(jVal) {
      handler(utils.convReturnVertxGen(NetSocket, jVal));
    }));
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.listen = function() {
    ...
    if (__args.length === 0) {
      ...
      j_netServer.listen(__args[0]._jdel);
      return that;
      ...
      j_netServer.listen(__args[0]._jdel, function(ar) {
      if (ar.succeeded()) {
        __args[1](utils.convReturnVertxGen(NetServer, ar.result()), null);
      } else {
        __args[1](null, ar.cause());
  ...
  /**
   ...
   is passed to the {@link NetServer#connectHandler}, e.g during the TLS handshake.
  ...
  this.exceptionHandler = function(handler) {
    ...
    if (__args.length === 1 && typeof __args[0] === 'function') {
      j_netServer.exceptionHandler(function(jVal) {
...
NetServer._create = function(jdel) {
  var obj = Object.create(NetServer.prototype, {});
  NetServer.apply(obj, arguments);
  return obj;
}
