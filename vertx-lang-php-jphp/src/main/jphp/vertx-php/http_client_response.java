...
public class HttpClientResponse extends BaseWrapper<HttpClientResponse>{
  ...
  this.exceptionHandler = function(handler) {
    ...
    if (__args.length === 1 && (typeof __args[0] === 'function' || __args[0] == null)) {
      j_httpClientResponse.exceptionHandler(handler == null ? null : function(jVal) {
  ...
  this.handler = function(handler) {
    var __args = arguments;
    if (__args.length === 1 && (typeof __args[0] === 'function' || __args[0] == null)) {
      j_httpClientResponse.handler(handler == null ? null : function(jVal) {
  ...
  this.getHeader = function(headerName) {
    ...
    if (__args.length === 1 && typeof __args[0] === 'string') {
      return j_httpClientResponse.getHeader(headerName);
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.getTrailer = function(trailerName) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'string') {
      return j_httpClientResponse.getTrailer(trailerName);
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.customFrameHandler = function(handler) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'function') {
      j_httpClientResponse.customFrameHandler(function(jVal) {
...
HttpClientResponse._create = function(jdel) {
  var obj = Object.create(HttpClientResponse.prototype, {});
  HttpClientResponse.apply(obj, arguments);
  return obj;
}
