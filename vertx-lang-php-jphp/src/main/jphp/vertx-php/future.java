...
public class Future extends BaseWrapper<Future>{
  ...
  this.complete = function() {
    ...
    if (__args.length === 0) {
      ...
      j_future.complete(j_T.unwrap(__args[0]));
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.fail = function() {
    ...
    if (__args.length === 1 && typeof __args[0] === 'object') {
      j_future.fail(utils.convParamThrowable(__args[0]));
    }  else if (__args.length === 1 && typeof __args[0] === 'string') {
      j_future.fail(__args[0]);
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.tryComplete = function() {
    ...
    if (__args.length === 0) {
      ...
      return j_future.tryComplete(j_T.unwrap(__args[0]));
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.tryFail = function() {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'object') {
      return j_future.tryFail(utils.convParamThrowable(__args[0]));
    }  else if (__args.length === 1 && typeof __args[0] === 'string') {
      return j_future.tryFail(__args[0]);
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.compose = function() {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'function') {
      return utils.convReturnVertxGen(Future, j_future.compose(function(jVal) {
  ...
  this.map = function() {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'function') {
      return utils.convReturnVertxGen(Future, j_future.map(function(jVal) {
      var jRet = __args[0](j_T.wrap(jVal));
      return utils.convParamTypeUnknown(jRet);
    }), undefined);
    }  else if (__args.length === 1 && typeof __args[0] !== 'function') {
      return utils.convReturnVertxGen(Future, j_future.map(utils.convParamTypeUnknown(__args[0])), undefined);
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.recover = function(mapper) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'function') {
      return utils.convReturnVertxGen(Future, j_future.recover(function(jVal) {
  ...
  this.otherwise = function() {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'function') {
      return utils.convReturnVertxGen(Future, j_future.otherwise(function(jVal) {
      var jRet = __args[0](utils.convReturnThrowable(jVal));
      return j_T.unwrap(jRet);
    }), undefined);
    }  else if (__args.length === 1 && j_T.accept(__args[0])) {
      return utils.convReturnVertxGen(Future, j_future.otherwise(j_T.unwrap(__args[0])), undefined);
    } else throw new TypeError('function invoked with invalid arguments');
  };
...
Future.future = function() {
  ...
  if (__args.length === 0) {
    ...
    return utils.convReturnVertxGen(Future, JFuture.future(function(jVal) {
...
Future.succeededFuture = function() {
  ...
  if (__args.length === 0) {
    ...
    return utils.convReturnVertxGen(Future, JFuture.succeededFuture(utils.convParamTypeUnknown(__args[0])), undefined);
  } else throw new TypeError('function invoked with invalid arguments');
};
...
Future.failedFuture = function() {
  var __args = arguments;
  if (__args.length === 1 && typeof __args[0] === 'object') {
    return utils.convReturnVertxGen(Future, JFuture.failedFuture(utils.convParamThrowable(__args[0])), undefined);
  }else if (__args.length === 1 && typeof __args[0] === 'string') {
    return utils.convReturnVertxGen(Future, JFuture.failedFuture(__args[0]), undefined);
  } else throw new TypeError('function invoked with invalid arguments');
};
