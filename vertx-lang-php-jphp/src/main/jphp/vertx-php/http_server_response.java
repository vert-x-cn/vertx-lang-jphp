...
public class HttpServerResponse extends BaseWrapper<HttpServerResponse>{
  ...
  this.exceptionHandler = function(handler) {
    ...
    if (__args.length === 1 && (typeof __args[0] === 'function' || __args[0] == null)) {
      j_httpServerResponse.exceptionHandler(handler == null ? null : function(jVal) {
  ...
  this.write = function() {
    ...
    if (__args.length === 1 && typeof __args[0] === 'object' && __args[0]._jdel) {
      j_httpServerResponse.write(__args[0]._jdel);
      return that;
    }  else if (__args.length === 1 && typeof __args[0] === 'string') {
      j_httpServerResponse.write(__args[0]);
      return that;
    }  else if (__args.length === 2 && typeof __args[0] === 'string' && typeof __args[1] === 'string') {
      j_httpServerResponse.write(__args[0], __args[1]);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.setWriteQueueMaxSize = function(maxSize) {
    ...
    if (__args.length === 1 && typeof __args[0] ==='number') {
      j_httpServerResponse.setWriteQueueMaxSize(maxSize);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.drainHandler = function(handler) {
    var __args = arguments;
    if (__args.length === 1 && (typeof __args[0] === 'function' || __args[0] == null)) {
      j_httpServerResponse.drainHandler(handler);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.setStatusCode = function(statusCode) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] ==='number') {
      j_httpServerResponse.setStatusCode(statusCode);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.setStatusMessage = function(statusMessage) {
    ...
    if (__args.length === 1 && typeof __args[0] === 'string') {
      j_httpServerResponse.setStatusMessage(statusMessage);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.setChunked = function(chunked) {
    ...
    if (__args.length === 1 && typeof __args[0] ==='boolean') {
      j_httpServerResponse.setChunked(chunked);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.putHeader = function(name, value) {
    ...
    if (__args.length === 2 && typeof __args[0] === 'string' && typeof __args[1] === 'string') {
      j_httpServerResponse.putHeader(name, value);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.putTrailer = function(name, value) {
    var __args = arguments;
    if (__args.length === 2 && typeof __args[0] === 'string' && typeof __args[1] === 'string') {
      j_httpServerResponse.putTrailer(name, value);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.closeHandler = function(handler) {
    var __args = arguments;
    if (__args.length === 1 && (typeof __args[0] === 'function' || __args[0] == null)) {
      j_httpServerResponse.closeHandler(handler);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.endHandler = function(handler) {
    var __args = arguments;
    if (__args.length === 1 && (typeof __args[0] === 'function' || __args[0] == null)) {
      j_httpServerResponse.endHandler(handler);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.end = function() {
    ...
    if (__args.length === 0) {
      ...
      j_httpServerResponse.end(__args[0]);
    }  else if (__args.length === 1 && typeof __args[0] === 'object' && __args[0]._jdel) {
      j_httpServerResponse.end(__args[0]._jdel);
    }  else if (__args.length === 2 && typeof __args[0] === 'string' && typeof __args[1] === 'string') {
      j_httpServerResponse.end(__args[0], __args[1]);
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.sendFile = function() {
    ...
    if (__args.length === 1 && typeof __args[0] === 'string') {
      ...
      j_httpServerResponse.sendFile(__args[0], __args[1], __args[2]);
      return that;
    }  else if (__args.length === 3 && typeof __args[0] === 'string' && typeof __args[1] ==='number' && typeof __args[2] === 'function') {
      j_httpServerResponse.sendFile(__args[0], __args[1], function(ar) {
      if (ar.succeeded()) {
        __args[2](null, null);
      } else {
      ...
      j_httpServerResponse.sendFile(__args[0], __args[1], __args[2], function(ar) {
      if (ar.succeeded()) {
        __args[3](null, null);
      } else {
  ...
  this.headersEndHandler = function(handler) {
    var __args = arguments;
    if (__args.length === 1 && (typeof __args[0] === 'function' || __args[0] == null)) {
      j_httpServerResponse.headersEndHandler(handler);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.bodyEndHandler = function(handler) {
    var __args = arguments;
    if (__args.length === 1 && (typeof __args[0] === 'function' || __args[0] == null)) {
      j_httpServerResponse.bodyEndHandler(handler);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.push = function() {
    ...
    if (__args.length === 3 && typeof __args[0] === 'string' && typeof __args[1] === 'string' && typeof __args[2] === 'function') {
      j_httpServerResponse.push(io.vertx.core.http.HttpMethod.valueOf(__args[0]), __args[1], function(ar) {
      if (ar.succeeded()) {
      ...
      return utils.convReturnVertxGen(HttpServerResponse, j_httpServerResponse.push(io.vertx.core.http.HttpMethod.valueOf(__args[0]), __args[1], __args[2], function(ar) {
      if (ar.succeeded()) {
      ...
      return utils.convReturnVertxGen(HttpServerResponse, j_httpServerResponse.push(io.vertx.core.http.HttpMethod.valueOf(__args[0]), __args[1], __args[2]._jdel, function(ar) {
      if (ar.succeeded()) {
        __args[3](utils.convReturnVertxGen(HttpServerResponse, ar.result()), null);
      } else {
        __args[3](null, ar.cause());
      ...
      j_httpServerResponse.push(io.vertx.core.http.HttpMethod.valueOf(__args[0]), __args[1], __args[2], __args[3]._jdel, function(ar) {
      if (ar.succeeded()) {
  ...
  this.reset = function() {
    ...
    if (__args.length === 0) {
      ...
      j_httpServerResponse.reset(__args[0]);
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.writeCustomFrame = function() {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'object' && __args[0]._jdel) {
      j_httpServerResponse.writeCustomFrame(__args[0]._jdel);
      return that;
    }  else if (__args.length === 3 && typeof __args[0] ==='number' && typeof __args[1] ==='number' && typeof __args[2] === 'object' && __args[2]._jdel) {
      j_httpServerResponse.writeCustomFrame(__args[0], __args[1], __args[2]._jdel);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
