...
public class HttpServerFileUpload extends BaseWrapper<HttpServerFileUpload>{
  ...
  this.exceptionHandler = function(handler) {
    ...
    if (__args.length === 1 && (typeof __args[0] === 'function' || __args[0] == null)) {
      j_httpServerFileUpload.exceptionHandler(handler == null ? null : function(jVal) {
  ...
  this.handler = function(handler) {
    var __args = arguments;
    if (__args.length === 1 && (typeof __args[0] === 'function' || __args[0] == null)) {
      j_httpServerFileUpload.handler(handler == null ? null : function(jVal) {
  ...
  this.endHandler = function(endHandler) {
    var __args = arguments;
    if (__args.length === 1 && (typeof __args[0] === 'function' || __args[0] == null)) {
      j_httpServerFileUpload.endHandler(endHandler);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.streamToFileSystem = function(filename) {
    ...
    if (__args.length === 1 && typeof __args[0] === 'string') {
      j_httpServerFileUpload.streamToFileSystem(filename);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  /**
   ...
   @return {boolean} true if the size of the upload can be retrieved via {@link HttpServerFileUpload#size}.
   */
...
HttpServerFileUpload._create = function(jdel) {
  var obj = Object.create(HttpServerFileUpload.prototype, {});
  HttpServerFileUpload.apply(obj, arguments);
  return obj;
}
