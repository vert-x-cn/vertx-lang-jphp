...
public class HttpServer extends BaseWrapper<HttpServer>{
  ...
  this.requestHandler = function(handler) {
    ...
    if (__args.length === 1 && typeof __args[0] === 'function') {
      j_httpServer.requestHandler(function(jVal) {
      handler(utils.convReturnVertxGen(HttpServerRequest, jVal));
    });
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.connectionHandler = function(handler) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'function') {
      j_httpServer.connectionHandler(function(jVal) {
  ...
  this.exceptionHandler = function(handler) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'function') {
      j_httpServer.exceptionHandler(function(jVal) {
  ...
  this.websocketHandler = function(handler) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'function') {
      j_httpServer.websocketHandler(function(jVal) {
      handler(utils.convReturnVertxGen(ServerWebSocket, jVal));
    });
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.listen = function() {
    ...
    if (__args.length === 0) {
      ...
      j_httpServer.listen(__args[0], __args[1]);
      return that;
    }  else if (__args.length === 2 && typeof __args[0] ==='number' && typeof __args[1] === 'function') {
      j_httpServer.listen(__args[0], function(ar) {
      if (ar.succeeded()) {
      ...
      j_httpServer.listen(__args[0], __args[1], function(ar) {
      if (ar.succeeded()) {
...
HttpServer._create = function(jdel) {
  var obj = Object.create(HttpServer.prototype, {});
  HttpServer.apply(obj, arguments);
  return obj;
}
