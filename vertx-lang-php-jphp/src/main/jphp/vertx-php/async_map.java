...
public class AsyncMap extends BaseWrapper<AsyncMap>{
  ...
  this.get = function(k, resultHandler) {
    ...
    if (__args.length === 2 && j_K.accept(__args[0]) && typeof __args[1] === 'function') {
      j_asyncMap.get(j_K.unwrap(k), function(ar) {
      if (ar.succeeded()) {
  ...
  this.put = function() {
    ...
    if (__args.length === 3 && j_K.accept(__args[0]) && j_V.accept(__args[1]) && typeof __args[2] === 'function') {
      j_asyncMap.put(j_K.unwrap(__args[0]), j_V.unwrap(__args[1]), function(ar) {
      if (ar.succeeded()) {
        __args[2](null, null);
      } else {
      ...
      j_asyncMap.put(j_K.unwrap(__args[0]), j_V.unwrap(__args[1]), __args[2], function(ar) {
      if (ar.succeeded()) {
        __args[3](null, null);
      } else {
  ...
  this.putIfAbsent = function() {
    var __args = arguments;
    if (__args.length === 3 && j_K.accept(__args[0]) && j_V.accept(__args[1]) && typeof __args[2] === 'function') {
      j_asyncMap.putIfAbsent(j_K.unwrap(__args[0]), j_V.unwrap(__args[1]), function(ar) {
      if (ar.succeeded()) {
      ...
      j_asyncMap.putIfAbsent(j_K.unwrap(__args[0]), j_V.unwrap(__args[1]), __args[2], function(ar) {
      if (ar.succeeded()) {
  ...
  this.remove = function(k, resultHandler) {
    var __args = arguments;
    if (__args.length === 2 && j_K.accept(__args[0]) && typeof __args[1] === 'function') {
      j_asyncMap.remove(j_K.unwrap(k), function(ar) {
      if (ar.succeeded()) {
        resultHandler(j_V.wrap(ar.result()), null);
      } else {
        resultHandler(null, ar.cause());
  ...
  this.removeIfPresent = function(k, v, resultHandler) {
    var __args = arguments;
    if (__args.length === 3 && j_K.accept(__args[0]) && j_V.accept(__args[1]) && typeof __args[2] === 'function') {
      j_asyncMap.removeIfPresent(j_K.unwrap(k), j_V.unwrap(v), function(ar) {
      if (ar.succeeded()) {
  ...
  this.replace = function(k, v, resultHandler) {
    var __args = arguments;
    if (__args.length === 3 && j_K.accept(__args[0]) && j_V.accept(__args[1]) && typeof __args[2] === 'function') {
      j_asyncMap.replace(j_K.unwrap(k), j_V.unwrap(v), function(ar) {
      if (ar.succeeded()) {
        resultHandler(j_V.wrap(ar.result()), null);
      } else {
        resultHandler(null, ar.cause());
  ...
  this.replaceIfPresent = function(k, oldValue, newValue, resultHandler) {
    ...
    if (__args.length === 4 && j_K.accept(__args[0]) && j_V.accept(__args[1]) && j_V.accept(__args[2]) && typeof __args[3] === 'function') {
      j_asyncMap.replaceIfPresent(j_K.unwrap(k), j_V.unwrap(oldValue), j_V.unwrap(newValue), function(ar) {
      if (ar.succeeded()) {
        resultHandler(ar.result(), null);
      } else {
        resultHandler(null, ar.cause());
