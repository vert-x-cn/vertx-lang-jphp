...
public class WebSocketFrame extends BaseWrapper<WebSocketFrame>{
...
WebSocketFrame.binaryFrame = function(data, isFinal) {
  ...
  if (__args.length === 2 && typeof __args[0] === 'object' && __args[0]._jdel && typeof __args[1] ==='boolean') {
    return utils.convReturnVertxGen(WebSocketFrame, JWebSocketFrame.binaryFrame(data._jdel, isFinal));
  } else throw new TypeError('function invoked with invalid arguments');
};
...
WebSocketFrame.textFrame = function(str, isFinal) {
  ...
  if (__args.length === 2 && typeof __args[0] === 'string' && typeof __args[1] ==='boolean') {
    return utils.convReturnVertxGen(WebSocketFrame, JWebSocketFrame.textFrame(str, isFinal));
  } else throw new TypeError('function invoked with invalid arguments');
};
...
WebSocketFrame.pingFrame = function(data) {
  ...
  if (__args.length === 1 && typeof __args[0] === 'object' && __args[0]._jdel) {
    return utils.convReturnVertxGen(WebSocketFrame, JWebSocketFrame.pingFrame(data._jdel));
  } else throw new TypeError('function invoked with invalid arguments');
};
...
WebSocketFrame.pongFrame = function(data) {
  var __args = arguments;
  if (__args.length === 1 && typeof __args[0] === 'object' && __args[0]._jdel) {
    return utils.convReturnVertxGen(WebSocketFrame, JWebSocketFrame.pongFrame(data._jdel));
  } else throw new TypeError('function invoked with invalid arguments');
};
...
WebSocketFrame.continuationFrame = function(data, isFinal) {
  var __args = arguments;
  if (__args.length === 2 && typeof __args[0] === 'object' && __args[0]._jdel && typeof __args[1] ==='boolean') {
    return utils.convReturnVertxGen(WebSocketFrame, JWebSocketFrame.continuationFrame(data._jdel, isFinal));
  } else throw new TypeError('function invoked with invalid arguments');
};
