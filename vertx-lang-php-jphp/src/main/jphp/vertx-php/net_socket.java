...
public class NetSocket extends BaseWrapper<NetSocket>{
  ...
  this.end = function() {
    ...
    if (__args.length === 0) {
      ...
      j_netSocket.end(__args[0]._jdel);
  ...
  this.exceptionHandler = function(handler) {
    ...
    if (__args.length === 1 && (typeof __args[0] === 'function' || __args[0] == null)) {
      j_netSocket.exceptionHandler(handler == null ? null : function(jVal) {
  ...
  this.handler = function(handler) {
    var __args = arguments;
    if (__args.length === 1 && (typeof __args[0] === 'function' || __args[0] == null)) {
      j_netSocket.handler(handler == null ? null : function(jVal) {
  ...
  this.endHandler = function(endHandler) {
    var __args = arguments;
    if (__args.length === 1 && (typeof __args[0] === 'function' || __args[0] == null)) {
      j_netSocket.endHandler(endHandler);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.write = function() {
    ...
    if (__args.length === 1 && typeof __args[0] === 'object' && __args[0]._jdel) {
      j_netSocket.write(__args[0]._jdel);
      return that;
    }  else if (__args.length === 1 && typeof __args[0] === 'string') {
      j_netSocket.write(__args[0]);
      return that;
    }  else if (__args.length === 2 && typeof __args[0] === 'string' && typeof __args[1] === 'string') {
      j_netSocket.write(__args[0], __args[1]);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.setWriteQueueMaxSize = function(maxSize) {
    ...
    if (__args.length === 1 && typeof __args[0] ==='number') {
      j_netSocket.setWriteQueueMaxSize(maxSize);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.drainHandler = function(handler) {
    var __args = arguments;
    if (__args.length === 1 && (typeof __args[0] === 'function' || __args[0] == null)) {
      j_netSocket.drainHandler(handler);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.sendFile = function() {
    ...
    if (__args.length === 1 && typeof __args[0] === 'string') {
      ...
      j_netSocket.sendFile(__args[0], __args[1], __args[2]);
      return that;
    }  else if (__args.length === 3 && typeof __args[0] === 'string' && typeof __args[1] ==='number' && typeof __args[2] === 'function') {
      j_netSocket.sendFile(__args[0], __args[1], function(ar) {
      if (ar.succeeded()) {
        __args[2](null, null);
      } else {
      ...
      j_netSocket.sendFile(__args[0], __args[1], __args[2], function(ar) {
      if (ar.succeeded()) {
        __args[3](null, null);
      } else {
  ...
  this.closeHandler = function(handler) {
    var __args = arguments;
    if (__args.length === 1 && (typeof __args[0] === 'function' || __args[0] == null)) {
      j_netSocket.closeHandler(handler);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.upgradeToSsl = function() {
    ...
    if (__args.length === 1 && typeof __args[0] === 'function') {
      j_netSocket.upgradeToSsl(__args[0]);
      return that;
    }  else if (__args.length === 2 && typeof __args[0] === 'string' && typeof __args[1] === 'function') {
      j_netSocket.upgradeToSsl(__args[0], __args[1]);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
...
NetSocket._create = function(jdel) {
  var obj = Object.create(NetSocket.prototype, {});
  NetSocket.apply(obj, arguments);
  return obj;
}
