...
public class MultiMap extends BaseWrapper<MultiMap>{
...
MultiMap._create = function(jdel) {
  var obj = Object.create(MultiMap.prototype, {});
  MultiMap.apply(obj, arguments);
  return obj;
}
