...
public class Vertx extends BaseWrapper<Vertx>{
  ...
  this.createNetServer = function() {
    ...
    if (__args.length === 0) {
      ...
      return utils.convReturnVertxGen(NetServer, j_vertx.createNetServer(__args[0] != null ? new NetServerOptions(new JsonObject(Java.asJSONCompatible(__args[0]))) : null));
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.createNetClient = function() {
    ...
    if (__args.length === 0) {
      ...
      return utils.convReturnVertxGen(NetClient, j_vertx.createNetClient(__args[0] != null ? new NetClientOptions(new JsonObject(Java.asJSONCompatible(__args[0]))) : null));
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.createHttpServer = function() {
    ...
    if (__args.length === 0) {
      ...
      return utils.convReturnVertxGen(HttpServer, j_vertx.createHttpServer(__args[0] != null ? new HttpServerOptions(new JsonObject(Java.asJSONCompatible(__args[0]))) : null));
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.createHttpClient = function() {
    ...
    if (__args.length === 0) {
      ...
      return utils.convReturnVertxGen(HttpClient, j_vertx.createHttpClient(__args[0] != null ? new HttpClientOptions(new JsonObject(Java.asJSONCompatible(__args[0]))) : null));
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.createDatagramSocket = function() {
    ...
    if (__args.length === 0) {
      ...
      return utils.convReturnVertxGen(DatagramSocket, j_vertx.createDatagramSocket(__args[0] != null ? new DatagramSocketOptions(new JsonObject(Java.asJSONCompatible(__args[0]))) : null));
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.createDnsClient = function() {
    ...
    if (__args.length === 0) {
      ...
      return utils.convReturnVertxGen(DnsClient, j_vertx.createDnsClient(__args[0] != null ? new DnsClientOptions(new JsonObject(Java.asJSONCompatible(__args[0]))) : null));
    }  else if (__args.length === 2 && typeof __args[0] ==='number' && typeof __args[1] === 'string') {
      return utils.convReturnVertxGen(DnsClient, j_vertx.createDnsClient(__args[0], __args[1]));
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.timerStream = function(delay) {
    ...
    if (__args.length === 1 && typeof __args[0] ==='number') {
      return utils.convReturnVertxGen(TimeoutStream, j_vertx.timerStream(delay));
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.periodicStream = function(delay) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] ==='number') {
      return utils.convReturnVertxGen(TimeoutStream, j_vertx.periodicStream(delay));
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.deployVerticle = function() {
    ...
    if (__args.length === 1 && typeof __args[0] === 'string') {
      ...
      j_vertx.deployVerticle(__args[0], __args[1] != null ? new DeploymentOptions(new JsonObject(Java.asJSONCompatible(__args[1]))) : null);
    }  else if (__args.length === 3 && typeof __args[0] === 'string' && (typeof __args[1] === 'object' && __args[1] != null) && typeof __args[2] === 'function') {
      j_vertx.deployVerticle(__args[0], __args[1] != null ? new DeploymentOptions(new JsonObject(Java.asJSONCompatible(__args[1]))) : null, function(ar) {
      if (ar.succeeded()) {
  ...
  this.createSharedWorkerExecutor = function() {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'string') {
      return utils.convReturnVertxGen(WorkerExecutor, j_vertx.createSharedWorkerExecutor(__args[0]));
    }  else if (__args.length === 2 && typeof __args[0] === 'string' && typeof __args[1] ==='number') {
      return utils.convReturnVertxGen(WorkerExecutor, j_vertx.createSharedWorkerExecutor(__args[0], __args[1]));
    }  else if (__args.length === 3 && typeof __args[0] === 'string' && typeof __args[1] ==='number' && typeof __args[2] ==='number') {
      return utils.convReturnVertxGen(WorkerExecutor, j_vertx.createSharedWorkerExecutor(__args[0], __args[1], __args[2]));
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  /**
   ...
   @return {boolean} wether the native transport is used
   */
  ...
  this.exceptionHandler = function(handler) {
    ...
    if (__args.length === 1 && (typeof __args[0] === 'function' || __args[0] == null)) {
      j_vertx.exceptionHandler(handler == null ? null : function(jVal) {
...
Vertx.vertx = function() {
  ...
  if (__args.length === 0) {
    ...
    return utils.convReturnVertxGen(Vertx, JVertx.vertx(__args[0] != null ? new VertxOptions(new JsonObject(Java.asJSONCompatible(__args[0]))) : null));
  } else throw new TypeError('function invoked with invalid arguments');
};
...
Vertx.clusteredVertx = function(options, resultHandler) {
  ...
  if (__args.length === 2 && (typeof __args[0] === 'object' && __args[0] != null) && typeof __args[1] === 'function') {
    JVertx.clusteredVertx(options != null ? new VertxOptions(new JsonObject(Java.asJSONCompatible(options))) : null, function(ar) {
    if (ar.succeeded()) {
