...
public class EventBus extends BaseWrapper<EventBus>{
  ...
  this.send = function() {
    ...
    if (__args.length === 2 && typeof __args[0] === 'string' && typeof __args[1] !== 'function') {
      j_eventBus.send(__args[0], utils.convParamTypeUnknown(__args[1]));
      return that;
    }  else if (__args.length === 3 && typeof __args[0] === 'string' && typeof __args[1] !== 'function' && typeof __args[2] === 'function') {
      j_eventBus.send(__args[0], utils.convParamTypeUnknown(__args[1]), function(ar) {
      if (ar.succeeded()) {
      ...
      j_eventBus.send(__args[0], utils.convParamTypeUnknown(__args[1]), __args[2] != null ? new DeliveryOptions(new JsonObject(Java.asJSONCompatible(__args[2]))) : null);
      return that;
      ...
      j_eventBus.send(__args[0], utils.convParamTypeUnknown(__args[1]), __args[2] != null ? new DeliveryOptions(new JsonObject(Java.asJSONCompatible(__args[2]))) : null, function(ar) {
      if (ar.succeeded()) {
  ...
  this.publish = function() {
    var __args = arguments;
    if (__args.length === 2 && typeof __args[0] === 'string' && typeof __args[1] !== 'function') {
      j_eventBus.publish(__args[0], utils.convParamTypeUnknown(__args[1]));
      return that;
    }  else if (__args.length === 3 && typeof __args[0] === 'string' && typeof __args[1] !== 'function' && (typeof __args[2] === 'object' && __args[2] != null)) {
      j_eventBus.publish(__args[0], utils.convParamTypeUnknown(__args[1]), __args[2] != null ? new DeliveryOptions(new JsonObject(Java.asJSONCompatible(__args[2]))) : null);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.consumer = function() {
    ...
    if (__args.length === 1 && typeof __args[0] === 'string') {
      return utils.convReturnVertxGen(MessageConsumer, j_eventBus.consumer(__args[0]), undefined);
    }  else if (__args.length === 2 && typeof __args[0] === 'string' && typeof __args[1] === 'function') {
      return utils.convReturnVertxGen(MessageConsumer, j_eventBus.consumer(__args[0], function(jVal) {
  ...
  this.localConsumer = function() {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'string') {
      return utils.convReturnVertxGen(MessageConsumer, j_eventBus.localConsumer(__args[0]), undefined);
    }  else if (__args.length === 2 && typeof __args[0] === 'string' && typeof __args[1] === 'function') {
      return utils.convReturnVertxGen(MessageConsumer, j_eventBus.localConsumer(__args[0], function(jVal) {
      __args[1](utils.convReturnVertxGen(Message, jVal, undefined));
    }), undefined);
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.sender = function() {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'string') {
      return utils.convReturnVertxGen(MessageProducer, j_eventBus.sender(__args[0]), undefined);
    }  else if (__args.length === 2 && typeof __args[0] === 'string' && (typeof __args[1] === 'object' && __args[1] != null)) {
      return utils.convReturnVertxGen(MessageProducer, j_eventBus.sender(__args[0], __args[1] != null ? new DeliveryOptions(new JsonObject(Java.asJSONCompatible(__args[1]))) : null), undefined);
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.publisher = function() {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'string') {
      return utils.convReturnVertxGen(MessageProducer, j_eventBus.publisher(__args[0]), undefined);
    }  else if (__args.length === 2 && typeof __args[0] === 'string' && (typeof __args[1] === 'object' && __args[1] != null)) {
      return utils.convReturnVertxGen(MessageProducer, j_eventBus.publisher(__args[0], __args[1] != null ? new DeliveryOptions(new JsonObject(Java.asJSONCompatible(__args[1]))) : null), undefined);
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.addInterceptor = function(interceptor) {
    ...
    if (__args.length === 1 && typeof __args[0] === 'function') {
      return utils.convReturnVertxGen(EventBus, j_eventBus.addInterceptor(function(jVal) {
      interceptor(utils.convReturnVertxGen(SendContext, jVal));
    }));
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.removeInterceptor = function(interceptor) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'function') {
      return utils.convReturnVertxGen(EventBus, j_eventBus.removeInterceptor(function(jVal) {
      interceptor(utils.convReturnVertxGen(SendContext, jVal));
    }));
    } else throw new TypeError('function invoked with invalid arguments');
  };
...
EventBus._create = function(jdel) {
  var obj = Object.create(EventBus.prototype, {});
  EventBus.apply(obj, arguments);
  return obj;
}
