...
public class DatagramSocket extends BaseWrapper<DatagramSocket>{
  ...
  this.sender = function(port, host) {
    ...
    if (__args.length === 2 && typeof __args[0] ==='number' && typeof __args[1] === 'string') {
      return utils.convReturnVertxGen(WriteStream, j_datagramSocket.sender(port, host), Buffer._jtype);
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.handler = function(handler) {
    var __args = arguments;
    if (__args.length === 1 && (typeof __args[0] === 'function' || __args[0] == null)) {
      j_datagramSocket.handler(handler == null ? null : function(jVal) {
  ...
  this.exceptionHandler = function(handler) {
    var __args = arguments;
    if (__args.length === 1 && (typeof __args[0] === 'function' || __args[0] == null)) {
      j_datagramSocket.exceptionHandler(handler == null ? null : function(jVal) {
...
DatagramSocket._create = function(jdel) {
  var obj = Object.create(DatagramSocket.prototype, {});
  DatagramSocket.apply(obj, arguments);
  return obj;
}
