...
public class SendContext extends BaseWrapper<SendContext>{
  ...
  /**
   ...
   @return {Object} the value sent or published (before being processed by the codec)
   */
  this.sentBody = function() {
    var __args = arguments;
    if (__args.length === 0) {
      return utils.convReturnTypeUnknown(j_sendContext.sentBody());
    } else throw new TypeError('function invoked with invalid arguments');
  };
