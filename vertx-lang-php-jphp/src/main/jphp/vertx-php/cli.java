...
public class CLI extends BaseWrapper<CLI>{
  ...
  this.parse = function() {
    ...
    if (__args.length === 1 && typeof __args[0] === 'object' && __args[0] instanceof Array) {
      return utils.convReturnVertxGen(CommandLine, j_cLI.parse(utils.convParamListBasicOther(__args[0])));
    }  else if (__args.length === 2 && typeof __args[0] === 'object' && __args[0] instanceof Array && typeof __args[1] ==='boolean') {
      return utils.convReturnVertxGen(CommandLine, j_cLI.parse(utils.convParamListBasicOther(__args[0]), __args[1]));
  ...
  this.addOption = function(option) {
    ...
    if (__args.length === 1 && (typeof __args[0] === 'object' && __args[0] != null)) {
      j_cLI.addOption(option != null ? new Option(new JsonObject(Java.asJSONCompatible(option))) : null);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.addOptions = function(options) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'object' && __args[0] instanceof Array) {
      j_cLI.addOptions(utils.convParamListDataObject(options, function(json) { return new Option(json); }));
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.setOptions = function(options) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'object' && __args[0] instanceof Array) {
      j_cLI.setOptions(utils.convParamListDataObject(options, function(json) { return new Option(json); }));
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.addArgument = function(arg) {
    var __args = arguments;
    if (__args.length === 1 && (typeof __args[0] === 'object' && __args[0] != null)) {
      j_cLI.addArgument(arg != null ? new Argument(new JsonObject(Java.asJSONCompatible(arg))) : null);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.addArguments = function(args) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'object' && __args[0] instanceof Array) {
      j_cLI.addArguments(utils.convParamListDataObject(args, function(json) { return new Argument(json); }));
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.setArguments = function(args) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'object' && __args[0] instanceof Array) {
      j_cLI.setArguments(utils.convParamListDataObject(args, function(json) { return new Argument(json); }));
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.getOption = function(name) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'string') {
      return utils.convReturnDataObject(j_cLI.getOption(name));
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.getArgument = function() {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'string') {
      return utils.convReturnDataObject(j_cLI.getArgument(__args[0]));
...
CLI.create = function(name) {
  var __args = arguments;
  if (__args.length === 1 && typeof __args[0] === 'string') {
    return utils.convReturnVertxGen(CLI, JCLI.create(name));
  } else throw new TypeError('function invoked with invalid arguments');
};
