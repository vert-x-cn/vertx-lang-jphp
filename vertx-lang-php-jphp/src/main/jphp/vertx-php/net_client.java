...
public class NetClient extends BaseWrapper<NetClient>{
  ...
  this.connect = function() {
    ...
    if (__args.length === 2 && typeof __args[0] === 'object' && __args[0]._jdel && typeof __args[1] === 'function') {
      j_netClient.connect(__args[0]._jdel, function(ar) {
      if (ar.succeeded()) {
      ...
      j_netClient.connect(__args[0], __args[1], function(ar) {
      if (ar.succeeded()) {
      ...
      j_netClient.connect(__args[0]._jdel, __args[1], function(ar) {
      if (ar.succeeded()) {
        __args[2](utils.convReturnVertxGen(NetSocket, ar.result()), null);
      } else {
        __args[2](null, ar.cause());
      ...
      j_netClient.connect(__args[0], __args[1], __args[2], function(ar) {
      if (ar.succeeded()) {
...
NetClient._create = function(jdel) {
  var obj = Object.create(NetClient.prototype, {});
  NetClient.apply(obj, arguments);
  return obj;
}
