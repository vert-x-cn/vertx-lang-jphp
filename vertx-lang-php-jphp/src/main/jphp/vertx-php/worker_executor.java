...
public class WorkerExecutor extends BaseWrapper<WorkerExecutor>{
  ...
  this.executeBlocking = function() {
    ...
    if (__args.length === 2 && typeof __args[0] === 'function' && typeof __args[1] === 'function') {
      j_workerExecutor.executeBlocking(function(jVal) {
...
WorkerExecutor._create = function(jdel) {
  var obj = Object.create(WorkerExecutor.prototype, {});
  WorkerExecutor.apply(obj, arguments);
  return obj;
}
