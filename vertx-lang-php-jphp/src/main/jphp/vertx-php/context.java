...
public class Context extends BaseWrapper<Context>{
  ...
  this.executeBlocking = function() {
    ...
    if (__args.length === 2 && typeof __args[0] === 'function' && typeof __args[1] === 'function') {
      j_context.executeBlocking(function(jVal) {
  ...
  this.exceptionHandler = function(handler) {
    ...
    if (__args.length === 1 && (typeof __args[0] === 'function' || __args[0] == null)) {
      j_context.exceptionHandler(handler == null ? null : function(jVal) {
