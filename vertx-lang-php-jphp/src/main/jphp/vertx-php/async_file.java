...
public class AsyncFile extends BaseWrapper<AsyncFile>{
  ...
  this.end = function() {
    ...
    if (__args.length === 0) {
      ...
      j_asyncFile.end(__args[0]._jdel);
  ...
  this.handler = function(handler) {
    ...
    if (__args.length === 1 && (typeof __args[0] === 'function' || __args[0] == null)) {
      j_asyncFile.handler(handler == null ? null : function(jVal) {
  ...
  this.exceptionHandler = function(handler) {
    var __args = arguments;
    if (__args.length === 1 && (typeof __args[0] === 'function' || __args[0] == null)) {
      j_asyncFile.exceptionHandler(handler == null ? null : function(jVal) {
  ...
  this.setWritePos = function(writePos) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] ==='number') {
      j_asyncFile.setWritePos(writePos);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.setReadBufferSize = function(readBufferSize) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] ==='number') {
      j_asyncFile.setReadBufferSize(readBufferSize);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
...
AsyncFile._create = function(jdel) {
  var obj = Object.create(AsyncFile.prototype, {});
  AsyncFile.apply(obj, arguments);
  return obj;
}
