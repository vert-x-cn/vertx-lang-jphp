...
public class MessageConsumer extends BaseWrapper<MessageConsumer>{
  ...
  this.exceptionHandler = function(handler) {
    ...
    if (__args.length === 1 && (typeof __args[0] === 'function' || __args[0] == null)) {
      j_messageConsumer.exceptionHandler(handler == null ? null : function(jVal) {
  ...
  this.handler = function(handler) {
    var __args = arguments;
    if (__args.length === 1 && (typeof __args[0] === 'function' || __args[0] == null)) {
      j_messageConsumer.handler(handler == null ? null : function(jVal) {
  ...
  this.setMaxBufferedMessages = function(maxBufferedMessages) {
    ...
    if (__args.length === 1 && typeof __args[0] ==='number') {
      return utils.convReturnVertxGen(MessageConsumer, j_messageConsumer.setMaxBufferedMessages(maxBufferedMessages), undefined);
    } else throw new TypeError('function invoked with invalid arguments');
  };
...
MessageConsumer._create = function(jdel) {
  var obj = Object.create(MessageConsumer.prototype, {});
  MessageConsumer.apply(obj, arguments);
  return obj;
}
