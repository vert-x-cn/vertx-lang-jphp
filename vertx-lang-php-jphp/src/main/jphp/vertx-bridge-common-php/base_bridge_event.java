...
public class BaseBridgeEvent extends BaseWrapper<BaseBridgeEvent>{
  ...
  this.setHandler = function(handler) {
    ...
    if (__args.length === 1 && typeof __args[0] === 'function') {
      j_baseBridgeEvent.setHandler(function(ar) {
      if (ar.succeeded()) {
  ...
  this.complete = function() {
    ...
    if (__args.length === 0) {
      ...
      j_baseBridgeEvent.complete(__args[0]);
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.fail = function() {
    ...
    if (__args.length === 1 && typeof __args[0] === 'object') {
      j_baseBridgeEvent.fail(utils.convParamThrowable(__args[0]));
    }  else if (__args.length === 1 && typeof __args[0] === 'string') {
      j_baseBridgeEvent.fail(__args[0]);
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.tryComplete = function() {
    ...
    if (__args.length === 0) {
      ...
      return j_baseBridgeEvent.tryComplete(__args[0]);
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.tryFail = function() {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'object') {
      return j_baseBridgeEvent.tryFail(utils.convParamThrowable(__args[0]));
    }  else if (__args.length === 1 && typeof __args[0] === 'string') {
      return j_baseBridgeEvent.tryFail(__args[0]);
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.compose = function() {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'function') {
      return utils.convReturnVertxGen(Future, j_baseBridgeEvent.compose(function(jVal) {
  ...
  this.map = function() {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'function') {
      return utils.convReturnVertxGen(Future, j_baseBridgeEvent.map(function(jVal) {
      var jRet = __args[0](jVal);
      return utils.convParamTypeUnknown(jRet);
    }), undefined);
    }  else if (__args.length === 1 && typeof __args[0] !== 'function') {
      return utils.convReturnVertxGen(Future, j_baseBridgeEvent.map(utils.convParamTypeUnknown(__args[0])), undefined);
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.recover = function(mapper) {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'function') {
      return utils.convReturnVertxGen(Future, j_baseBridgeEvent.recover(function(jVal) {
  ...
  this.otherwise = function() {
    var __args = arguments;
    if (__args.length === 1 && typeof __args[0] === 'function') {
      return utils.convReturnVertxGen(Future, j_baseBridgeEvent.otherwise(function(jVal) {
      var jRet = __args[0](utils.convReturnThrowable(jVal));
      return jRet;
    }), undefined);
    }  else if (__args.length === 1 && typeof __args[0] ==='boolean') {
      return utils.convReturnVertxGen(Future, j_baseBridgeEvent.otherwise(__args[0]), undefined);
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.setRawMessage = function(message) {
    ...
    if (__args.length === 1 && (typeof __args[0] === 'object' && __args[0] != null)) {
      j_baseBridgeEvent.setRawMessage(utils.convParamJsonObject(message));
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
