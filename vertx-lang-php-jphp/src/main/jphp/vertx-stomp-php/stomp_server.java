...
public class StompServer extends BaseWrapper<StompServer>{
  ...
  this.handler = function(handler) {
    ...
    if (__args.length === 1 && typeof __args[0] === 'object' && __args[0]._jdel) {
      j_stompServer.handler(handler._jdel);
      return that;
  ...
  this.listen = function() {
    ...
    if (__args.length === 0) {
      ...
      j_stompServer.listen(__args[0]);
      return that;
    }  else if (__args.length === 1 && typeof __args[0] === 'function') {
      j_stompServer.listen(function(ar) {
      if (ar.succeeded()) {
      ...
      j_stompServer.listen(__args[0], __args[1]);
      return that;
    }  else if (__args.length === 2 && typeof __args[0] ==='number' && typeof __args[1] === 'function') {
      j_stompServer.listen(__args[0], function(ar) {
      if (ar.succeeded()) {
      ...
      j_stompServer.listen(__args[0], __args[1], function(ar) {
      if (ar.succeeded()) {
  ...
  this.close = function() {
    ...
    if (__args.length === 0) {
      ...
      j_stompServer.close(function(ar) {
      if (ar.succeeded()) {
        __args[0](null, null);
      } else {
        __args[0](null, ar.cause());
  ...
  this.writingFrameHandler = function(handler) {
    ...
    if (__args.length === 1 && typeof __args[0] === 'function') {
      j_stompServer.writingFrameHandler(function(jVal) {
...
StompServer.create = function() {
  var __args = arguments;
  if (__args.length === 1 && typeof __args[0] === 'object' && __args[0]._jdel) {
    return utils.convReturnVertxGen(StompServer, JStompServer.create(__args[0]._jdel));
  }else if (__args.length === 2 && typeof __args[0] === 'object' && __args[0]._jdel && (typeof __args[1] === 'object' && __args[1] != null)) {
    return utils.convReturnVertxGen(StompServer, JStompServer.create(__args[0]._jdel, __args[1] != null ? new StompServerOptions(new JsonObject(Java.asJSONCompatible(__args[1]))) : null));
  }else if (__args.length === 2 && typeof __args[0] === 'object' && __args[0]._jdel && typeof __args[1] === 'object' && __args[1]._jdel) {
    return utils.convReturnVertxGen(StompServer, JStompServer.create(__args[0]._jdel, __args[1]._jdel));
    ...
    return utils.convReturnVertxGen(StompServer, JStompServer.create(__args[0]._jdel, __args[1]._jdel, __args[2] != null ? new StompServerOptions(new JsonObject(Java.asJSONCompatible(__args[2]))) : null));
  } else throw new TypeError('function invoked with invalid arguments');
};
