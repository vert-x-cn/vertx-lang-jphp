...
public class StompServerConnection extends BaseWrapper<StompServerConnection>{
  ...
  this.write = function() {
    ...
    if (__args.length === 1 && (typeof __args[0] === 'object' && __args[0] != null)) {
      j_stompServerConnection.write(__args[0] != null ? new Frame(new JsonObject(Java.asJSONCompatible(__args[0]))) : null);
      return that;
    }  else if (__args.length === 1 && typeof __args[0] === 'object' && __args[0]._jdel) {
      j_stompServerConnection.write(__args[0]._jdel);
      return that;
  ...
  this.configureHeartbeat = function(ping, pong, pingHandler) {
    ...
    if (__args.length === 3 && typeof __args[0] ==='number' && typeof __args[1] ==='number' && typeof __args[2] === 'function') {
      j_stompServerConnection.configureHeartbeat(ping, pong, function(jVal) {
