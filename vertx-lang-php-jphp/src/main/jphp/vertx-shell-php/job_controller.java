...
public class JobController extends BaseWrapper<JobController>{
  ...
  this.getJob = function(id) {
    ...
    if (__args.length === 1 && typeof __args[0] ==='number') {
      return utils.convReturnVertxGen(Job, j_jobController.getJob(id));
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.createJob = function(process, line) {
    ...
    if (__args.length === 2 && typeof __args[0] === 'object' && __args[0]._jdel && typeof __args[1] === 'string') {
      return utils.convReturnVertxGen(Job, j_jobController.createJob(process._jdel, line));
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.close = function() {
    ...
    if (__args.length === 0) {
      ...
      j_jobController.close(__args[0]);
    } else throw new TypeError('function invoked with invalid arguments');
  };
