...
public class TermServer extends BaseWrapper<TermServer>{
  ...
  this.termHandler = function(handler) {
    ...
    if (__args.length === 1 && typeof __args[0] === 'function') {
      j_termServer.termHandler(function(jVal) {
  ...
  this.authProvider = function(provider) {
    ...
    if (__args.length === 1 && typeof __args[0] === 'object' && __args[0]._jdel) {
      j_termServer.authProvider(provider._jdel);
      return that;
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.listen = function() {
    ...
    if (__args.length === 0) {
      ...
      j_termServer.listen(function(ar) {
      if (ar.succeeded()) {
  ...
  this.close = function() {
    ...
    if (__args.length === 0) {
      ...
      j_termServer.close(function(ar) {
      if (ar.succeeded()) {
        __args[0](null, null);
      } else {
        __args[0](null, ar.cause());
...
TermServer.createSSHTermServer = function() {
  var __args = arguments;
  if (__args.length === 1 && typeof __args[0] === 'object' && __args[0]._jdel) {
    return utils.convReturnVertxGen(TermServer, JTermServer.createSSHTermServer(__args[0]._jdel));
  }else if (__args.length === 2 && typeof __args[0] === 'object' && __args[0]._jdel && (typeof __args[1] === 'object' && __args[1] != null)) {
    return utils.convReturnVertxGen(TermServer, JTermServer.createSSHTermServer(__args[0]._jdel, __args[1] != null ? new SSHTermOptions(new JsonObject(Java.asJSONCompatible(__args[1]))) : null));
  } else throw new TypeError('function invoked with invalid arguments');
};
...
TermServer.createTelnetTermServer = function() {
  var __args = arguments;
  if (__args.length === 1 && typeof __args[0] === 'object' && __args[0]._jdel) {
    return utils.convReturnVertxGen(TermServer, JTermServer.createTelnetTermServer(__args[0]._jdel));
  }else if (__args.length === 2 && typeof __args[0] === 'object' && __args[0]._jdel && (typeof __args[1] === 'object' && __args[1] != null)) {
    return utils.convReturnVertxGen(TermServer, JTermServer.createTelnetTermServer(__args[0]._jdel, __args[1] != null ? new TelnetTermOptions(new JsonObject(Java.asJSONCompatible(__args[1]))) : null));
  } else throw new TypeError('function invoked with invalid arguments');
};
...
TermServer.createHttpTermServer = function() {
  var __args = arguments;
  if (__args.length === 1 && typeof __args[0] === 'object' && __args[0]._jdel) {
    return utils.convReturnVertxGen(TermServer, JTermServer.createHttpTermServer(__args[0]._jdel));
  }else if (__args.length === 2 && typeof __args[0] === 'object' && __args[0]._jdel && (typeof __args[1] === 'object' && __args[1] != null)) {
    return utils.convReturnVertxGen(TermServer, JTermServer.createHttpTermServer(__args[0]._jdel, __args[1] != null ? new HttpTermOptions(new JsonObject(Java.asJSONCompatible(__args[1]))) : null));
  }else if (__args.length === 2 && typeof __args[0] === 'object' && __args[0]._jdel && typeof __args[1] === 'object' && __args[1]._jdel) {
    return utils.convReturnVertxGen(TermServer, JTermServer.createHttpTermServer(__args[0]._jdel, __args[1]._jdel));
    ...
    return utils.convReturnVertxGen(TermServer, JTermServer.createHttpTermServer(__args[0]._jdel, __args[1]._jdel, __args[2] != null ? new HttpTermOptions(new JsonObject(Java.asJSONCompatible(__args[2]))) : null));
  } else throw new TypeError('function invoked with invalid arguments');
};
