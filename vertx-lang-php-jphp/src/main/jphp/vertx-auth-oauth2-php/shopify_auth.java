...
public class ShopifyAuth extends BaseWrapper<ShopifyAuth>{
...
ShopifyAuth.create = function() {
  ...
  if (__args.length === 4 && typeof __args[0] === 'object' && __args[0]._jdel && typeof __args[1] === 'string' && typeof __args[2] === 'string' && typeof __args[3] === 'string') {
    return utils.convReturnVertxGen(OAuth2Auth, JShopifyAuth.create(__args[0]._jdel, __args[1], __args[2], __args[3]));
    ...
    return utils.convReturnVertxGen(OAuth2Auth, JShopifyAuth.create(__args[0]._jdel, __args[1], __args[2], __args[3], __args[4] != null ? new HttpClientOptions(new JsonObject(Java.asJSONCompatible(__args[4]))) : null));
