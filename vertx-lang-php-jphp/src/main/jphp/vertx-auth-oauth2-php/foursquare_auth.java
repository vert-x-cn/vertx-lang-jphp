...
public class FoursquareAuth extends BaseWrapper<FoursquareAuth>{
...
/**
 ...
 @param vertx {Vertx} 
 @param clientId {string} the client id given to you by Foursquare 
 @param clientSecret {string} the client secret given to you by Foursquare 
...
FoursquareAuth.create = function() {
  ...
  if (__args.length === 3 && typeof __args[0] === 'object' && __args[0]._jdel && typeof __args[1] === 'string' && typeof __args[2] === 'string') {
    return utils.convReturnVertxGen(OAuth2Auth, JFoursquareAuth.create(__args[0]._jdel, __args[1], __args[2]));
    ...
    return utils.convReturnVertxGen(OAuth2Auth, JFoursquareAuth.create(__args[0]._jdel, __args[1], __args[2], __args[3] != null ? new HttpClientOptions(new JsonObject(Java.asJSONCompatible(__args[3]))) : null));
