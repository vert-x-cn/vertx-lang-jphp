...
@Name("WebSocketBaseImpl")
@Namespace("io\\vertx\\php\\core\\http\\impl")
public class WebSocketBaseImpl extends VertxGenWrapper<io.vertx.core.http.WebSocketBase> implements WebSocketBase<io.vertx.core.http.WebSocketBase>{
    
    public WebSocketBaseImpl(Environment env, io.vertx.core.http.WebSocketBase wrappedObject){
