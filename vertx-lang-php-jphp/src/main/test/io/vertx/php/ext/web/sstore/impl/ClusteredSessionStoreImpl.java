...
import io.vertx.php.ext.web.sstore.ClusteredSessionStore;
...
@Name("ClusteredSessionStoreImpl")
@Namespace("io\\vertx\\php\\ext\\web\\sstore\\impl")
public class ClusteredSessionStoreImpl extends VertxGenWrapper<io.vertx.ext.web.sstore.ClusteredSessionStore> implements ClusteredSessionStore<io.vertx.ext.web.sstore.ClusteredSessionStore>{
    
    public ClusteredSessionStoreImpl(Environment env, io.vertx.ext.web.sstore.ClusteredSessionStore wrappedObject){
