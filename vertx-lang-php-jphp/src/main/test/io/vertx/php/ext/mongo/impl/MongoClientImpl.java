...
@Name("MongoClientImpl")
@Namespace("io\\vertx\\php\\ext\\mongo\\impl")
public class MongoClientImpl extends VertxGenWrapper<io.vertx.ext.mongo.MongoClient> implements MongoClient<io.vertx.ext.mongo.MongoClient>{
    
    public MongoClientImpl(Environment env, io.vertx.ext.mongo.MongoClient wrappedObject){
        super(env, wrappedObject);
    }

    @Signature
    public static Memory createNonShared(Environment __env__, Memory... args) {
        return Utils.convReturnVertxGen(__env__, MongoClientImpl::new, io.vertx.ext.mongo.MongoClient.createNonShared(vertx, config)
    }

    @Signature
    public static Memory createShared(Environment __env__, Memory... args) {
        return Utils.convReturnVertxGen(__env__, MongoClientImpl::new, io.vertx.ext.mongo.MongoClient.createShared(vertx, config)
    }
    ...
    @Signature
    public Memory findBatch(Environment __env__, Memory... args) {
        return Utils.convReturnVertxGen(__env__, ReadStreamImpl::new, this.getWrappedObject().findBatch(collection, query)
    }
    ...
    @Signature
    public Memory findBatchWithOptions(Environment __env__, Memory... args) {
        return Utils.convReturnVertxGen(__env__, ReadStreamImpl::new, this.getWrappedObject().findBatchWithOptions(collection, query, options)
    }
    ...
    public Memory findOneAndReplaceWithOptions(Environment __env__, Memory... args) {
        this.getWrappedObject().findOneAndReplaceWithOptions(collection, query, replace, findOptions, updateOptions, resultHandler)
    }
    ...
    @Signature
    public Memory distinctBatch(Environment __env__, Memory... args) {
        return Utils.convReturnVertxGen(__env__, ReadStreamImpl::new, this.getWrappedObject().distinctBatch(collection, fieldName, resultClassname)
    }

    @Signature
    public Memory distinctBatchWithQuery(Environment __env__, Memory... args) {
        return Utils.convReturnVertxGen(__env__, ReadStreamImpl::new, this.getWrappedObject().distinctBatchWithQuery(collection, fieldName, resultClassname, query)
    }
