...
import io.vertx.php.ext.asyncsql.PostgreSQLClient;
...
@Name("PostgreSQLClientImpl")
@Namespace("io\\vertx\\php\\ext\\asyncsql\\impl")
public class PostgreSQLClientImpl extends VertxGenWrapper<io.vertx.ext.asyncsql.PostgreSQLClient> implements PostgreSQLClient<io.vertx.ext.asyncsql.PostgreSQLClient>{
    
    public PostgreSQLClientImpl(Environment env, io.vertx.ext.asyncsql.PostgreSQLClient wrappedObject){
    ...
    public static Memory createNonShared(Environment __env__, Memory... args) {
        return Utils.convReturnVertxGen(__env__, AsyncSQLClientImpl::new, io.vertx.ext.asyncsql.PostgreSQLClient.createNonShared(vertx, config)
    }

    @Signature
    public static Memory createShared(Environment __env__, Memory... args) {
        return Utils.convReturnVertxGen(__env__, AsyncSQLClientImpl::new, io.vertx.ext.asyncsql.PostgreSQLClient.createShared(vertx, config)
    }
