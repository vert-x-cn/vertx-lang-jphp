...
public interface MongoClient<S extends io.vertx.ext.mongo.MongoClient> extends IWrapper<S>{
    ...
    @Signature
    default Memory findBatch(Environment __env__, Memory... args) {
    ...
    @Signature
    default Memory findBatchWithOptions(Environment __env__, Memory... args) {
    ...
    @Signature
    default Memory distinctBatch(Environment __env__, Memory... args) {
    ...
    @Signature
    default Memory distinctBatchWithQuery(Environment __env__, Memory... args) {
