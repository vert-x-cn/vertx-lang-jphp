...
public interface SockJSSocket<S extends io.vertx.ext.web.handler.sockjs.SockJSSocket> extends IWrapper<S>{
    ...
    @Signature
    default Memory webSession(Environment __env__, Memory... args) {
        return Utils.convReturnVertxGen(__env__, SessionImpl::new, this.getWrappedObject().webSession()
    }
    
    @Signature
    default Memory webUser(Environment __env__, Memory... args) {
        return Utils.convReturnVertxGen(__env__, UserImpl::new, this.getWrappedObject().webUser()
    }
