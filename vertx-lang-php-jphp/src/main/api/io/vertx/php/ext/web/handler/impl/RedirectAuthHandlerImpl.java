...
import io.vertx.php.ext.web.handler.RedirectAuthHandler;
...
@Name("RedirectAuthHandlerImpl")
@Namespace("io\\vertx\\php\\ext\\web\\handler\\impl")
public class RedirectAuthHandlerImpl extends VertxGenWrapper<io.vertx.ext.web.handler.RedirectAuthHandler> implements RedirectAuthHandler<io.vertx.ext.web.handler.RedirectAuthHandler>{
    
    public RedirectAuthHandlerImpl(Environment env, io.vertx.ext.web.handler.RedirectAuthHandler wrappedObject){
