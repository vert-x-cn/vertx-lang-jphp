...
public class SQLClient extends VertxGenVariable0Wrapper<io.vertx.ext.sql.SQLClient>{
    
    private SQLClient(Environment env, io.vertx.ext.sql.SQLClient wrappedObject){
        super(env, wrappedObject);
    }
    public static  SQLClient __create(Environment env, io.vertx.ext.sql.SQLClient wrappedObject){
        return new SQLClient(env, wrappedObject);
    }
