package io.vertx.php.ext.web.templ.freemarker;
...
@Name("FreeMarkerTemplateEngine")
@Namespace("io\\vertx\\php\\ext\\web\\templ\\freemarker")
@SuppressWarnings("ALL")
public class FreeMarkerTemplateEngine extends VertxGenVariable0Wrapper<io.vertx.ext.web.templ.freemarker.FreeMarkerTemplateEngine>{
    
    private FreeMarkerTemplateEngine(Environment env, io.vertx.ext.web.templ.freemarker.FreeMarkerTemplateEngine wrappedObject){
        super(env, wrappedObject);
    }
    public static  FreeMarkerTemplateEngine __create(Environment env, io.vertx.ext.web.templ.freemarker.FreeMarkerTemplateEngine wrappedObject){
        return new FreeMarkerTemplateEngine(env, wrappedObject);
    }
    ...
    public static Memory create(Environment __ENV__) {
        return Utils.<io.vertx.ext.web.templ.freemarker.FreeMarkerTemplateEngine, FreeMarkerTemplateEngine>convReturnVertxGenVariable0(__ENV__, FreeMarkerTemplateEngine.class, FreeMarkerTemplateEngine::__create, io.vertx.ext.web.templ.freemarker.FreeMarkerTemplateEngine.create());
    }/*1*/
