package io.vertx.php.ext.web.templ.jade;
...
@Namespace("io\\vertx\\php\\ext\\web\\templ\\jade")
@SuppressWarnings("ALL")
public class JadeTemplateEngine extends VertxGenVariable0Wrapper<io.vertx.ext.web.templ.jade.JadeTemplateEngine>{
    
    private JadeTemplateEngine(Environment env, io.vertx.ext.web.templ.jade.JadeTemplateEngine wrappedObject){
        super(env, wrappedObject);
    }
    public static  JadeTemplateEngine __create(Environment env, io.vertx.ext.web.templ.jade.JadeTemplateEngine wrappedObject){
        return new JadeTemplateEngine(env, wrappedObject);
    }
    ...
    public static Memory create(Environment __ENV__) {
        return Utils.<io.vertx.ext.web.templ.jade.JadeTemplateEngine, JadeTemplateEngine>convReturnVertxGenVariable0(__ENV__, JadeTemplateEngine.class, JadeTemplateEngine::__create, io.vertx.ext.web.templ.jade.JadeTemplateEngine.create());
    }/*1*/
