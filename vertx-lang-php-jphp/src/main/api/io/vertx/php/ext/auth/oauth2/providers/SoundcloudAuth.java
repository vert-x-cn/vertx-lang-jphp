...
public class SoundcloudAuth extends VertxGenVariable0Wrapper<io.vertx.ext.auth.oauth2.providers.SoundcloudAuth>{
    
    private SoundcloudAuth(Environment env, io.vertx.ext.auth.oauth2.providers.SoundcloudAuth wrappedObject){
        super(env, wrappedObject);
    }
    public static  SoundcloudAuth __create(Environment env, io.vertx.ext.auth.oauth2.providers.SoundcloudAuth wrappedObject){
        return new SoundcloudAuth(env, wrappedObject);
    }
    ...
    public static Memory create(Environment __ENV__, Memory arg0, Memory arg1, Memory arg2) {
        if(Utils.isNotNull(arg0) && Utils.isVertxGen(io.vertx.core.Vertx.class, Vertx.class, arg0) && Utils.isNotNull(arg1) && Utils.isString(__ENV__, arg1) && Utils.isNotNull(arg2) && Utils.isString(__ENV__, arg2)) {
            return Utils.<io.vertx.ext.auth.oauth2.OAuth2Auth, OAuth2Auth>convReturnVertxGenVariable0(__ENV__, OAuth2Auth.class, OAuth2Auth::__create, io.vertx.ext.auth.oauth2.providers.SoundcloudAuth.create(Utils.  <io.vertx.core.Vertx, Vertx  >convParamVertxGenVariable0(__ENV__, Vertx.class, Vertx::__create, arg0), Utils.convParamString(__ENV__, arg1), Utils.convParamString(__ENV__, arg2)));
        }/*3*/ else {
