...
public class BridgeEvent extends VertxGenVariable0Wrapper<io.vertx.ext.web.handler.sockjs.BridgeEvent>{
    
    private BridgeEvent(Environment env, io.vertx.ext.web.handler.sockjs.BridgeEvent wrappedObject){
        super(env, wrappedObject);
    }
    public static  BridgeEvent __create(Environment env, io.vertx.ext.web.handler.sockjs.BridgeEvent wrappedObject){
        return new BridgeEvent(env, wrappedObject);
    }
    ...
    @Signature
    public Memory socket(Environment __ENV__) {
        return Utils.<io.vertx.ext.web.handler.sockjs.SockJSSocket, SockJSSocket>convReturnVertxGenVariable0(__ENV__, SockJSSocket.class, SockJSSocket::__create, this.getWrappedObject().socket());
    }/*1*/
