...
public class WebSocket extends VertxGenVariable0Wrapper<io.vertx.core.http.WebSocket>{
    
    private WebSocket(Environment env, io.vertx.core.http.WebSocket wrappedObject){
        super(env, wrappedObject);
    }
    public static  WebSocket __create(Environment env, io.vertx.core.http.WebSocket wrappedObject){
        return new WebSocket(env, wrappedObject);
    }
