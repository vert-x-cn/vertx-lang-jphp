...
@Name("ServerWebSocketImpl")
@Namespace("io\\vertx\\php\\core\\http\\impl")
public class ServerWebSocketImpl extends VertxGenWrapper<io.vertx.core.http.ServerWebSocket> implements ServerWebSocket<io.vertx.core.http.ServerWebSocket>{
    
    public ServerWebSocketImpl(Environment env, io.vertx.core.http.ServerWebSocket wrappedObject){
    ...
    @Signature
    public void reject(Environment __env__, Memory... args) {
