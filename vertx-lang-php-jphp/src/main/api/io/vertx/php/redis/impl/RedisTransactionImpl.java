...
@Name("RedisTransactionImpl")
@Namespace("io\\vertx\\php\\redis\\impl")
public class RedisTransactionImpl extends VertxGenWrapper<io.vertx.redis.RedisTransaction> implements RedisTransaction<io.vertx.redis.RedisTransaction>{
    
    public RedisTransactionImpl(Environment env, io.vertx.redis.RedisTransaction wrappedObject){
    ...
    @Signature
    public Memory discard(Environment __env__, Memory... args) {
    ...
    @Signature
    public Memory exec(Environment __env__, Memory... args) {
    ...
    @Signature
    public Memory multi(Environment __env__, Memory... args) {
    ...
    @Signature
    public Memory unwatch(Environment __env__, Memory... args) {
    ...
    @Signature
    public Memory watch(Environment __env__, Memory... args) {
        this.getWrappedObject().watch(key, handler)
    }

    @Signature
    public Memory watchMany(Environment __env__, Memory... args) {
