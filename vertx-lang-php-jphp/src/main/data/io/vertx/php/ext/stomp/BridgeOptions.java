...
//false
public  class BridgeOptions extends DataObjectWrapper<io.vertx.ext.stomp.BridgeOptions> { 
    public BridgeOptions(Environment env, io.vertx.ext.stomp.BridgeOptions wrappedObject) {
    ...
    public Memory __construct(){
        this.__wrappedObject = new io.vertx.ext.stomp.BridgeOptions();
        return Memory.NULL;    }

    @Signature
    public Memory __construct(Memory memory) {
        this.__wrappedObject = new io.vertx.ext.stomp.BridgeOptions(new JsonObject(JsonFunctions.json_encode(memory)));
        return Memory.NULL;
    }
    ...
    public boolean isPointToPoint(){ 
        return this.getWrappedObject().isPointToPoint();
    }

    @Signature
    public BridgeOptions setPointToPoint(boolean pointToPoint){ 
        this.getWrappedObject().setPointToPoint(pointToPoint);
        return this;
    }
}
