...
There is a single event bus instance for every Vert.x instance and it is obtained using the method `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.Vertx.html#method_eventBus[eventBus]`.
...
This simplest way to register a handler is using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.eventbus.EventBus.html#method_consumer[consumer]`.
Here's an example:
...
When a message arrives for your handler, your handler will be called, passing in the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.eventbus.Message.html[message]`.

The object returned from call to +consumer()+ is an instance of `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.eventbus.MessageConsumer.html[MessageConsumer]`

This object can subsequently be used to unregister the handler, or use the handler as a stream.

Alternatively you can use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.eventbus.EventBus.html#method_consumer[consumer]` to
...
If you want to be notified when this has completed, you can register a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.eventbus.MessageConsumer.html#method_completionHandler[completion handler]`
...
To unregister a handler, call `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.eventbus.MessageConsumer.html#method_unregister[unregister]`.

If you are on a clustered event bus, un-registering can take some time to propagate across the nodes, if you want to
be notified when this is complete use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.eventbus.MessageConsumer.html#method_unregister[unregister]`.
...
Publishing a message is simple. Just use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.eventbus.EventBus.html#method_publish[publish]` specifying the
...
You can send a message with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.eventbus.EventBus.html#method_send[send]`
...
The object you receive in a message handler is a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.eventbus.Message.html[Message]`.

The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.eventbus.Message.html#method_body[body]` of the message corresponds to the object that was sent or published.

The headers of the message are available with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.eventbus.Message.html#method_headers[headers]`.

==== Acknowledging messages / sending replies

When using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.eventbus.EventBus.html#method_send[send]` the event bus attempts to deliver the message to a
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.eventbus.MessageConsumer.html[MessageConsumer]`registered with the event bus.

In some cases it's useful for the sender to know when the consumer has received the message and "processed" it.

To acknowledge that the message has been processed the consumer can reply to the message by calling `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.eventbus.Message.html#method_reply[reply]`.
...
* The recipient has explicitly failed the message using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.eventbus.Message.html#method_fail[fail]`
...
clustered, the port and host, as you would do with `link:../enums.adoc#VertxOptions#method_setClustered[setClustered]`,
`link:../enums.adoc#VertxOptions#method_getClusterHost[getClusterHost]` and `link:../enums.adoc#VertxOptions#method_getClusterPort[getClusterPort]`.
