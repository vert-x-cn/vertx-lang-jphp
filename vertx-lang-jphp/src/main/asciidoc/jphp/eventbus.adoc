...
The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.eventbus.EventBus.html[event bus]` is the *nervous system* of Vert.x.

There is a single event bus instance for every Vert.x instance and it is obtained using the method `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.Vertx.html#method_Vertx[eventBus]`.
...
Out of the box Vert.x allows any primitive/simple type, String, or `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.buffer.Buffer.html[buffers]` to
be sent as messages.
...
This simplest way to register a handler is using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.eventbus.EventBus.html#method_EventBus[consumer]`.
Here's an example:
...
When a message arrives for your handler, your handler will be called, passing in the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.eventbus.Message<T>.html[message]`.

The object returned from call to +consumer()+ is an instance of `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.eventbus.MessageConsumer<T>.html[MessageConsumer]`

This object can subsequently be used to unregister the handler, or use the handler as a stream.

Alternatively you can use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.eventbus.EventBus.html#method_EventBus[consumer]` to
...
If you want to be notified when this has completed, you can register a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.eventbus.MessageConsumer<T>.html#method_MessageConsumer[completion handler]`
...
To unregister a handler, call `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.eventbus.MessageConsumer<T>.html#method_MessageConsumer[unregister]`.

If you are on a clustered event bus, un-registering can take some time to propagate across the nodes, if you want to
be notified when this is complete use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.eventbus.MessageConsumer<T>.html#method_MessageConsumer[unregister]`.
...
Publishing a message is simple. Just use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.eventbus.EventBus.html#method_EventBus[publish]` specifying the
...
You can send a message with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.eventbus.EventBus.html#method_EventBus[send]`
...
The object you receive in a message handler is a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.eventbus.Message<T>.html[Message]`.

The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.eventbus.Message<T>.html#method_Message[body]` of the message corresponds to the object that was sent or published.

The headers of the message are available with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.eventbus.Message<T>.html#method_Message[headers]`.

==== Acknowledging messages / sending replies

When using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.eventbus.EventBus.html#method_EventBus[send]` the event bus attempts to deliver the message to a
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.eventbus.MessageConsumer<T>.html[MessageConsumer]`registered with the event bus.

In some cases it's useful for the sender to know when the consumer has received the message and "processed" it.

To acknowledge that the message has been processed the consumer can reply to the message by calling `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.eventbus.Message<T>.html#method_Message[reply]`.
...
When sending a message with a reply handler you can specify a timeout in the `link:../enums.adoc#DeliveryOptions[DeliveryOptions]`.
...
* The recipient has explicitly failed the message using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.eventbus.Message<T>.html#method_Message[fail]`
...
`link:../enums.adoc#EventBusOptions[EventBusOptions]`let you configure all aspects of these TCP connections. As
the event bus acts as a server and client, the configuration is close to
`link:../enums.adoc#NetClientOptions[NetClientOptions]`and `link:../enums.adoc#NetServerOptions[NetServerOptions]`.
...
The `link:../enums.adoc#EventBusOptions[EventBusOptions]` also lets you specify whether or not the event bus is
clustered, the port and host, as you would do with `link:../enums.adoc#VertxOptions#method_VertxOptions[setClustered]`,
`link:../enums.adoc#VertxOptions#method_VertxOptions[getClusterHost]` and `link:../enums.adoc#VertxOptions#method_VertxOptions[getClusterPort]`.
