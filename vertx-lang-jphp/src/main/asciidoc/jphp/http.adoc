...
- `link:../dataobjects.html#Http2Settings#getMaxConcurrentStreams()[getMaxConcurrentStreams]`: {@code 100} as recommended by the HTTP/2 RFC
...
Use `link:../../scaladocs/io/vertx/scala/core/http/HttpServerRequest.html#host()[host]` to return the host of the HTTP request.
...
To enable decompression set `link:../dataobjects.html#HttpServerOptions#setDecompressionSupported(boolean)[decompressionSupported]` on the
...
To receive custom frames, you can use the `link:../../scaladocs/io/vertx/scala/core/http/HttpServerRequest.html#customFrameHandler(io.vertx.core.Handler)[customFrameHandler]` on the request,
...
`link:../../scaladocs/io/vertx/scala/core/http/HttpServerRequest.html#rawMethod()[rawMethod]`returns the HTTP method as sent by the client.
...
To send such frames, you can use the `link:../../scaladocs/io/vertx/scala/core/http/HttpServerResponse.html#writeCustomFrame(int,%20int,%20io.vertx.core.buffer.Buffer)[writeCustomFrame]` on the response.
Here's an example:
...
The request handler are notified of stream reset events with the `link:../../scaladocs/io/vertx/scala/core/http/HttpServerRequest.html#exceptionHandler(io.vertx.core.Handler)[request handler]` and
`link:../../scaladocs/io/vertx/scala/core/http/HttpServerResponse.html#exceptionHandler(io.vertx.core.Handler)[response handler]`:
...
The `link:../../scaladocs/io/vertx/scala/core/http/HttpServerResponse.html#push(io.vertx.core.http.HttpMethod,%20java.lang.String,%20java.lang.String,%20io.vertx.core.Handler)[push]` method must be called before the initiating response ends, however
the pushed response can be written after.

==== Handling exceptions

You can set an `link:../../scaladocs/io/vertx/scala/core/http/HttpServer.html#exceptionHandler(io.vertx.core.Handler)[exceptionHandler]` to receive any
exceptions that happens before the connection is passed to the `link:../../scaladocs/io/vertx/scala/core/http/HttpServer.html#requestHandler(io.vertx.core.Handler)[requestHandler]`
or to the `link:../../scaladocs/io/vertx/scala/core/http/HttpServer.html#websocketHandler(io.vertx.core.Handler)[websocketHandler]`, e.g during the TLS handshake.
...
By default - if compression is enabled via `link:../dataobjects.html#HttpServerOptions#setCompressionSupported(boolean)[compressionSupported]` - Vert.x will use '6' as compression level,
but the parameter can be configured to address any case with `link:../dataobjects.html#HttpServerOptions#setCompressionLevel(int)[compressionLevel]`.
...
with `link:../../scaladocs/io/vertx/scala/core/http/HttpClientResponse.html#version()[version]` when the response arrives.
...
`link:../../scaladocs/io/vertx/scala/core/http/HttpClient.html#getNow(io.vertx.core.http.RequestOptions,%20io.vertx.core.Handler)[getNow]`.
...
general purpose request methods such as `link:../../scaladocs/io/vertx/scala/core/http/HttpClient.html#request(io.vertx.core.http.HttpMethod,%20io.vertx.core.http.RequestOptions)[request]` which allow you to specify
...
To do this you can call one of the specific request methods such as `link:../../scaladocs/io/vertx/scala/core/http/HttpClient.html#post(io.vertx.core.http.RequestOptions)[post]` or
one of the general purpose request methods such as `link:../../scaladocs/io/vertx/scala/core/http/HttpClient.html#request(io.vertx.core.http.HttpMethod,%20io.vertx.core.http.RequestOptions)[request]`.
...
is used, `link:../../scaladocs/io/vertx/scala/core/http/HttpClientRequest.html#setRawMethod(java.lang.String)[setRawMethod]` must be used to
...
To send such frames, you can use the `link:../../scaladocs/io/vertx/scala/core/http/HttpClientRequest.html#write(io.vertx.core.buffer.Buffer)[write]` on the request. Here's an example:
...
The request handler are notified of stream reset events with the `link:../../scaladocs/io/vertx/scala/core/http/HttpClientRequest.html#exceptionHandler(io.vertx.core.Handler)[request handler]` and
`link:../../scaladocs/io/vertx/scala/core/http/HttpClientResponse.html#exceptionHandler(io.vertx.core.Handler)[response handler]`:
...
client.get("some-uri", (response: io.vertx.scala.core.http.HttpClientResponse) => {
  println(s"Received response with status code ${response.statusCode()}")
...
The maximum redirects is `16` by default and can be changed with `link:../dataobjects.html#HttpClientOptions#setMaxRedirects(int)[maxRedirects]`.
...
client.redirectHandler((response: io.vertx.scala.core.http.HttpClientResponse) => {
  ...
  if (response.statusCode() == 301 && response.getHeader("Location") != null) {
    ...
    Future.succeededFuture(client.getAbs(absoluteURI))
  }
...
The policy handles the original `link:../../scaladocs/io/vertx/scala/core/http/HttpClientResponse.html[HttpClientResponse]` received and returns either `null`
...
* request headers, unless if you have set some headers (including `link:../../scaladocs/io/vertx/scala/core/http/HttpClientRequest.html#setHost(java.lang.String)[setHost]`)
...
You can set the default timeout using `link:../dataobjects.html#HttpClientOptions#setKeepAliveTimeout(int)[keepAliveTimeout]` - any
...
HTTP/2 connections will not be closed by the client automatically. To close them you can call `link:../../scaladocs/io/vertx/scala/core/http/HttpConnection.html#close()[close]`
...
The `link:../../scaladocs/io/vertx/scala/core/http/HttpConnection.html[HttpConnection]` offers the API for dealing with HTTP connection events, lifecycle
and settings.

HTTP/2 implements fully the `link:../../scaladocs/io/vertx/scala/core/http/HttpConnection.html[HttpConnection]` API.

HTTP/1.x implements partially the `link:../../scaladocs/io/vertx/scala/core/http/HttpConnection.html[HttpConnection]` API: only the close operation,
the close handler and exception handler are implemented. This protocol does not provide semantics for
the other operations.

==== Server connections

The `link:../../scaladocs/io/vertx/scala/core/http/HttpServerRequest.html#connection()[connection]` method returns the request connection on the server:
...
The `link:../../scaladocs/io/vertx/scala/core/http/HttpClientRequest.html#connection()[connection]` method returns the request connection on the client:
...
Conversely the `link:../../scaladocs/io/vertx/scala/core/http/HttpConnection.html#remoteSettingsHandler(io.vertx.core.Handler)[remoteSettingsHandler]` is notified
...
validity: `link:../../scaladocs/io/vertx/scala/core/http/HttpConnection.html#ping(io.vertx.core.buffer.Buffer,%20io.vertx.core.Handler)[ping]` sends a {@literal PING} frame to the remote
endpoint:
...
Calling `link:../../scaladocs/io/vertx/scala/core/http/HttpConnection.html#shutdown()[shutdown]` will send a {@literal GOAWAY} frame to the
...
The `link:../../scaladocs/io/vertx/scala/core/http/HttpConnection.html#shutdownHandler(io.vertx.core.Handler))[shutdownHandler]` notifies when all streams have been closed, the
...
The `link:../../scaladocs/io/vertx/scala/core/http/HttpConnection.html#shutdownHandler(io.vertx.core.Handler))[shutdownHandler]` will be called when all current streams
...
Connection `link:../../scaladocs/io/vertx/scala/core/http/HttpConnection.html#close()[close]` closes the connection:
...
The `link:../../scaladocs/io/vertx/scala/core/http/HttpConnection.html#closeHandler(io.vertx.core.Handler)[closeHandler]` notifies when a connection is closed.
...
specifying a scheme with `link:../../scaladocs/io/vertx/scala/core/http/HttpClient.html#requestAbs(io.vertx.core.http.HttpMethod,%20java.lang.String)[requestAbs]`
method.
...
client.getNow(RequestOptions()
  ...
  .setURI("/")
  .setSsl(true)
, (response: io.vertx.scala.core.http.HttpClientResponse) => {
  println(s"Received response with status code ${response.statusCode()}")
})

----

The `link:../dataobjects.html#HttpClientOptions#setSsl(boolean)[ssl]` setting acts as the default client setting.

The `link:../dataobjects.html#RequestOptions#setSsl(boolean)[ssl]` overrides the default client setting
...
Likewise `link:../../scaladocs/io/vertx/scala/core/http/HttpClient.html#requestAbs(io.vertx.core.http.HttpMethod,%20java.lang.String)[requestAbs]` scheme
...
`link:../../scaladocs/io/vertx/scala/core/http/ServerWebSocket.html#path()[path]`, `link:../../scaladocs/io/vertx/scala/core/http/ServerWebSocket.html#query()[query]` and
`link:../../scaladocs/io/vertx/scala/core/http/ServerWebSocket.html#uri()[URI]`of the HTTP request of the WebSocket handshake.

==== WebSockets on the client

The Vert.x `link:../../scaladocs/io/vertx/scala/core/http/HttpClient.html[HttpClient]` supports WebSockets.

You can connect a WebSocket to a server using one of the `link:../../scaladocs/io/vertx/scala/core/http/HttpClient.html#websocket(io.vertx.core.http.RequestOptions,%20io.vertx.core.Handler)[websocket]` operations and
providing a handler.
...
`link:../../scaladocs/io/vertx/scala/core/http/WebSocket.html#writeBinaryMessage(io.vertx.core.buffer.Buffer)[writeBinaryMessage]`or
`link:../../scaladocs/io/vertx/scala/core/http/WebSocket.html#writeTextMessage(java.lang.String)[writeTextMessage]`:
...
var client = vertx.createHttpClient(options)
client.getAbs("ftp://ftp.gnu.org/gnu/", (response: io.vertx.scala.core.http.HttpClientResponse) => {
  println(s"Received response with status code ${response.statusCode()}")
})
