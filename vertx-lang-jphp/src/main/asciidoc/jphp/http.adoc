...
If you don't want the default, a server can be configured by passing in a `link:../enums.adoc#HttpServerOptions[HttpServerOptions]`
...
To handle `h2` requests, TLS must be enabled along with `link:../enums.adoc#HttpServerOptions#method_HttpServerOptions[setUseAlpn]`:
...
When a server accepts an HTTP/2 connection, it sends to the client its `link:../enums.adoc#HttpServerOptions#method_HttpServerOptions[initial settings]`.
The settings define how the client can use the connection, the default initial settings for a server are:

- `link:../enums.adoc#Http2Settings#method_Http2Settings[getMaxConcurrentStreams]`: {@code 100} as recommended by the HTTP/2 RFC
...
To tell the server to listen for incoming requests you use one of the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServer.html#method_HttpServer[listen]`
alternatives.
...
To be notified when a request arrives you need to set a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServer.html#method_HttpServer[requestHandler]`:
...
When a request arrives, the request handler is called passing in an instance of `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerRequest.html[HttpServerRequest]`.
...
The server request object allows you to retrieve the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerRequest.html#method_HttpServerRequest[uri]`,
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerRequest.html#method_HttpServerRequest[path]`, `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerRequest.html#method_HttpServerRequest[params]` and
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerRequest.html#method_HttpServerRequest[headers]`, amongst other things.

Each server request object is associated with one server response object. You use
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerRequest.html#method_HttpServerRequest[response]`to get a reference to the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerResponse.html[HttpServerResponse]`
object.
...
The version of HTTP specified in the request can be retrieved with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerRequest.html#method_HttpServerRequest[version]`

==== Request method

Use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerRequest.html#method_HttpServerRequest[method]` to retrieve the HTTP method of the request.
(i.e. whether it's GET, POST, PUT, DELETE, HEAD, OPTIONS, etc).

==== Request URI

Use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerRequest.html#method_HttpServerRequest[uri]` to retrieve the URI of the request.
...
Use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerRequest.html#method_HttpServerRequest[path]` to return the path part of the URI
...
Use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerRequest.html#method_HttpServerRequest[query]` to return the query part of the URI
...
Use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerRequest.html#method_HttpServerRequest[headers]` to return the headers of the HTTP request.

This returns an instance of `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.MultiMap.html[MultiMap]` - which is like a normal Map or Hash but allows multiple
...
Use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerRequest.html#method_HttpServerRequest[host]` to return the host of the HTTP request.

For HTTP/1.x requests the `host` header is returned, for HTTP/1 requests the `:authority` pseudo header is returned.

==== Request parameters

Use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerRequest.html#method_HttpServerRequest[params]` to return the parameters of the HTTP request.

Just like `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerRequest.html#method_HttpServerRequest[headers]` this returns an instance of `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.MultiMap.html[MultiMap]`
...
The address of the sender of the request can be retrieved with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerRequest.html#method_HttpServerRequest[remoteAddress]`.

==== Absolute URI

The URI passed in an HTTP request is usually relative. If you wish to retrieve the absolute URI corresponding
to the request, you can get it with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerRequest.html#method_HttpServerRequest[absoluteURI]`

==== End handler

The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerRequest.html#method_HttpServerRequest[endHandler]` of the request is invoked when the entire request,
...
To receive the body, you can use the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerRequest.html#method_HttpServerRequest[handler]`  on the request,
...
The object passed into the handler is a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.buffer.Buffer.html[Buffer]`, and the handler can be called
...
This is such a common case, that Vert.x provides a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerRequest.html#method_HttpServerRequest[bodyHandler]` to do this
...
The request object is a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.streams.ReadStream<T>.html[ReadStream]` so you can pump the request body to any
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.streams.WriteStream<T>.html[WriteStream]`instance.
...
such a form *before* any of the body is read by calling `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerRequest.html#method_HttpServerRequest[setExpectMultipart]`
with true, and then you should retrieve the actual attributes using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerRequest.html#method_HttpServerRequest[formAttributes]`
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerRequest.html#method_HttpServerRequest[uploadHandler]`on the request.

This handler will be called once for every
upload that arrives on the server.

The object passed into the handler is a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerFileUpload.html[HttpServerFileUpload]` instance.
...
The upload object is a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.streams.ReadStream<T>.html[ReadStream]` so you can pump the request body to any
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.streams.WriteStream<T>.html[WriteStream]`instance. See the chapter on <<streams, streams and pumps>> for a
detailed explanation.

If you just want to upload the file to disk somewhere you can use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerFileUpload.html#method_HttpServerFileUpload[streamToFileSystem]`:
...
To enable decompression set `link:../enums.adoc#HttpServerOptions#method_HttpServerOptions[setDecompressionSupported]` on the
...
To receive custom frames, you can use the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerRequest.html#method_HttpServerRequest[customFrameHandler]` on the request,
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerRequest.html#method_HttpServerRequest[rawMethod]`returns the HTTP method as sent by the client.

=== Sending back responses

The server response object is an instance of `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerResponse.html[HttpServerResponse]` and is obtained from the
request with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerRequest.html#method_HttpServerRequest[response]`.
...
Use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerResponse.html#method_HttpServerResponse[setStatusCode]` to set a different code.

You can also specify a custom status message with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerResponse.html#method_HttpServerResponse[setStatusMessage]`.
...
To write data to an HTTP response, you use one the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerResponse.html#method_HttpServerResponse[write]` operations.
...
single call to the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerResponse.html#method_HttpServerResponse[end]`
...
Once you have finished with the HTTP response you should `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerResponse.html#method_HttpServerResponse[end]` it.
...
You can close the underlying TCP connection with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerResponse.html#method_HttpServerResponse[close]`.
...
closed after an idle time, then you configure `link:../enums.adoc#HttpServerOptions#method_HttpServerOptions[setIdleTimeout]`.
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerResponse.html#method_HttpServerResponse[headers]`:
...
Or you can use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerResponse.html#method_HttpServerResponse[putHeader]`
...
Default is non-chunked. When in chunked mode, each call to one of the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerResponse.html#method_HttpServerResponse[write]`
...
To add trailers to the response, add them directly to the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerResponse.html#method_HttpServerResponse[trailers]`.
...
Or use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerResponse.html#method_HttpServerResponse[putTrailer]`.
...
If you were writing a web server, one way to serve a file from disk would be to open it as an `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.file.AsyncFile.html[AsyncFile]`
and pump it to the HTTP response.

Or you could load it it one go using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.file.FileSystem.html#method_FileSystem[readFile]` and write it straight to the response.
...
This is done by using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerResponse.html#method_HttpServerResponse[sendFile]`, and is usually more efficient for large
...
be notified when the file has been writen you can use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerResponse.html#method_HttpServerResponse[sendFile]`
...
The server response is a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.streams.WriteStream<T>.html[WriteStream]` instance so you can pump to it from any
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.streams.ReadStream<T>.html[ReadStream]`, e.g. `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.file.AsyncFile.html[AsyncFile]`, `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.net.NetSocket.html[NetSocket]`,
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.WebSocket.html[WebSocket]`or `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerRequest.html[HttpServerRequest]`.
...
To send such frames, you can use the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerResponse.html#method_HttpServerResponse[writeCustomFrame]` on the response.
Here's an example:
...
The request handler are notified of stream reset events with the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerRequest.html#method_HttpServerRequest[request handler]` and
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerResponse.html#method_HttpServerResponse[response handler]`:
...
The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerResponse.html#method_HttpServerResponse[push]` method must be called before the initiating response ends, however
the pushed response can be written after.

==== Handling exceptions

You can set an `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServer.html#method_HttpServer[exceptionHandler]` to receive any
exceptions that happens before the connection is passed to the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServer.html#method_HttpServer[requestHandler]`
or to the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServer.html#method_HttpServer[websocketHandler]`, e.g during the TLS handshake.
...
To enable compression use can configure it with `link:../enums.adoc#HttpServerOptions#method_HttpServerOptions[setCompressionSupported]`.
...
By default - if compression is enabled via `link:../enums.adoc#HttpServerOptions#method_HttpServerOptions[setCompressionSupported]` - Vert.x will use '6' as compression level,
but the parameter can be configured to address any case with `link:../enums.adoc#HttpServerOptions#method_HttpServerOptions[setCompressionLevel]`.

=== Creating an HTTP client

You create an `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpClient.html[HttpClient]` instance with default options as follows:
...
By default the http client performs HTTP/1.1 requests, to perform HTTP/2 requests the `link:../enums.adoc#HttpClientOptions#method_HttpClientOptions[setProtocolVersion]`
...
`link:../enums.adoc#HttpClientOptions#method_HttpClientOptions[setHttp2ClearTextUpgrade]`options is set to false: after the
...
with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpClientResponse.html#method_HttpClientResponse[version]` when the response arrives.

When a clients connects to an HTTP/2 server, it sends to the server its `link:../enums.adoc#HttpClientOptions#method_HttpClientOptions[initial settings]`.
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpClient.html#method_HttpClient[getNow]`.
...
general purpose request methods such as `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpClient.html#method_HttpClient[request]` which allow you to specify
...
To do this you can call one of the specific request methods such as `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpClient.html#method_HttpClient[post]` or
one of the general purpose request methods such as `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpClient.html#method_HttpClient[request]`.

These methods don't send the request immediately, but instead return an instance of `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpClientRequest.html[HttpClientRequest]`
...
You can write headers to a request using the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpClientRequest.html#method_HttpClientRequest[headers]` multi-map as follows:
...
The headers are an instance of `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.MultiMap.html[MultiMap]` which provides operations for adding, setting and removing
entries. Http headers allow more than one value for a specific key.

You can also write headers using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpClientRequest.html#method_HttpClientRequest[putHeader]`
...
is used, `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpClientRequest.html#method_HttpClientRequest[setRawMethod]` must be used to
set the raw method to send to the server.

==== Ending HTTP requests

Once you have finished with the HTTP request you must end it with one of the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpClientRequest.html#method_HttpClientRequest[end]`
operations.
...
You put the HTTP request into chunked mode using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpClientRequest.html#method_HttpClientRequest[setChunked]`.
...
You can set a timeout for a specific http request using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpClientRequest.html#method_HttpClientRequest[setTimeout]`.
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpClientRequest.html[HttpClientRequest]`instance:
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpClientResponse.html[HttpClientResponse]`code:
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpClientRequest.html#method_HttpClientRequest[handler]`, for example:
...
The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpClientRequest.html[HttpClientRequest]` instance is also a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.streams.WriteStream<T>.html[WriteStream]` which means
you can pump to it from any `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.streams.ReadStream<T>.html[ReadStream]` instance.
...
To send such frames, you can use the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpClientRequest.html#method_HttpClientRequest[write]` on the request. Here's an example:
...
The request handler are notified of stream reset events with the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpClientRequest.html#method_HttpClientRequest[request handler]` and
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpClientResponse.html#method_HttpClientResponse[response handler]`:
...
You receive an instance of `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpClientResponse.html[HttpClientResponse]` into the handler that you specify in of
the request methods or by setting a handler directly on the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpClientRequest.html[HttpClientRequest]` object.

You can query the status code and the status message of the response with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpClientResponse.html#method_HttpClientResponse[statusCode]`
and `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpClientResponse.html#method_HttpClientResponse[statusMessage]`.
...
The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpClientResponse.html[HttpClientResponse]` instance is also a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.streams.ReadStream<T>.html[ReadStream]` which means
you can pump it to any `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.streams.WriteStream<T>.html[WriteStream]` instance.

==== Response headers and trailers

Http responses can contain headers. Use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpClientResponse.html#method_HttpClientResponse[headers]` to get the headers.

The object returned is a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.MultiMap.html[MultiMap]` as HTTP headers can contain multiple values for single keys.
...
You use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpClientResponse.html#method_HttpClientResponse[trailers]` to get the trailers. Trailers are also a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.MultiMap.html[MultiMap]`.
...
As parts of the response body arrive, the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpClientResponse.html#method_HttpClientResponse[handler]` is called with
a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.buffer.Buffer.html[Buffer]` representing the piece of the body:
...
Or you can use the convenience `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpClientResponse.html#method_HttpClientResponse[bodyHandler]` which
...
The response `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpClientResponse.html#method_HttpClientResponse[endHandler]` is called when the entire response body has been read
or immediately after the headers have been read and the response handler has been called if there is no body.

==== Reading cookies from the response

You can retrieve the list of cookies from a response using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpClientResponse.html#method_HttpClientResponse[cookies]`.
...
The maximum redirects is `16` by default and can be changed with `link:../enums.adoc#HttpClientOptions#method_HttpClientOptions[setMaxRedirects]`.
...
The policy handles the original `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpClientResponse.html[HttpClientResponse]` received and returns either `null`
...
* request headers, unless if you have set some headers (including `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpClientRequest.html#method_HttpClientRequest[setHost]`)
...
Vert.x allows you to set a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpClientRequest.html#method_HttpClientRequest[continueHandler]` on the
client request object

This will be called if the server sends back a `Status: 100 (Continue)` response to signify that it is ok to send
the rest of the request.

This is used in conjunction with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpClientRequest.html#method_HttpClientRequest[sendHead]`to send the head of the request.
...
This is done by setting the option `link:../enums.adoc#HttpServerOptions#method_HttpServerOptions[setHandle100ContinueAutomatically]`.

If you'd prefer to decide whether to send back continue responses manually, then this property should be set to
`false` (the default), then you can inspect the headers and call `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerResponse.html#method_HttpServerResponse[writeContinue]`
...
To enable compression set `link:../enums.adoc#HttpClientOptions#method_HttpClientOptions[setTryUseCompression]` on the options
...
For pooling to work, keep alive must be true using `link:../enums.adoc#HttpClientOptions#method_HttpClientOptions[setKeepAlive]`
...
The maximum number of connections to pool *for each server* is configured using `link:../enums.adoc#HttpClientOptions#method_HttpClientOptions[setMaxPoolSize]`
...
You can set the default timeout using `link:../enums.adoc#HttpClientOptions#method_HttpClientOptions[setKeepAliveTimeout]` - any
...
To enable pipe-lining, it must be enabled using `link:../enums.adoc#HttpClientOptions#method_HttpClientOptions[setPipelining]`.
By default pipe-lining is disabled.

When pipe-lining is enabled requests will be written to connections without waiting for previous responses to return.

The number of pipe-lined requests over a single connection is limited by `link:../enums.adoc#HttpClientOptions#method_HttpClientOptions[setPipeliningLimit]`.
...
When the clients needs to use more than a single connection and use pooling, the `link:../enums.adoc#HttpClientOptions#method_HttpClientOptions[setHttp2MaxPoolSize]`
shall be used.

When it is desirable to limit the number of multiplexed streams per connection and use a connection
pool instead of a single connection, `link:../enums.adoc#HttpClientOptions#method_HttpClientOptions[setHttp2MultiplexingLimit]`
can be used.
...
with the `link:../enums.adoc#Http2Settings#method_Http2Settings[SETTINGS_MAX_CONCURRENT_STREAMS]` setting.

HTTP/2 connections will not be closed by the client automatically. To close them you can call `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpConnection.html#method_HttpConnection[close]`
or close the client instance.

Alternatively you can set idle timeout using `link:../enums.adoc#HttpClientOptions#method_HttpClientOptions[setIdleTimeout]` - any
...
The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpConnection.html[HttpConnection]` offers the API for dealing with HTTP connection events, lifecycle
and settings.

HTTP/2 implements fully the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpConnection.html[HttpConnection]` API.

HTTP/1.x implements partially the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpConnection.html[HttpConnection]` API: only the close operation,
the close handler and exception handler are implemented. This protocol does not provide semantics for
the other operations.

==== Server connections

The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerRequest.html#method_HttpServerRequest[connection]` method returns the request connection on the server:
...
The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpClientRequest.html#method_HttpClientRequest[connection]` method returns the request connection on the client:
...
The configuration of an HTTP/2 is configured by the `link:../enums.adoc#Http2Settings[Http2Settings]` data object.
...
are configured by `link:../enums.adoc#HttpClientOptions#method_HttpClientOptions[setInitialSettings]` on the client and
`link:../enums.adoc#HttpServerOptions#method_HttpServerOptions[setInitialSettings]`on the server.
...
Conversely the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpConnection.html#method_HttpConnection[remoteSettingsHandler]` is notified
...
validity: `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpConnection.html#method_HttpConnection[ping]` sends a {@literal PING} frame to the remote
endpoint:
...
Calling `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpConnection.html#method_HttpConnection[shutdown]` will send a {@literal GOAWAY} frame to the
...
The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpConnection.html#method_HttpConnection[shutdownHandler]` notifies when all streams have been closed, the
...
The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpConnection.html#method_HttpConnection[shutdownHandler]` will be called when all current streams
...
Connection `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpConnection.html#method_HttpConnection[close]` closes the connection:
...
The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpConnection.html#method_HttpConnection[closeHandler]` notifies when a connection is closed.
...
SSL can also be enabled/disabled per request with `link:../enums.adoc#RequestOptions[RequestOptions]` or when
specifying a scheme with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpClient.html#method_HttpClient[requestAbs]`
method.
...
The `link:../enums.adoc#HttpClientOptions#method_HttpClientOptions[setSsl]` setting acts as the default client setting.

The `link:../enums.adoc#RequestOptions#method_RequestOptions[setSsl]` overrides the default client setting
...
Likewise `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpClient.html#method_HttpClient[requestAbs]` scheme
...
The first way involves providing a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServer.html#method_HttpServer[websocketHandler]`
on the server instance.

When a WebSocket connection is made to the server, the handler will be called, passing in an instance of
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.ServerWebSocket.html[ServerWebSocket]`.
...
You can choose to reject the WebSocket by calling `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.ServerWebSocket.html#method_ServerWebSocket[reject]`.
...
call `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerRequest.html#method_HttpServerRequest[upgrade]` on the server request.
...
The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.ServerWebSocket.html[ServerWebSocket]` instance enables you to retrieve the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.ServerWebSocket.html#method_ServerWebSocket[headers]`,
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.ServerWebSocket.html#method_ServerWebSocket[path]`, `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.ServerWebSocket.html#method_ServerWebSocket[query]` and
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.ServerWebSocket.html#method_ServerWebSocket[URI]`of the HTTP request of the WebSocket handshake.

==== WebSockets on the client

The Vert.x `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpClient.html[HttpClient]` supports WebSockets.

You can connect a WebSocket to a server using one of the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpClient.html#method_HttpClient[websocket]` operations and
providing a handler.

The handler will be called with an instance of `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.WebSocket.html[WebSocket]` when the connection has been made:
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.WebSocket.html#method_WebSocket[writeBinaryMessage]`or
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.WebSocket.html#method_WebSocket[writeTextMessage]`:
...
`link:../enums.adoc#HttpClientOptions#method_HttpClientOptions[setMaxWebsocketFrameSize]`
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.WebSocketFrame.html#method_WebSocketFrame[WebSocketFrame::binaryFrame]`
, `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.WebSocketFrame.html#method_WebSocketFrame[WebSocketFrame::textFrame]` or
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.WebSocketFrame.html#method_WebSocketFrame[WebSocketFrame::continuationFrame]`and write them
to the WebSocket using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.WebSocket.html#method_WebSocket[writeFrame]`.
...
of shortcut methods to do that with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.WebSocket.html#method_WebSocket[writeFinalBinaryFrame]`
and `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.WebSocket.html#method_WebSocket[writeFinalTextFrame]`.
...
To read frames from a WebSocket you use the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.WebSocket.html#method_WebSocket[frameHandler]`.

The frame handler will be called with instances of `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.WebSocketFrame.html[WebSocketFrame]` when a frame arrives,
for example:
...
Use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.WebSocketBase.html#method_WebSocketBase[close]` to close the WebSocket connection when you have finished with it.

==== Streaming WebSockets

The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.WebSocket.html[WebSocket]` instance is also a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.streams.ReadStream<T>.html[ReadStream]` and a
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.streams.WriteStream<T>.html[WriteStream]`so it can be used with pumps.
...
The proxy can be configured in the `link:../enums.adoc#HttpClientOptions[HttpClientOptions]` by setting a
`link:../enums.adoc#ProxyOptions[ProxyOptions]`object containing proxy type, hostname, port and optionally username and password.
