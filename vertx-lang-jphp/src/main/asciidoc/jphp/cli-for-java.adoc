...
The described `link:../vertx-jphp/enums.adoc#Option[Option]` and `link:../vertx-jphp/enums.adoc#Argument[Argument]` classes are _untyped_,
...
Instead of
`link:../vertx-jphp/enums.adoc#Option[Option]`and `link:../vertx-jphp/enums.adoc#Argument[Argument]`, use `TypedOption`
and `TypedArgument` in the `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.cli.CLI.html[CLI]` definition:
...
Once annotated, you can define the `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.cli.CLI.html[CLI]` and inject the values using:
