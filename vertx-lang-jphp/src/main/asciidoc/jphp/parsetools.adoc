...
For more details, check out the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.parsetools.RecordParser.html[RecordParser]` class.
...
For more details, check out the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.parsetools.JsonParser.html[JsonParser]` class.