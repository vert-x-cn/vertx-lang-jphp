...
Any flow control aware object that can be _written-to_ implements `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.streams.WriteStream<T>.html[WriteStream]`,
while any flow control object that can be _read-from_ is said to implement `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.streams.ReadStream<T>.html[ReadStream]`.
...
And there we have it. The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.streams.WriteStream<T>.html#method_WriteStream[drainHandler]` event handler will
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerRequest.html[HttpServerRequest]`, `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.eventbus.MessageConsumer<T>.html[MessageConsumer]`,
...
- `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.streams.ReadStream<T>.html#method_ReadStream[handler]`:
set a handler which will receive items from the ReadStream.
- `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.streams.ReadStream<T>.html#method_ReadStream[pause]`:
pause the handler. When paused no items will be received in the handler.
- `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.streams.ReadStream<T>.html#method_ReadStream[resume]`:
resume the handler. The handler will be called if any item arrives.
- `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.streams.ReadStream<T>.html#method_ReadStream[exceptionHandler]`:
Will be called if an exception occurs on the ReadStream.
- `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.streams.ReadStream<T>.html#method_ReadStream[endHandler]`:
...
and `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.eventbus.MessageProducer<T>.html[MessageProducer]`

Functions:

- `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.streams.WriteStream<T>.html#method_WriteStream[write]`:
write an object to the WriteStream. This method will never block. Writes are queued internally and asynchronously
written to the underlying resource.
- `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.streams.WriteStream<T>.html#method_WriteStream[setWriteQueueMaxSize]`:
set the number of object at which the write queue is considered _full_, and the method `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.streams.WriteStream<T>.html#method_WriteStream[writeQueueFull]`
...
- `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.streams.WriteStream<T>.html#method_WriteStream[writeQueueFull]`:
returns `true` if the write queue is considered full.
- `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.streams.WriteStream<T>.html#method_WriteStream[exceptionHandler]`:
Will be called if an exception occurs on the `WriteStream`.
- `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.streams.WriteStream<T>.html#method_WriteStream[drainHandler]`:
...
- `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.streams.Pump.html#method_Pump[start]`:
Start the pump.
- `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.streams.Pump.html#method_Pump[stop]`:
Stops the pump. When the pump starts it is in stopped mode.
- `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.streams.Pump.html#method_Pump[setWriteQueueMaxSize]`:
This has the same meaning as `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.streams.WriteStream<T>.html#method_WriteStream[setWriteQueueMaxSize]` on the `WriteStream`.
