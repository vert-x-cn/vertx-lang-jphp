...
In previous versions the `io.vertx.core.streams` package was manipulating `link:../../apidocs/io/vertx/core/buffer/Buffer.html[Buffer]`
...
[source,jphp]
----
/*variableDecl*/$server = $vertx.$createNetServer(NetServerOptions(
  port = 1234,
  host = "localhost"))
