...
To use UDP you first need t create a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.datagram.DatagramSocket.html[DatagramSocket]`. It does not matter here if you only want to send data or send
and receive.
...
The returned `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.datagram.DatagramSocket.html[DatagramSocket]` will not be bound to a specific port. This is not a
...
If you want to receive packets you need to bind the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.datagram.DatagramSocket.html[DatagramSocket]` by calling
`listen(...)}` on it.

This way you will be able to receive `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.datagram.DatagramPacket.html[DatagramPacket]`s that were sent to the address and port on
which the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.datagram.DatagramSocket.html[DatagramSocket]` listens.

Beside this you also want to set a `Handler` which will be called for each received `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.datagram.DatagramPacket.html[DatagramPacket]`.

The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.datagram.DatagramPacket.html[DatagramPacket]` has the following methods:

- `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.datagram.DatagramPacket.html#method_DatagramPacket[sender]`: The InetSocketAddress which represent the sender of the packet
- `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.datagram.DatagramPacket.html#method_DatagramPacket[data]`: The Buffer which holds the data which was received.
...
If you want to receive packets for specific Multicast group you need to bind the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.datagram.DatagramSocket.html[DatagramSocket]` by
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.datagram.DatagramSocket.html[DatagramSocket]`listens and also to those sent to the Multicast group.
...
When creating a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.datagram.DatagramSocket.html[DatagramSocket]` there are multiple properties you can set to
change it's behaviour with the `link:../enums.adoc#DatagramSocketOptions[DatagramSocketOptions]` object. Those are listed here:

- `link:../enums.adoc#DatagramSocketOptions#method_DatagramSocketOptions[setSendBufferSize]` Sets the send buffer size in bytes.
- `link:../enums.adoc#DatagramSocketOptions#method_DatagramSocketOptions[setReceiveBufferSize]` Sets the TCP receive buffer size
in bytes.
- `link:../enums.adoc#DatagramSocketOptions#method_DatagramSocketOptions[setReuseAddress]` If true then addresses in TIME_WAIT
state can be reused after they have been closed.
- `link:../enums.adoc#DatagramSocketOptions#method_DatagramSocketOptions[setTrafficClass]`
- `link:../enums.adoc#DatagramSocketOptions#method_DatagramSocketOptions[setBroadcast]` Sets or clears the SO_BROADCAST socket
option. When this option is set, Datagram (UDP) packets may be sent to a local interface's broadcast address.
- `link:../enums.adoc#DatagramSocketOptions#method_DatagramSocketOptions[setMulticastNetworkInterface]` Sets or clears
the IP_MULTICAST_LOOP socket option. When this option is set, multicast packets will also be received on the
local interface.
- `link:../enums.adoc#DatagramSocketOptions#method_DatagramSocketOptions[setMulticastTimeToLive]` Sets the IP_MULTICAST_TTL socket
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.datagram.DatagramSocket.html#method_DatagramSocket[localAddress]`. This will only return an `InetSocketAddress` if you
bound the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.datagram.DatagramSocket.html[DatagramSocket]` with `listen(...)` before, otherwise it will return null.

==== Closing a DatagramSocket

You can close a socket by invoking the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.datagram.DatagramSocket.html#method_DatagramSocket[close]` method. This will close
