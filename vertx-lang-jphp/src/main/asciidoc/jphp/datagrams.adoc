...
- `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.datagram.DatagramPacket.html#method_sender[sender]`: The InetSocketAddress which represent the sender of the packet
- `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.datagram.DatagramPacket.html#method_data[data]`: The Buffer which holds the data which was received.
...
- `link:../enums.adoc#DatagramSocketOptions#method_setSendBufferSize[setSendBufferSize]` Sets the send buffer size in bytes.
- `link:../enums.adoc#DatagramSocketOptions#method_setReceiveBufferSize[setReceiveBufferSize]` Sets the TCP receive buffer size
in bytes.
- `link:../enums.adoc#DatagramSocketOptions#method_setReuseAddress[setReuseAddress]` If true then addresses in TIME_WAIT
state can be reused after they have been closed.
- `link:../enums.adoc#DatagramSocketOptions#method_setTrafficClass[setTrafficClass]`
- `link:../enums.adoc#DatagramSocketOptions#method_setBroadcast[setBroadcast]` Sets or clears the SO_BROADCAST socket
option. When this option is set, Datagram (UDP) packets may be sent to a local interface's broadcast address.
- `link:../enums.adoc#DatagramSocketOptions#method_setMulticastNetworkInterface[setMulticastNetworkInterface]` Sets or clears
the IP_MULTICAST_LOOP socket option. When this option is set, multicast packets will also be received on the
local interface.
- `link:../enums.adoc#DatagramSocketOptions#method_setMulticastTimeToLive[setMulticastTimeToLive]` Sets the IP_MULTICAST_TTL socket
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.datagram.DatagramSocket.html#method_localAddress[localAddress]`. This will only return an `InetSocketAddress` if you
...
You can close a socket by invoking the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.datagram.DatagramSocket.html#method_close[close]` method. This will close
