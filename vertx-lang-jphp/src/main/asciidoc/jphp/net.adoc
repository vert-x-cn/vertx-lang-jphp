...
To tell the server to listen for incoming requests you use one of the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.net.NetServer.html#method_NetServer[listen]`
alternatives.
...
To find out the real port the server is listening on you can call `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.net.NetServer.html#method_NetServer[actualPort]`.
...
To be notified when a connection is made you need to set a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.net.NetServer.html#method_NetServer[connectHandler]`:
...
To read data from the socket you set the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.net.NetSocket.html#method_NetSocket[handler]` on the
socket.
...
You write to a socket using one of `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.net.NetSocket.html#method_NetSocket[write]`.
...
If you want to be notified when a socket is closed, you can set a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.net.NetSocket.html#method_NetSocket[closeHandler]`
on it:
...
You can set an `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.net.NetSocket.html#method_NetSocket[exceptionHandler]` to receive any
exceptions that happen on the socket.

You can set an `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.net.NetServer.html#method_NetServer[exceptionHandler]` to receive any
exceptions that happens before the connection is passed to the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.net.NetServer.html#method_NetServer[connectHandler]`
...
The address of the handler is given by `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.net.NetSocket.html#method_NetSocket[writeHandlerID]`

=== Local and remote addresses

The local address of a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.net.NetSocket.html[NetSocket]` can be retrieved using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.net.NetSocket.html#method_NetSocket[localAddress]`.
...
can be retrieved using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.net.NetSocket.html#method_NetSocket[remoteAddress]`.

=== Sending files or resources from the classpath

Files and classpath resources can be written to the socket directly using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.net.NetSocket.html#method_NetSocket[sendFile]`. This can be a very
...
Instances of `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.net.NetSocket.html[NetSocket]` are also `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.streams.ReadStream<T>.html[ReadStream]` and
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.streams.WriteStream<T>.html[WriteStream]`instances so they can be used to pump data to or from other
...
A non SSL/TLS connection can be upgraded to SSL/TLS using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.net.NetSocket.html#method_NetSocket[upgradeToSsl]`.
...
Call `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.net.NetServer.html#method_NetServer[close]` to close the server. Closing the server closes any open connections
...
To make a connection to a server you use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.net.NetClient.html#method_NetClient[connect]`,
...
This is configured with `link:../enums.adoc#NetClientOptions#method_NetClientOptions[setReconnectInterval]` and
`link:../enums.adoc#NetClientOptions#method_NetClientOptions[setReconnectAttempts]`.
...
SSL/TLS is enabled with  `link:../enums.adoc#NetServerOptions#method_NetServerOptions[ssl]`.
...
If the `link:../enums.adoc#ClientOptionsBase#method_ClientOptionsBase[trustALl]` is set to true on the client, then the client will
...
If `link:../enums.adoc#ClientOptionsBase#method_ClientOptionsBase[trustAll]` is not set then a client trust store must be
...
trust store location is set by using the function `link:../enums.adoc#JksOptions#method_JksOptions[path]` on the
...
`link:../enums.adoc#JksOptions#method_JksOptions[path]`on the
...
longer be trusted. The `link:../enums.adoc#NetClientOptions#method_NetClientOptions[crlPath]` configures
the crl list to use:
...
- the `link:../enums.adoc#TCPSSLOptions#method_TCPSSLOptions[getSslEngineOptions]` options when it is set
...
(`link:../enums.adoc#NetServerOptions#method_NetServerOptions[options]`) then an exact match with the trust store
alias is done
* otherwise the available CA certificates are used in the same way as if no SNI is in place

You can enable SNI on the server by setting `link:../enums.adoc#NetServerOptions#method_NetServerOptions[setSni]` to `true` and
...
OpenSSL requires to configure `link:../enums.adoc#TCPSSLOptions#method_TCPSSLOptions[setOpenSslEngineOptions]`
