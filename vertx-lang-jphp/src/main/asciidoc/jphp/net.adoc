...
If you don't want the default, a server can be configured by passing in a `link:../vertx-jphp/enums.adoc#NetServerOptions[NetServerOptions]`
...
To tell the server to listen for incoming requests you use one of the `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.net.NetServer.html#method_listen[listen]`
alternatives.
...
To find out the real port the server is listening on you can call `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.net.NetServer.html#method_actualPort[actualPort]`.
...
To be notified when a connection is made you need to set a `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.net.NetServer.html#method_connectHandler[connectHandler]`:
...
When a connection is made the handler will be called with an instance of `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.net.NetSocket.html[NetSocket]`.
...
To read data from the socket you set the `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.net.NetSocket.html#method_handler[handler]` on the
socket.

This handler will be called with an instance of `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.buffer.Buffer.html[Buffer]` every time data is received on
the socket.
...
You write to a socket using one of `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.net.NetSocket.html#method_write[write]`.
...
If you want to be notified when a socket is closed, you can set a `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.net.NetSocket.html#method_closeHandler[closeHandler]`
on it:
...
You can set an `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.net.NetSocket.html#method_exceptionHandler[exceptionHandler]` to receive any
exceptions that happen on the socket.

You can set an `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.net.NetServer.html#method_exceptionHandler[exceptionHandler]` to receive any
exceptions that happens before the connection is passed to the `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.net.NetServer.html#method_connectHandler[connectHandler]`
...
The address of the handler is given by `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.net.NetSocket.html#method_writeHandlerID[writeHandlerID]`

=== Local and remote addresses

The local address of a `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.net.NetSocket.html[NetSocket]` can be retrieved using `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.net.NetSocket.html#method_localAddress[localAddress]`.

The remote address, (i.e. the address of the other end of the connection) of a `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.net.NetSocket.html[NetSocket]`
can be retrieved using `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.net.NetSocket.html#method_remoteAddress[remoteAddress]`.

=== Sending files or resources from the classpath

Files and classpath resources can be written to the socket directly using `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.net.NetSocket.html#method_sendFile[sendFile]`. This can be a very
...
Instances of `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.net.NetSocket.html[NetSocket]` are also `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.streams.ReadStream.html[ReadStream]` and
`link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.streams.WriteStream.html[WriteStream]`instances so they can be used to pump data to or from other
...
A non SSL/TLS connection can be upgraded to SSL/TLS using `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.net.NetSocket.html#method_upgradeToSsl[upgradeToSsl]`.
...
Call `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.net.NetServer.html#method_close[close]` to close the server. Closing the server closes any open connections
...
If you don't want the default, a client can be configured by passing in a `link:../vertx-jphp/enums.adoc#NetClientOptions[NetClientOptions]`
instance when creating it:
...
To make a connection to a server you use `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.net.NetClient.html#method_connect[connect]`,
specifying the port and host of the server and a handler that will be called with a result containing the
`link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.net.NetSocket.html[NetSocket]`when connection is successful or with a failure if connection failed.
...
This is configured with `link:../vertx-jphp/enums.adoc#NetClientOptions#method_setReconnectInterval[setReconnectInterval]` and
`link:../vertx-jphp/enums.adoc#NetClientOptions#method_setReconnectAttempts[setReconnectAttempts]`.
...
the `link:../vertx-jphp/enums.adoc#NetClientOptions[NetClientOptions]` or `link:../vertx-jphp/enums.adoc#NetServerOptions[NetServerOptions]` instances used
to create the servers or clients.

==== Enabling SSL/TLS on the server

SSL/TLS is enabled with  `link:../vertx-jphp/enums.adoc#NetServerOptions#method_setSsl[ssl]`.
...
If the `link:../vertx-jphp/enums.adoc#ClientOptionsBase#method_setTrustAll[trustALl]` is set to true on the client, then the client will
...
If `link:../vertx-jphp/enums.adoc#ClientOptionsBase#method_setTrustAll[trustAll]` is not set then a client trust store must be
...
trust store location is set by using the function `link:../vertx-jphp/enums.adoc#JksOptions#method_setPath[path]` on the
`link:../vertx-jphp/enums.adoc#JksOptions[jks options]`. If a server presents a certificate during connection which is not
...
`link:../vertx-jphp/enums.adoc#JksOptions#method_setPath[path]`on the
`link:../vertx-jphp/enums.adoc#JksOptions[jks options]`.
...
`link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.net.SelfSignedCertificate.html[SelfSignedCertificate]`can be used to provide self-signed PEM certificate helpers and
...
longer be trusted. The `link:../vertx-jphp/enums.adoc#NetClientOptions#method_addCrlPath[crlPath]` configures
the crl list to use:
...
Cipher suite can be specified on the `link:../vertx-jphp/enums.adoc#NetServerOptions[NetServerOptions]` or `link:../vertx-jphp/enums.adoc#NetClientOptions[NetClientOptions]` configuration.
...
Protocol versions can be specified on the `link:../vertx-jphp/enums.adoc#NetServerOptions[NetServerOptions]` or `link:../vertx-jphp/enums.adoc#NetClientOptions[NetClientOptions]` configuration.
...
- the `link:../vertx-jphp/enums.adoc#TCPSSLOptions#method_getSslEngineOptions[getSslEngineOptions]` options when it is set
- otherwise `link:../vertx-jphp/enums.adoc#JdkSSLEngineOptions[JdkSSLEngineOptions]`
...
* if `link:../vertx-jphp/enums.adoc#JksOptions[JksOptions]` were used to set the trust options
(`link:../vertx-jphp/enums.adoc#NetServerOptions#method_setTrustOptions[options]`) then an exact match with the trust store
alias is done
* otherwise the available CA certificates are used in the same way as if no SNI is in place

You can enable SNI on the server by setting `link:../vertx-jphp/enums.adoc#NetServerOptions#method_setSni[setSni]` to `true` and
...
`link:../vertx-jphp/enums.adoc#PemKeyCertOptions[PemKeyCertOptions]`can be configured to hold multiple entries:
...
- the `link:../vertx-jphp/enums.adoc#TCPSSLOptions#method_getSslEngineOptions[getSslEngineOptions]` options when it is set
- `link:../vertx-jphp/enums.adoc#JdkSSLEngineOptions[JdkSSLEngineOptions]` when ALPN is available for JDK
- `link:../vertx-jphp/enums.adoc#OpenSSLEngineOptions[OpenSSLEngineOptions]` when ALPN is available for OpenSSL
- otherwise it fails
...
OpenSSL requires to configure `link:../vertx-jphp/enums.adoc#TCPSSLOptions#method_setOpenSslEngineOptions[setOpenSslEngineOptions]`
...
The `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.net.NetClient.html[NetClient]` supports either a HTTP/1.x _CONNECT_, _SOCKS4a_ or _SOCKS5_ proxy.

The proxy can be configured in the `link:../vertx-jphp/enums.adoc#NetClientOptions[NetClientOptions]` by setting a
