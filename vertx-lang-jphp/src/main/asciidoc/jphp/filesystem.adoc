...
The Vert.x `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.file.FileSystem.html[FileSystem]` object provides many operations for manipulating the file system.

There is one file system object per Vert.x instance, and you obtain it with  `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.Vertx.html#method_fileSystem[fileSystem]`.
...
please consult the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.file.FileSystem.html[API docs]` for the full list.
...
You open an `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.file.AsyncFile.html[AsyncFile]` as follows:
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.file.AsyncFile.html#method_write[write]`method.
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.file.AsyncFile.html#method_read[read]`
method.
...
When opening an `AsyncFile`, you pass an `link:../enums.adoc#OpenOptions[OpenOptions]` instance.
These options describe the behavior of the file access. For instance, you can configure the file permissions with the
`link:../enums.adoc#OpenOptions#method_setRead[setRead]`, `link:../enums.adoc#OpenOptions#method_setWrite[setWrite]`
and `link:../enums.adoc#OpenOptions#method_setPerms[setPerms]` methods.

You can also configure the behavior if the open file already exists with
`link:../enums.adoc#OpenOptions#method_setCreateNew[setCreateNew]`and
`link:../enums.adoc#OpenOptions#method_setTruncateExisting[setTruncateExisting]`.

You can also mark the file to be deleted on
close or when the JVM is shutdown with `link:../enums.adoc#OpenOptions#method_setDeleteOnClose[setDeleteOnClose]`.

==== Flushing data to underlying storage.

In the `OpenOptions`, you can enable/disable the automatic synchronisation of the content on every write using
`link:../enums.adoc#OpenOptions#method_setDsync[setDsync]`. In that case, you can manually flush any writes from the OS
cache by calling the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.file.AsyncFile.html#method_flush[flush]` method.
...
This caching behaviour can be set on the `link:../enums.adoc#VertxOptions#method_setFileResolverCachingEnabled[setFileResolverCachingEnabled]`
...
To close an `AsyncFile` call the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.file.AsyncFile.html#method_close[close]` method. Closing is asynchronous and
