...
There is one file system object per Vert.x instance, and you obtain it with  `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.Vertx.html#method_Vertx[fileSystem]`.
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.file.AsyncFile.html#method_AsyncFile[write]`method.
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.file.AsyncFile.html#method_AsyncFile[read]`
method.
...
`link:../enums.adoc#OpenOptions#method_OpenOptions[setRead]`, `link:../enums.adoc#OpenOptions#method_OpenOptions[setWrite]`
and `link:../enums.adoc#OpenOptions#method_OpenOptions[setPerms]` methods.

You can also configure the behavior if the open file already exists with
`link:../enums.adoc#OpenOptions#method_OpenOptions[setCreateNew]`and
`link:../enums.adoc#OpenOptions#method_OpenOptions[setTruncateExisting]`.

You can also mark the file to be deleted on
close or when the JVM is shutdown with `link:../enums.adoc#OpenOptions#method_OpenOptions[setDeleteOnClose]`.

==== Flushing data to underlying storage.

In the `OpenOptions`, you can enable/disable the automatic synchronisation of the content on every write using
`link:../enums.adoc#OpenOptions#method_OpenOptions[setDsync]`. In that case, you can manually flush any writes from the OS
cache by calling the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.file.AsyncFile.html#method_AsyncFile[flush]` method.
...
This caching behaviour can be set on the `link:../enums.adoc#VertxOptions#method_VertxOptions[setFileResolverCachingEnabled]`
...
To close an `AsyncFile` call the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.file.AsyncFile.html#method_AsyncFile[close]` method. Closing is asynchronous and
