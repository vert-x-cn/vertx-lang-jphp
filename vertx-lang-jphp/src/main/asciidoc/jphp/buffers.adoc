...
[source,jphp]
----
/*variableDecl*/$buff = Buffer.$buffer()
...
[source,jphp]
----
/*variableDecl*/$buff = Buffer.$buffer("some string")
...
[source,jphp]
----
/*variableDecl*/$buff = Buffer.$buffer("some string", "UTF-16")
...
[source,jphp]
----
/*variableDecl*/$buff = Buffer.$buffer(10000)
...
----
/*variableDecl*/$buff = Buffer.$buffer()
/*forLoop*/for (/*variableDecl*/$i = 0; $i < $buff.$length(); 4) {
...
[source,jphp]
----
/*variableDecl*/$buff = Buffer.$buffer(128)
/*variableDecl*/$pos = 15
