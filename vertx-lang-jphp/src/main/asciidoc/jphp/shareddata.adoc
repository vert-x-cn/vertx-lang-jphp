...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.shareddata.LocalMap<K,V>.html[Local shared maps]`allow you to share data safely between different event
...
You get an instance of `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.shareddata.AsyncMap<K,V>.html[AsyncMap]` with
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.shareddata.SharedData.html#method_SharedData[getAsyncMap]`.
...
You put data in a map with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.shareddata.AsyncMap<K,V>.html#method_AsyncMap[put]`.
...
You get data from a map with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.shareddata.AsyncMap<K,V>.html#method_AsyncMap[get]`.
...
See the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.shareddata.AsyncMap<K,V>.html[API docs]` for more information.
...
To obtain a lock use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.shareddata.SharedData.html#method_SharedData[getLock]`.
...
When you've finished with the lock, you call `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.shareddata.Lock.html#method_Lock[release]` to release it, so
...
You obtain an instance with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.shareddata.SharedData.html#method_SharedData[getCounter]`:
