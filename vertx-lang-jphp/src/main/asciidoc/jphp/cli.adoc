...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.cli.CLI.html#method_CLI[CLI::create]`. The passed string is the name of the CLI. Once created you
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.cli.CLI.html#method_CLI[addArgument]`and
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.cli.CLI.html#method_CLI[addOption]`methods.
...
`link:../enums.adoc#Option#method_Option[setFlag]`. By default, options receive a single value, however, you can
configure the option to receive several values using `link:../enums.adoc#Option#method_Option[setMultiValued]`:
...
An option can be _hidden_ using the `link:../enums.adoc#Option#method_Option[setHidden]` method. Hidden option are
...
* be hidden using `link:../enums.adoc#Argument#method_Argument[setHidden]`
* be mandatory using `link:../enums.adoc#Argument#method_Argument[setRequired]`
* have a default value using `link:../enums.adoc#Argument#method_Argument[setDefaultValue]`
* receive several values using `link:../enums.adoc#Argument#method_Argument[setMultiValued]` - only the last argument
can be multi-valued.
...
The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.cli.CLI.html#method_CLI[parse]` method returns a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.cli.CommandLine.html[CommandLine]`
...
validation by passing `false` as second parameter of `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.cli.CLI.html#method_CLI[parse]`.
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.cli.CommandLine.html[CommandLine]`is valid using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.cli.CommandLine.html#method_CommandLine[isValid]`.

=== Query / Interrogation Stage

Once parsed, you can retrieve the values of the options and arguments from the
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.cli.CommandLine.html[CommandLine]`object returned by the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.cli.CLI.html#method_CLI[parse]`
method:
