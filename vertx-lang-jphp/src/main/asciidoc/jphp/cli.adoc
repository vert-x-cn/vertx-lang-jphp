...
name. The CLI API uses the `link:../vertx-jphp/enums.adoc#Option[Option]` and `link:../vertx-jphp/enums.adoc#Argument[Argument]` classes to
...
As you can see, you can create a new `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.cli.CLI.html[CLI]` using
`link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.cli.CLI.html#method_create[CLI::create]`. The passed string is the name of the CLI. Once created you
...
`link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.cli.CLI.html#method_addArgument[addArgument]`and
`link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.cli.CLI.html#method_addOption[addOption]`methods.

==== Options

An `link:../vertx-jphp/enums.adoc#Option[Option]` is a command line parameter identified by a _key_ present in the user command
...
`link:../vertx-jphp/enums.adoc#Option#method_setFlag[setFlag]`. By default, options receive a single value, however, you can
configure the option to receive several values using `link:../vertx-jphp/enums.adoc#Option#method_setMultiValued[setMultiValued]`:
...
An option can be _hidden_ using the `link:../vertx-jphp/enums.adoc#Option#method_setHidden[setHidden]` method. Hidden option are
...
As options, `link:../vertx-jphp/enums.adoc#Argument[Argument]` can:

* be hidden using `link:../vertx-jphp/enums.adoc#Argument#method_setHidden[setHidden]`
* be mandatory using `link:../vertx-jphp/enums.adoc#Argument#method_setRequired[setRequired]`
* have a default value using `link:../vertx-jphp/enums.adoc#Argument#method_setDefaultValue[setDefaultValue]`
* receive several values using `link:../vertx-jphp/enums.adoc#Argument#method_setMultiValued[setMultiValued]` - only the last argument
can be multi-valued.
...
Once your `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.cli.CLI.html[CLI]` instance is configured, you can generate the _usage_ message:
...
Once your `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.cli.CLI.html[CLI]` instance is configured, you can parse the user command line to evaluate
...
The `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.cli.CLI.html#method_parse[parse]` method returns a `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.cli.CommandLine.html[CommandLine]`
...
validation by passing `false` as second parameter of `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.cli.CLI.html#method_parse[parse]`.
...
`link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.cli.CommandLine.html[CommandLine]`is valid using `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.cli.CommandLine.html#method_isValid[isValid]`.

=== Query / Interrogation Stage

Once parsed, you can retrieve the values of the options and arguments from the
`link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.cli.CommandLine.html[CommandLine]`object returned by the `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.cli.CLI.html#method_parse[parse]`
method:
