...
public class MySQLClient extends VertxGenVariable0Wrapper<io.vertx.ext.asyncsql.MySQLClient>{
    
    private MySQLClient(Environment env, io.vertx.ext.asyncsql.MySQLClient wrappedObject){
        super(env, wrappedObject);
    }
    public static  MySQLClient __create(Environment env, io.vertx.ext.asyncsql.MySQLClient wrappedObject){
        return new MySQLClient(env, wrappedObject);
    }
    ...
    public static Memory createNonShared(Environment __ENV__, Memory arg0, Memory arg1) {
        if(Utils.isNotNull(arg0) && Utils.isVertxGen(io.vertx.core.Vertx.class, Vertx.class, arg0) && Utils.isNotNull(arg1) && Utils.isJsonObject(__ENV__, arg1)) {
            return Utils.<io.vertx.ext.asyncsql.AsyncSQLClient, AsyncSQLClient>convReturnVertxGenVariable0(__ENV__, AsyncSQLClient.class, AsyncSQLClient::__create, io.vertx.ext.asyncsql.MySQLClient.createNonShared(Utils.  <io.vertx.core.Vertx, Vertx  >convParamVertxGenVariable0(__ENV__, Vertx.class, Vertx::__create, arg0), Utils.convParamJsonObject(__ENV__, arg1)));
        }/*2*/ else {
            throw new RuntimeException("function invoked with invalid arguments");
        }
    }/*1*/
    ...
    public static Memory createShared(Environment __ENV__, Memory arg0, Memory arg1) {
        if(Utils.isNotNull(arg0) && Utils.isVertxGen(io.vertx.core.Vertx.class, Vertx.class, arg0) && Utils.isNotNull(arg1) && Utils.isJsonObject(__ENV__, arg1)) {
            return Utils.<io.vertx.ext.asyncsql.AsyncSQLClient, AsyncSQLClient>convReturnVertxGenVariable0(__ENV__, AsyncSQLClient.class, AsyncSQLClient::__create, io.vertx.ext.asyncsql.MySQLClient.createShared(Utils.  <io.vertx.core.Vertx, Vertx  >convParamVertxGenVariable0(__ENV__, Vertx.class, Vertx::__create, arg0), Utils.convParamJsonObject(__ENV__, arg1)));
        }/*3*/ else {
            throw new RuntimeException("function invoked with invalid arguments");
        }
    }/*4*/
