...
public class GoogleAuth extends VertxGenVariable0Wrapper<io.vertx.ext.auth.oauth2.providers.GoogleAuth>{
    
    private GoogleAuth(Environment env, io.vertx.ext.auth.oauth2.providers.GoogleAuth wrappedObject){
        super(env, wrappedObject);
    }
    public static  GoogleAuth __create(Environment env, io.vertx.ext.auth.oauth2.providers.GoogleAuth wrappedObject){
        return new GoogleAuth(env, wrappedObject);
    }
    ...
    public static Memory create(Environment __ENV__, Memory arg0, Memory arg1) {
        if(Utils.isNotNull(arg0) && Utils.isVertxGen(io.vertx.core.Vertx.class, Vertx.class, arg0) && Utils.isNotNull(arg1) && Utils.isJsonObject(__ENV__, arg1)) {
            return Utils.<io.vertx.ext.auth.oauth2.OAuth2Auth, OAuth2Auth>convReturnVertxGenVariable0(__ENV__, OAuth2Auth.class, OAuth2Auth::__create, io.vertx.ext.auth.oauth2.providers.GoogleAuth.create(Utils.  <io.vertx.core.Vertx, Vertx  >convParamVertxGenVariable0(__ENV__, Vertx.class, Vertx::__create, arg0), Utils.convParamJsonObject(__ENV__, arg1)));
        }/*3*/ else {
