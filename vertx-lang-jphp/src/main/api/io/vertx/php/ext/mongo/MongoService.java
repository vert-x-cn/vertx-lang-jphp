...
public class MongoService extends VertxGenVariable0Wrapper<io.vertx.ext.mongo.MongoService>{
    ...
    private MongoService(Environment env, io.vertx.ext.mongo.MongoService wrappedObject){
        super(env, wrappedObject);
    }
    public static  MongoService __create(Environment env, io.vertx.ext.mongo.MongoService wrappedObject){
        return new MongoService(env, wrappedObject);
    }

    @Signature
    public static Memory createEventBusProxy(Environment __ENV__, Memory arg0, Memory arg1) {
        if(Utils.isNotNull(arg0) && Utils.isVertxGen(io.vertx.core.Vertx.class, Vertx.class, arg0) && Utils.isNotNull(arg1) && Utils.isString(__ENV__, arg1)) {
            return Utils.<io.vertx.ext.mongo.MongoService, MongoService>convReturnVertxGenVariable0(__ENV__, MongoService.class, MongoService::__create, io.vertx.ext.mongo.MongoService.createEventBusProxy(Utils.  <io.vertx.core.Vertx, Vertx  >convParamVertxGenVariable0(__ENV__, Vertx.class, Vertx::__create, arg0), Utils.convParamString(__ENV__, arg1)));
        }/*2*/ else {
