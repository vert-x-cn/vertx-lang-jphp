package io.vertx.php.ext.web.templ.handlebars;
...
@Namespace("io\\vertx\\php\\ext\\web\\templ\\handlebars")
...
public class HandlebarsTemplateEngine extends VertxGenVariable0Wrapper<io.vertx.ext.web.templ.handlebars.HandlebarsTemplateEngine>{
    ...
    private HandlebarsTemplateEngine(Environment env, io.vertx.ext.web.templ.handlebars.HandlebarsTemplateEngine wrappedObject){
        super(env, wrappedObject);
    }
    public static  HandlebarsTemplateEngine __create(Environment env, io.vertx.ext.web.templ.handlebars.HandlebarsTemplateEngine wrappedObject){
        return new HandlebarsTemplateEngine(env, wrappedObject);
    }
    ...
    public static Memory create(Environment __ENV__) {
        return Utils.<io.vertx.ext.web.templ.handlebars.HandlebarsTemplateEngine, HandlebarsTemplateEngine>convReturnVertxGenVariable0(__ENV__, HandlebarsTemplateEngine.class, HandlebarsTemplateEngine::__create, io.vertx.ext.web.templ.handlebars.HandlebarsTemplateEngine.create());
    }/*1*/
