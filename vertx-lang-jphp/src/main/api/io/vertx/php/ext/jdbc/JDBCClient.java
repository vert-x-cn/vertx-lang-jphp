...
import io.vertx.php.ext.sql.ResultSet;
...
import io.vertx.php.ext.sql.UpdateResult;
...
public class JDBCClient extends VertxGenVariable0Wrapper<io.vertx.ext.jdbc.JDBCClient>{
    
    private JDBCClient(Environment env, io.vertx.ext.jdbc.JDBCClient wrappedObject){
        super(env, wrappedObject);
    }
    public static  JDBCClient __create(Environment env, io.vertx.ext.jdbc.JDBCClient wrappedObject){
        return new JDBCClient(env, wrappedObject);
    }
    ...
    public static Memory createNonShared(Environment __ENV__, Memory arg0, Memory arg1) {
        if(Utils.isNotNull(arg0) && Utils.isVertxGen(io.vertx.core.Vertx.class, Vertx.class, arg0) && Utils.isNotNull(arg1) && Utils.isJsonObject(__ENV__, arg1)) {
            return Utils.<io.vertx.ext.jdbc.JDBCClient, JDBCClient>convReturnVertxGenVariable0(__ENV__, JDBCClient.class, JDBCClient::__create, io.vertx.ext.jdbc.JDBCClient.createNonShared(Utils.  <io.vertx.core.Vertx, Vertx  >convParamVertxGenVariable0(__ENV__, Vertx.class, Vertx::__create, arg0), Utils.convParamJsonObject(__ENV__, arg1)));
        }/*2*/ else {
            throw new RuntimeException("function invoked with invalid arguments");
        }
    }/*1*/
    ...
    public static Memory createShared(Environment __ENV__, Memory arg0, Memory arg1) {
        if(Utils.isNotNull(arg0) && Utils.isVertxGen(io.vertx.core.Vertx.class, Vertx.class, arg0) && Utils.isNotNull(arg1) && Utils.isJsonObject(__ENV__, arg1)) {
            return Utils.<io.vertx.ext.jdbc.JDBCClient, JDBCClient>convReturnVertxGenVariable0(__ENV__, JDBCClient.class, JDBCClient::__create, io.vertx.ext.jdbc.JDBCClient.createShared(Utils.  <io.vertx.core.Vertx, Vertx  >convParamVertxGenVariable0(__ENV__, Vertx.class, Vertx::__create, arg0), Utils.convParamJsonObject(__ENV__, arg1)));
        }/*3*/ else {
            throw new RuntimeException("function invoked with invalid arguments");
        }
    }/*4*/
