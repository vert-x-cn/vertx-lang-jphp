package io.vertx.php.ext.web.templ.rocker;
...
@Name("RockerTemplateEngine")
@Namespace("io\\vertx\\php\\ext\\web\\templ\\rocker")
@SuppressWarnings("ALL")
public class RockerTemplateEngine extends VertxGenVariable0Wrapper<io.vertx.ext.web.templ.rocker.RockerTemplateEngine>{
    
    private RockerTemplateEngine(Environment env, io.vertx.ext.web.templ.rocker.RockerTemplateEngine wrappedObject){
        super(env, wrappedObject);
    }
    public static  RockerTemplateEngine __create(Environment env, io.vertx.ext.web.templ.rocker.RockerTemplateEngine wrappedObject){
        return new RockerTemplateEngine(env, wrappedObject);
    }
    ...
    public static Memory create(Environment __ENV__) {
        return Utils.<io.vertx.ext.web.templ.rocker.RockerTemplateEngine, RockerTemplateEngine>convReturnVertxGenVariable0(__ENV__, RockerTemplateEngine.class, RockerTemplateEngine::__create, io.vertx.ext.web.templ.rocker.RockerTemplateEngine.create());
    }/*1*/
