...
public class LocalSessionStore extends VertxGenVariable0Wrapper<io.vertx.ext.web.sstore.LocalSessionStore>{
    
    private LocalSessionStore(Environment env, io.vertx.ext.web.sstore.LocalSessionStore wrappedObject){
        super(env, wrappedObject);
    }
    public static  LocalSessionStore __create(Environment env, io.vertx.ext.web.sstore.LocalSessionStore wrappedObject){
        return new LocalSessionStore(env, wrappedObject);
    }
    ...
    public static Memory create(Environment __ENV__, Memory arg0) {
        if(Utils.isNotNull(arg0) && Utils.isVertxGen(io.vertx.core.Vertx.class, Vertx.class, arg0)) {
            return Utils.<io.vertx.ext.web.sstore.LocalSessionStore, LocalSessionStore>convReturnVertxGenVariable0(__ENV__, LocalSessionStore.class, LocalSessionStore::__create, io.vertx.ext.web.sstore.LocalSessionStore.create(Utils.  <io.vertx.core.Vertx, Vertx  >convParamVertxGenVariable0(__ENV__, Vertx.class, Vertx::__create, arg0)));
        }/*3*/ else {
            throw new RuntimeException("function invoked with invalid arguments");
        }
    }/*4*/
