...
public class BasicAuthHandler extends VertxGenVariable0Wrapper<io.vertx.ext.web.handler.BasicAuthHandler>{
    
    private BasicAuthHandler(Environment env, io.vertx.ext.web.handler.BasicAuthHandler wrappedObject){
        super(env, wrappedObject);
    }
    public static  BasicAuthHandler __create(Environment env, io.vertx.ext.web.handler.BasicAuthHandler wrappedObject){
        return new BasicAuthHandler(env, wrappedObject);
    }
    ...
    public static Memory create(Environment __ENV__, Memory arg0) {
        if(Utils.isNotNull(arg0) && Utils.isVertxGen(io.vertx.ext.auth.AuthProvider.class, AuthProvider.class, arg0)) {
            return Utils.<io.vertx.ext.web.handler.AuthHandler, AuthHandler>convReturnVertxGenVariable0(__ENV__, AuthHandler.class, AuthHandler::__create, io.vertx.ext.web.handler.BasicAuthHandler.create(Utils.  <io.vertx.ext.auth.AuthProvider, AuthProvider  >convParamVertxGenVariable0(__ENV__, AuthProvider.class, AuthProvider::__create, arg0)));
        }/*3*/ else {
            throw new RuntimeException("function invoked with invalid arguments");
        }
    }/*4*/
    ...
    public static Memory create(Environment __ENV__, Memory arg0, Memory arg1) {
        if(Utils.isNotNull(arg0) && Utils.isVertxGen(io.vertx.ext.auth.AuthProvider.class, AuthProvider.class, arg0) && Utils.isNotNull(arg1) && Utils.isString(__ENV__, arg1)) {
            return Utils.<io.vertx.ext.web.handler.AuthHandler, AuthHandler>convReturnVertxGenVariable0(__ENV__, AuthHandler.class, AuthHandler::__create, io.vertx.ext.web.handler.BasicAuthHandler.create(Utils.  <io.vertx.ext.auth.AuthProvider, AuthProvider  >convParamVertxGenVariable0(__ENV__, AuthProvider.class, AuthProvider::__create, arg0), Utils.convParamString(__ENV__, arg1)));
        }/*2*/ else {
            throw new RuntimeException("function invoked with invalid arguments");
        }
    }/*1*/
