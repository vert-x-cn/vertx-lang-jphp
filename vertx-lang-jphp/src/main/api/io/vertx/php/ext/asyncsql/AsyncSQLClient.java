...
public class AsyncSQLClient extends VertxGenVariable0Wrapper<io.vertx.ext.asyncsql.AsyncSQLClient>{
    
    private AsyncSQLClient(Environment env, io.vertx.ext.asyncsql.AsyncSQLClient wrappedObject){
        super(env, wrappedObject);
    }
    public static  AsyncSQLClient __create(Environment env, io.vertx.ext.asyncsql.AsyncSQLClient wrappedObject){
        return new AsyncSQLClient(env, wrappedObject);
    }
