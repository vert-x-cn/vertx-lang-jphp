...
public class WebSocketBase extends VertxGenVariable0Wrapper<io.vertx.core.http.WebSocketBase>{
    
    private WebSocketBase(Environment env, io.vertx.core.http.WebSocketBase wrappedObject){
        super(env, wrappedObject);
    }
    public static  WebSocketBase __create(Environment env, io.vertx.core.http.WebSocketBase wrappedObject){
        return new WebSocketBase(env, wrappedObject);
    }
