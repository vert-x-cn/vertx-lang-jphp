...
//false
public  class NetClientOptions extends DataObjectWrapper<io.vertx.core.net.NetClientOptions> { 
    ...
    public Memory __construct(){
        this.__wrappedObject = new io.vertx.core.net.NetClientOptions();
        return Memory.NULL;    }
    ...
    @Signature
    public NetClientOptions addCrlPath(String crlPaths){ 
    ...
    @Signature
    public NetClientOptions addEnabledCipherSuite(String enabledCipherSuites){ 
    ...
    @Signature
    public NetClientOptions addEnabledSecureTransportProtocol(String enabledSecureTransportProtocols){ 
