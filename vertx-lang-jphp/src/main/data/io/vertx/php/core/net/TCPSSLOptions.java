...
//true
public  class TCPSSLOptions extends DataObjectWrapper<io.vertx.core.net.TCPSSLOptions> { 
    ...
    @Signature
    public TCPSSLOptions addCrlPath(String crlPaths){ 
    ...
    @Signature
    public TCPSSLOptions addEnabledCipherSuite(String enabledCipherSuites){ 
    ...
    @Signature
    public TCPSSLOptions addEnabledSecureTransportProtocol(String enabledSecureTransportProtocols){ 
