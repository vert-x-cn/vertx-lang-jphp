...
@Name("EventBusOptions")
@Namespace("io\\vertx\\php\\core\\eventbus")
//false
public  class EventBusOptions extends DataObjectWrapper<io.vertx.core.eventbus.EventBusOptions> { 
    ...
    public Memory __construct(){
        this.__wrappedObject = new io.vertx.core.eventbus.EventBusOptions();
        return Memory.NULL;    }
    ...
    @Signature
    public EventBusOptions addCrlPath(String crlPaths){ 
    ...
    @Signature
    public EventBusOptions addEnabledCipherSuite(String enabledCipherSuites){ 
    ...
    @Signature
    public EventBusOptions addEnabledSecureTransportProtocol(String enabledSecureTransportProtocols){ 
