...
//true
public  class ClientOptionsBase extends DataObjectWrapper<io.vertx.core.net.ClientOptionsBase> { 
    ...
    @Signature
    public ClientOptionsBase setEnabledSecureTransportProtocols(Set<String> enabledSecureTransportProtocols){ 
