...
//false
public  class HttpClientOptions extends DataObjectWrapper<io.vertx.core.http.HttpClientOptions> { 
    ...
    public Memory __construct(){
        this.__wrappedObject = new io.vertx.core.http.HttpClientOptions();
        return Memory.NULL;    }
