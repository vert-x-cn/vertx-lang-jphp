...
public abstract class ClientOptionsBase extends TCPSSLOptions { 
    ...
    @Signature
    public ClientOptionsBase addCrlPath(java.lang.String crlPaths){ 
    ...
    @Signature
    public ClientOptionsBase addEnabledCipherSuite(java.lang.String enabledCipherSuites){ 
    ...
    @Signature
    public ClientOptionsBase addEnabledSecureTransportProtocol(java.lang.String enabledSecureTransportProtocols){ 
