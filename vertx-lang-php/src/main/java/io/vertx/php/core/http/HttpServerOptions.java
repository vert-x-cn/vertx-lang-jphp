...
@Name("io\\vertx\\php\\core\\http\\HttpServerOptions")
public class HttpServerOptions extends NetServerOptions { 
    ...
    public Memory __construct(Memory memory) {
        if (memory instanceof ObjectMemory && ((ObjectMemory) memory).value instanceof HttpServerOptions) {
            io.vertx.core.http.HttpServerOptions value = (io.vertx.core.http.HttpServerOptions)((HttpServerOptions) ((ObjectMemory)memory).value).__wrappedObject;
            this.__wrappedObject = new io.vertx.core.http.HttpServerOptions(value);
        } else {
    ...
    public io.vertx.core.http.HttpServerOptions getWrappedObject(){
        return (io.vertx.core.http.HttpServerOptions)__wrappedObject;
    }
    ...
    @Signature
    public HttpServerOptions addCrlPath(java.lang.String crlPaths){ 
    ...
    @Signature
    public HttpServerOptions addEnabledCipherSuite(java.lang.String enabledCipherSuites){ 
    ...
    @Signature
    public HttpServerOptions addEnabledSecureTransportProtocol(java.lang.String enabledSecureTransportProtocols){ 
