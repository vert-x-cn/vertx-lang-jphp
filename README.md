...
[![Sonatype Nexus (Snapshots)](https://img.shields.io/nexus/s/https/oss.sonatype.org/tk.okou/vertx-lang-jphp.svg)](https://oss.sonatype.org/#nexus-search;gav~tk.okou~vertx-lang-jphp~3.6.1-SNAPSHOT~~)
...
```groovy
dependencies {
  compile 'tk.okou:vertx-lang-jphp:3.6.1-SNAPSHOT'
}
```
