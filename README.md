...
[![Sonatype Nexus (Snapshots)](https://img.shields.io/nexus/snapshots/https/oss.sonatype.org/tk.okou/vertx-lang-jphp.svg)](https://oss.sonatype.org/#nexus-search;gav~tk.okou~vertx-lang-jphp~3.7.2-SNAPSHOT~~)
...
```groovy
dependencies {
  compile 'tk.okou:vertx-lang-jphp:3.7.2-SNAPSHOT'
}
```
