...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.mongo.MongoAuth.html#method_MongoAuth[setCollectionName]`
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.mongo.MongoAuth.html#method_MongoAuth[setUsernameField]`
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.mongo.MongoAuth.html#method_MongoAuth[setPasswordField]`
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.mongo.MongoAuth.html#method_MongoAuth[setPermissionField]`
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.mongo.MongoAuth.html#method_MongoAuth[setRoleField]`
...
stored can be set by `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.mongo.MongoAuth.html#method_MongoAuth[setSaltField]`, the default is "salt".
You are able to change this behaviour by using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.mongo.HashStrategy.html#method_HashStrategy[setSaltStyle]`.
The HashStrategy you can retrieve by  `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.mongo.MongoAuth.html#method_MongoAuth[getHashStrategy]`.
...
database and will use a salt from external, which you will have to set by `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.mongo.HashStrategy.html#method_HashStrategy[setExternalSalt]`

If you want to override this behaviour you can do so by providing an alternative hash strategy and setting it with
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.mongo.MongoAuth.html#method_MongoAuth[setHashStrategy]`
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.mongo.MongoAuth.html#method_MongoAuth[setUsernameCredentialField]`and
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.mongo.MongoAuth.html#method_MongoAuth[setPasswordCredentialField]`
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.User.html#method_User[isAuthorised]`as follows:
