...
We provide an implementation of `link:https://vertx.okou.tk/phpdoc/vertx-auth-common-jphp/classes/io.vertx.jphp.ext.auth.AuthProvider.html[AuthProvider]` which uses the .digest file format
...
Once you've got one of these you can create a `link:https://vertx.okou.tk/phpdoc/vertx-auth-htdigest-jphp/classes/io.vertx.jphp.ext.auth.htdigest.HtdigestAuth.html[HtdigestAuth]` instance as follows:
