...
The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.unit.TestContext.html#method_assertInRange[assertInRange]` targets real numbers.
...
The recommended way to go is to use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.unit.TestContext.html#method_verify[verify]`
...
Creating an `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.unit.Async.html[Async]` object with the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.unit.TestContext.html#method_async[async]` method marks the
executed test case as non terminated. The test case terminates when the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.unit.Async.html#method_complete[complete]`
method is invoked.
...
zero using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.unit.Async.html#method_countDown[countDown]`:
...
The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.unit.TestContext.html#method_asyncAssertSuccess[asyncAssertSuccess]` method returns an {@literal Handler<AsyncResult<T>>}
...
The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.unit.TestContext.html#method_asyncAssertFailure[asyncAssertFailure]` method returns an {@literal Handler<AsyncResult<T>>}
...
When a test suite is created, it won't be executed until the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.unit.TestSuite.html#method_run[run]` method
is called.
...
Such test suite just need to be executed via the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.unit.TestSuite.html#method_run[run]` command, the
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.unit.Completion.html[Completion]`:
...
The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.unit.Completion.html[Completion]` object provides also a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.unit.Completion.html#method_resolve[resolve]` method that
...
The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.unit.Completion.html#method_awaitSuccess[awaitSuccess]` is a variation that throws an exception when
...
The `link:../enums.adoc#TestOptions#method_setUseEventLoop[setUseEventLoop]` configures the usage of the event
loop:
