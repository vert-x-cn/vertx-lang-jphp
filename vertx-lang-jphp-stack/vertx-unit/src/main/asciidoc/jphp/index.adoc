...
Vertx Unit provides the `link:https://vertx.okou.tk/phpdoc/vertx-unit-jphp/classes/io.vertx.jphp.ext.unit.TestContext.html[TestContext]` object for doing assertions in test cases. The _context_
...
The `link:https://vertx.okou.tk/phpdoc/vertx-unit-jphp/classes/io.vertx.jphp.ext.unit.TestContext.html#method_assertInRange[assertInRange]` targets real numbers.
...
The recommended way to go is to use `link:https://vertx.okou.tk/phpdoc/vertx-unit-jphp/classes/io.vertx.jphp.ext.unit.TestContext.html#method_verify[verify]`
...
Creating an `link:https://vertx.okou.tk/phpdoc/vertx-unit-jphp/classes/io.vertx.jphp.ext.unit.Async.html[Async]` object with the `link:https://vertx.okou.tk/phpdoc/vertx-unit-jphp/classes/io.vertx.jphp.ext.unit.TestContext.html#method_async[async]` method marks the
executed test case as non terminated. The test case terminates when the `link:https://vertx.okou.tk/phpdoc/vertx-unit-jphp/classes/io.vertx.jphp.ext.unit.Async.html#method_complete[complete]`
method is invoked.
...
It is possible to wait until the completion of a specific `link:https://vertx.okou.tk/phpdoc/vertx-unit-jphp/classes/io.vertx.jphp.ext.unit.Async.html[Async]`, similar
...
zero using `link:https://vertx.okou.tk/phpdoc/vertx-unit-jphp/classes/io.vertx.jphp.ext.unit.Async.html#method_countDown[countDown]`:
...
`link:https://vertx.okou.tk/phpdoc/vertx-unit-jphp/classes/io.vertx.jphp.ext.unit.TestContext.html[TestContext]`provides useful methods that provides powerful constructs for async testing:

The `link:https://vertx.okou.tk/phpdoc/vertx-unit-jphp/classes/io.vertx.jphp.ext.unit.TestContext.html#method_asyncAssertSuccess[asyncAssertSuccess]` method returns an {@literal Handler<AsyncResult<T>>}
instance that acts like `link:https://vertx.okou.tk/phpdoc/vertx-unit-jphp/classes/io.vertx.jphp.ext.unit.Async.html[Async]`, resolving the `Async` on success and failing the test
...
The `link:https://vertx.okou.tk/phpdoc/vertx-unit-jphp/classes/io.vertx.jphp.ext.unit.TestContext.html#method_asyncAssertSuccess[asyncAssertSuccess]` method returns an {@literal Handler<AsyncResult<T>>}
instance that acts like `link:https://vertx.okou.tk/phpdoc/vertx-unit-jphp/classes/io.vertx.jphp.ext.unit.Async.html[Async]`, invoking the delegating {@literal Handler<T>} on success
...
The `link:https://vertx.okou.tk/phpdoc/vertx-unit-jphp/classes/io.vertx.jphp.ext.unit.TestContext.html#method_asyncAssertFailure[asyncAssertFailure]` method returns an {@literal Handler<AsyncResult<T>>}
instance that acts like `link:https://vertx.okou.tk/phpdoc/vertx-unit-jphp/classes/io.vertx.jphp.ext.unit.Async.html[Async]`, resolving the `Async` on failure and failing the test
on success.
...
The `link:https://vertx.okou.tk/phpdoc/vertx-unit-jphp/classes/io.vertx.jphp.ext.unit.TestContext.html#method_asyncAssertFailure[asyncAssertFailure]` method returns an {@literal Handler<AsyncResult<T>>}
instance that acts like `link:https://vertx.okou.tk/phpdoc/vertx-unit-jphp/classes/io.vertx.jphp.ext.unit.Async.html[Async]`, invoking the delegating {@literal Handler<Throwable>} on
...
The `link:https://vertx.okou.tk/phpdoc/vertx-unit-jphp/classes/io.vertx.jphp.ext.unit.TestContext.html[TestContext]` has `get`/`put`/`remove` operations for sharing state between callbacks.
...
When a test suite is created, it won't be executed until the `link:https://vertx.okou.tk/phpdoc/vertx-unit-jphp/classes/io.vertx.jphp.ext.unit.TestSuite.html#method_run[run]` method
is called.
...
The test suite can also be run with a specified `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.Vertx.html[Vertx]` instance:
...
Such test suite just need to be executed via the `link:https://vertx.okou.tk/phpdoc/vertx-unit-jphp/classes/io.vertx.jphp.ext.unit.TestSuite.html#method_run[run]` command, the
...
`link:https://vertx.okou.tk/phpdoc/vertx-unit-jphp/classes/io.vertx.jphp.ext.unit.Completion.html[Completion]`:
...
The `link:https://vertx.okou.tk/phpdoc/vertx-unit-jphp/classes/io.vertx.jphp.ext.unit.Completion.html[Completion]` object provides also a `link:https://vertx.okou.tk/phpdoc/vertx-unit-jphp/classes/io.vertx.jphp.ext.unit.Completion.html#method_resolve[resolve]` method that
...
The `link:https://vertx.okou.tk/phpdoc/vertx-unit-jphp/classes/io.vertx.jphp.ext.unit.Completion.html#method_awaitSuccess[awaitSuccess]` is a variation that throws an exception when
...
The `link:../vertx-unit-jphp/enums.adoc#TestOptions#method_setUseEventLoop[setUseEventLoop]` configures the usage of the event
loop:
...
The messages sent over the event bus can be collected by the `link:https://vertx.okou.tk/phpdoc/vertx-unit-jphp/classes/io.vertx.jphp.ext.unit.collect.EventBusCollector.html[EventBusCollector]`
...
By default, assertions and failures must be done on the `link:https://vertx.okou.tk/phpdoc/vertx-unit-jphp/classes/io.vertx.jphp.ext.unit.TestContext.html[TestContext]` and throwing an
...
The exception handler is set during the _before_ phase, the `link:https://vertx.okou.tk/phpdoc/vertx-unit-jphp/classes/io.vertx.jphp.ext.unit.TestContext.html[TestContext]` is shared
...
and create a test suite after the class. The methods should declare a `link:https://vertx.okou.tk/phpdoc/vertx-unit-jphp/classes/io.vertx.jphp.ext.unit.TestContext.html[TestContext]`
...
For this purpose the `RunTestOnContext` rule needs a `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.Vertx.html[Vertx]`
instance. Such instance can be provided, otherwise the rule will manage an instance under the hood. Such
instance can be retrieved when the test is running, making this rule a way to manage a `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.Vertx.html[Vertx]`
instance as well.
...
with `link:https://vertx.okou.tk/phpdoc/vertx-unit-jphp/classes/io.vertx.jphp.ext.unit.TestContext.html[TestContext]` parameter are retained and mapped to a Vertx Unit test suite
via the method name:
