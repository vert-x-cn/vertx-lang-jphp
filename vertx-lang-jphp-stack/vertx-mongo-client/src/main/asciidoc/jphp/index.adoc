...
The first call to `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.mongo.MongoClient.html#method_MongoClient[MongoClient::createShared]`
...
In that case you can use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.mongo.MongoClient.html#method_MongoClient[MongoClient::createNonShared]`.
...
This is equivalent to calling `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.mongo.MongoClient.html#method_MongoClient[MongoClient::createShared]`
...
To save a document you use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.mongo.MongoClient.html#method_MongoClient[save]`.
...
To insert a document you use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.mongo.MongoClient.html#method_MongoClient[insert]`.
...
To update a documents you use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.mongo.MongoClient.html#method_MongoClient[updateCollection]`.
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.mongo.MongoClient.html#method_MongoClient[updateCollectionWithOptions]`
...
To replace documents you use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.mongo.MongoClient.html#method_MongoClient[replaceDocuments]`.
...
To execute multiple insert, update, replace, or delete operations at once, use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.mongo.MongoClient.html#method_MongoClient[bulkWrite]`.
...
To specify if the bulk operation should be executed in order, and with what write option, use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.mongo.MongoClient.html#method_MongoClient[bulkWriteWithOptions]`
...
To find documents you use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.mongo.MongoClient.html#method_MongoClient[find]`.
...
To specify things like what fields to return, how many results to return, etc use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.mongo.MongoClient.html#method_MongoClient[findWithOptions]`
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.mongo.MongoClient.html#method_MongoClient[find]`and
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.mongo.MongoClient.html#method_MongoClient[findWithOptions]`methods.
In order to avoid inflating the whole response into memory, use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.mongo.MongoClient.html#method_MongoClient[findBatch]`:
...
The matching documents are emitted one by one by the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.streams.ReadStream<T>.html[ReadStream]` handler.
...
To find a single document you use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.mongo.MongoClient.html#method_MongoClient[findOne]`.

This works just like `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.mongo.MongoClient.html#method_MongoClient[find]` but it returns just the first matching document.

=== Removing documents

To remove documents use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.mongo.MongoClient.html#method_MongoClient[removeDocuments]`.
...
To remove a single document you use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.mongo.MongoClient.html#method_MongoClient[removeDocument]`.

This works just like `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.mongo.MongoClient.html#method_MongoClient[removeDocuments]` but it removes just the first matching document.

=== Counting documents

To count documents use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.mongo.MongoClient.html#method_MongoClient[count]`.
...
To get a list of all collections you can use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.mongo.MongoClient.html#method_MongoClient[getCollections]`
...
To create a new collection you can use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.mongo.MongoClient.html#method_MongoClient[createCollection]`
...
To drop a collection you can use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.mongo.MongoClient.html#method_MongoClient[dropCollection]`
...
You can run arbitrary MongoDB commands with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.mongo.MongoClient.html#method_MongoClient[runCommand]`.
