...
* failures reported by your code in a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.Future<T>.html[Future]`
...
The executed block receives a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.Future<T>.html[Future]` object as parameter, to denote the
...
* returned `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.Future<T>.html[Future]` when calling `execute` methods
* provided `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.Future<T>.html[Future]` when calling the `executeAndReport` methods
...
`link:../enums.adoc#CircuitBreakerOptions#method_CircuitBreakerOptions[isFallbackOnFailure]`is enabled. When a fallback is
...
`link:../enums.adoc#CircuitBreakerOptions#method_CircuitBreakerOptions[setMaxRetries]`.
...
such a callback with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.circuitbreaker.CircuitBreaker.html#method_CircuitBreaker[halfOpenHandler]`.
...
`link:../enums.adoc#CircuitBreakerOptions#method_CircuitBreakerOptions[setNotificationAddress]`. If `null` is
...
`link:../enums.adoc#CircuitBreakerOptions#method_CircuitBreakerOptions[setResetTimeout]`, the circuit breaker decides that the
