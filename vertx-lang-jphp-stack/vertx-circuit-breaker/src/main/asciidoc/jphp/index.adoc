...
* failures reported by your code in a `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.Future.html[Future]`
...
The executed block receives a `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.Future.html[Future]` object as parameter, to denote the
...
* returned `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.Future.html[Future]` when calling `execute` methods
* provided `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.Future.html[Future]` when calling the `executeAndReport` methods
...
`link:../vertx-circuit-breaker-jphp/enums.adoc#CircuitBreakerOptions#method_isFallbackOnFailure[isFallbackOnFailure]`is enabled. When a fallback is
...
The fallback can also be set on the `link:https://vertx.okou.tk/phpdoc/vertx-circuit-breaker-jphp/classes/io.vertx.jphp.circuitbreaker.CircuitBreaker.html[CircuitBreaker]` object directly:
...
`link:../vertx-circuit-breaker-jphp/enums.adoc#CircuitBreakerOptions#method_setMaxRetries[setMaxRetries]`.
...
such a callback with `link:https://vertx.okou.tk/phpdoc/vertx-circuit-breaker-jphp/classes/io.vertx.jphp.circuitbreaker.CircuitBreaker.html#method_halfOpenHandler[halfOpenHandler]`.
...
`link:../vertx-circuit-breaker-jphp/enums.adoc#CircuitBreakerOptions#method_setNotificationAddress[setNotificationAddress]`. If `null` is
...
`link:../vertx-circuit-breaker-jphp/enums.adoc#CircuitBreakerOptions#method_setResetTimeout[setResetTimeout]`, the circuit breaker decides that the
...
`link:https://vertx.okou.tk/phpdoc/vertx-circuit-breaker-jphp/classes/io.vertx.jphp.circuitbreaker.HystrixMetricHandler.html[HystrixMetricHandler]`Vert.x Web Handler:
