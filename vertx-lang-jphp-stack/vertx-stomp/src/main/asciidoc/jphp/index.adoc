...
You can configure the port and host in the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.stomp.StompServer.html#method_StompServer[listen]`
method:
...
The handler receive a reference on the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.stomp.StompServer.html[StompServer]`.

You can also configure the host and port in `link:../enums.adoc#StompServerOptions[StompServerOptions]`:
...
The `link:../enums.adoc#StompServerOptions[StompServerOptions]` let you configure some aspects of the STOMP server.

First, the STOMP server is based on a
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.net.NetServer.html[NetServer]`, so you can configure the underlying `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.net.NetServer.html[NetServer]` from
the `link:../enums.adoc#StompServerOptions[StompServerOptions]`. Alternatively you can also pass the
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.net.NetServer.html[NetServer]`you want to use:
...
The `link:../enums.adoc#StompServerOptions[StompServerOptions]` let you configure:
...
`link:../enums.adoc#StompServerOptions#method_StompServerOptions[setTransactionChunkSize]`)
...
Enabling security requires an additional `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.AuthProvider.html[AuthProvider]` handling the
...
More information about `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.AuthProvider.html[AuthProvider]` is available
...
you can implement your own type of destination by providing a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.stomp.DestinationFactory.html[DestinationFactory]`
returning your own `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.stomp.Destination.html[Destination]` object.

=== Acknowledgment

By default, the STOMP server does nothing when a message is not acknowledged. You can customize this by
providing your own `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.stomp.Destination.html[Destination]` implementation.

The custom destination should call the

`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.stomp.StompServerHandler.html#method_StompServerHandler[onAck]`
and
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.stomp.StompServerHandler.html#method_StompServerHandler[onNack]`
method in order to let the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.stomp.StompServerHandler.html[StompServerHandler]` customizes the behavior:
...
You create a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.stomp.StompClient.html[StompClient]` instance with default options as follows:
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.stomp.StompClientConnection.html[StompClientConnection]`that let you interact with the server. You can
...
You can also configure the host and port in the `link:../enums.adoc#StompClientOptions[StompClientOptions]`:
...
use the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.stomp.StompClientConnection.html#method_StompClientConnection[disconnect]` method:
...
On the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.stomp.StompClientConnection.html[StompClientConnection]`, you can register an error handler receiving `ERROR`
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.stomp.StompClientConnection.html#method_StompClientConnection[connectionDroppedHandler]`. The handler can
...
`link:../enums.adoc#StompClientOptions[StompClientOptions]`when creating the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.stomp.StompClient.html[StompClient]`. As the
STOMP client relies on a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.net.NetClient.html[NetClient]`, you can configure the underlying Net Client from
the `link:../enums.adoc#StompClientOptions[StompClientOptions]`. Alternatively, you can pass the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.net.NetClient.html[NetClient]`
you want to use in the
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.stomp.StompClient.html#method_StompClient[connect]`method:
...
The `link:../enums.adoc#StompClientOptions[StompClientOptions]` let you configure:
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.stomp.StompServer.html#method_StompServer[webSocketHandler]`result to
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServer.html#method_HttpServer[websocketHandler]`:
...
`link:../enums.adoc#Frame[Frame]`handler that would be notified every time a frame is received from the wire. It lets
