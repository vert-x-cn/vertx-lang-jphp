...
You can configure the port and host in the `link:https://vertx.okou.tk/phpdoc/vertx-stomp-jphp/classes/io.vertx.jphp.ext.stomp.StompServer.html#method_listen[listen]`
method:
...
The handler receive a reference on the `link:https://vertx.okou.tk/phpdoc/vertx-stomp-jphp/classes/io.vertx.jphp.ext.stomp.StompServer.html[StompServer]`.

You can also configure the host and port in `link:../vertx-stomp-jphp/enums.adoc#StompServerOptions[StompServerOptions]`:
...
The `link:../vertx-stomp-jphp/enums.adoc#StompServerOptions[StompServerOptions]` let you configure some aspects of the STOMP server.

First, the STOMP server is based on a
`link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.net.NetServer.html[NetServer]`, so you can configure the underlying `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.net.NetServer.html[NetServer]` from
the `link:../vertx-stomp-jphp/enums.adoc#StompServerOptions[StompServerOptions]`. Alternatively you can also pass the
`link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.net.NetServer.html[NetServer]`you want to use:
...
The `link:../vertx-stomp-jphp/enums.adoc#StompServerOptions[StompServerOptions]` let you configure:
...
`link:../vertx-stomp-jphp/enums.adoc#StompServerOptions#method_setTransactionChunkSize[setTransactionChunkSize]`)
...
Enabling security requires an additional `link:https://vertx.okou.tk/phpdoc/vertx-auth-common-jphp/classes/io.vertx.jphp.ext.auth.AuthProvider.html[AuthProvider]` handling the
...
More information about `link:https://vertx.okou.tk/phpdoc/vertx-auth-common-jphp/classes/io.vertx.jphp.ext.auth.AuthProvider.html[AuthProvider]` is available
...
you can implement your own type of destination by providing a `link:https://vertx.okou.tk/phpdoc/vertx-stomp-jphp/classes/io.vertx.jphp.ext.stomp.DestinationFactory.html[DestinationFactory]`
returning your own `link:https://vertx.okou.tk/phpdoc/vertx-stomp-jphp/classes/io.vertx.jphp.ext.stomp.Destination.html[Destination]` object.

=== Acknowledgment

By default, the STOMP server does nothing when a message is not acknowledged. You can customize this by
providing your own `link:https://vertx.okou.tk/phpdoc/vertx-stomp-jphp/classes/io.vertx.jphp.ext.stomp.Destination.html[Destination]` implementation.

The custom destination should call the

`link:https://vertx.okou.tk/phpdoc/vertx-stomp-jphp/classes/io.vertx.jphp.ext.stomp.StompServerHandler.html#method_onAck[onAck]`
and
`link:https://vertx.okou.tk/phpdoc/vertx-stomp-jphp/classes/io.vertx.jphp.ext.stomp.StompServerHandler.html#method_onNack[onNack]`
method in order to let the `link:https://vertx.okou.tk/phpdoc/vertx-stomp-jphp/classes/io.vertx.jphp.ext.stomp.StompServerHandler.html[StompServerHandler]` customizes the behavior:
...
You create a `link:https://vertx.okou.tk/phpdoc/vertx-stomp-jphp/classes/io.vertx.jphp.ext.stomp.StompClient.html[StompClient]` instance with default options as follows:
...
`link:https://vertx.okou.tk/phpdoc/vertx-stomp-jphp/classes/io.vertx.jphp.ext.stomp.StompClientConnection.html[StompClientConnection]`that let you interact with the server. You can
...
You can also configure the host and port in the `link:../vertx-stomp-jphp/enums.adoc#StompClientOptions[StompClientOptions]`:
...
use the `link:https://vertx.okou.tk/phpdoc/vertx-stomp-jphp/classes/io.vertx.jphp.ext.stomp.StompClientConnection.html#method_disconnect[disconnect]` method:
...
On the `link:https://vertx.okou.tk/phpdoc/vertx-stomp-jphp/classes/io.vertx.jphp.ext.stomp.StompClientConnection.html[StompClientConnection]`, you can register an error handler receiving `ERROR`
...
`link:https://vertx.okou.tk/phpdoc/vertx-stomp-jphp/classes/io.vertx.jphp.ext.stomp.StompClientConnection.html#method_connectionDroppedHandler[connectionDroppedHandler]`. The handler can
...
`link:../vertx-stomp-jphp/enums.adoc#StompClientOptions[StompClientOptions]`when creating the `link:https://vertx.okou.tk/phpdoc/vertx-stomp-jphp/classes/io.vertx.jphp.ext.stomp.StompClient.html[StompClient]`. As the
STOMP client relies on a `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.net.NetClient.html[NetClient]`, you can configure the underlying Net Client from
the `link:../vertx-stomp-jphp/enums.adoc#StompClientOptions[StompClientOptions]`. Alternatively, you can pass the `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.net.NetClient.html[NetClient]`
you want to use in the
`link:https://vertx.okou.tk/phpdoc/vertx-stomp-jphp/classes/io.vertx.jphp.ext.stomp.StompClient.html#method_connect[connect]`method:
...
The `link:../vertx-stomp-jphp/enums.adoc#StompClientOptions[StompClientOptions]` let you configure:
...
`link:https://vertx.okou.tk/phpdoc/vertx-stomp-jphp/classes/io.vertx.jphp.ext.stomp.StompServer.html#method_webSocketHandler[webSocketHandler]`result to
`link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.http.HttpServer.html#method_websocketHandler[websocketHandler]`:
...
`link:../vertx-stomp-jphp/enums.adoc#Frame[Frame]`handler that would be notified every time a frame is received from the wire. It lets
