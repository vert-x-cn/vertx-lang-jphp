...
A fairly simple API to retrieve metrics via the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.metrics.Measured.html[Measured]`
interface which is implemented by various Vert.x components like `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServer.html[HttpServer]`,
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.net.NetServer.html[NetServer]`, and even `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.Vertx.html[Vertx]` itself.
...
Then when you create vertx enable metrics using the `link:../enums.adoc#DropwizardMetricsOptions[DropwizardMetricsOptions]`:
...
The `link:../enums.adoc#DropwizardMetricsOptions#method_DropwizardMetricsOptions[vertx.metrics.options.registryName]`
...
The `link:../enums.adoc#DropwizardMetricsOptions#method_DropwizardMetricsOptions[vertx.metrics.options.jmxEnabled]` and
`link:../enums.adoc#DropwizardMetricsOptions#method_DropwizardMetricsOptions[vertx.metrics.options.jmxDomain]`
...
The `link:../enums.adoc#DropwizardMetricsOptions#method_DropwizardMetricsOptions[vertx.metrics.options.configPath]`
...
The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.dropwizard.MetricsService.html[MetricsService]` provides an API in front of the Dropwizard Registry to get
...
Once enabled, the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.dropwizard.MetricsService.html[MetricsService]` allows to retrieve metrics snapshots from any
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.metrics.Measured.html[Measured]`object which provides a map of the metric name to the data,
...
Since `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServer.html[HttpServer]` implements `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.metrics.Measured.html[Measured]`, you can easily grab all metrics
...
The monitored handlers can be configured in the `link:../enums.adoc#DropwizardMetricsOptions[DropwizardMetricsOptions]` via
...
configured by `link:../enums.adoc#HttpClientOptions#method_HttpClientOptions[setMetricsName]`.
...
The monitored endpoints can be configured in the `link:../enums.adoc#DropwizardMetricsOptions[DropwizardMetricsOptions]` via
...
configured by `link:../enums.adoc#NetClientOptions#method_NetClientOptions[setMetricsName]`.
...
_vert.x-internal-blocking_. Named worker executor created with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.WorkerExecutor.html[WorkerExecutor]` are exposed.
