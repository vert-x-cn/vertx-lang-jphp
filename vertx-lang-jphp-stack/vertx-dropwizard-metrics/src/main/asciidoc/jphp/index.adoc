...
The `link:../enums.adoc#DropwizardMetricsOptions#method_setRegistryName[vertx.metrics.options.registryName]`
...
The `link:../enums.adoc#DropwizardMetricsOptions#method_setJmxEnabled[vertx.metrics.options.jmxEnabled]` and
`link:../enums.adoc#DropwizardMetricsOptions#method_setJmxDomain[vertx.metrics.options.jmxDomain]`
...
The `link:../enums.adoc#DropwizardMetricsOptions#method_setConfigPath[vertx.metrics.options.configPath]`
...
configured by `link:../enums.adoc#HttpClientOptions#method_setMetricsName[setMetricsName]`.
...
configured by `link:../enums.adoc#NetClientOptions#method_setMetricsName[setMetricsName]`.
