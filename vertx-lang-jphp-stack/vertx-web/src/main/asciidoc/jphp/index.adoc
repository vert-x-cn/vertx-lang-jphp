...
A `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.Router.html[Router]` is one of the core concepts of Vert.x-Web. It's an object which maintains zero or more
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.Route.html[Routes]`.
...
The object that gets passed into the handler is a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html[RoutingContext]` - this contains
the standard Vert.x `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerRequest.html[HttpServerRequest]` and `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerResponse.html[HttpServerResponse]`
...
to `link:null#method_Handler[handle]`.
...
of `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html[RoutingContext]`.

If you don't end the response in your handler, you should call `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html#method_RoutingContext[next]` so another
matching route can handle the request (if any).

You don't have to call `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html#method_RoutingContext[next]` before the handler has finished executing.
...
You set a blocking handler on a route with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.Route.html#method_Route[blockingHandler]`.
Here's an example:
...
false using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.Route.html#method_Route[blockingHandler]`.
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerRequest.html#method_HttpServerRequest[params]`.
...
If you want a route to only match for a specific HTTP method you can use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.Route.html#method_Route[method]`
...
If you want to route for a specific HTTP method you can also use the methods such as `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.Router.html#method_Router[get]`,
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.Router.html#method_Router[post]`and `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.Router.html#method_Router[put]` named after the HTTP
...
If you want to specify a route will match for more than HTTP method you can call `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.Route.html#method_Route[method]`
multiple times:
...
If the handler subsequently calls `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html#method_RoutingContext[next]` the handler for the next
...
If you want to override the default ordering for routes, you can do so using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.Route.html#method_Route[order]`,
...
You can also specify that a route is handled last, with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.Route.html#method_Route[last]`

== Routing based on MIME type of request

You can specify that a route will match against matching request MIME types using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.Route.html#method_Route[consumes]`.

In this case, the request will contain a `content-type` header specifying the MIME type of the request body.
This will be matched against the value specified in `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.Route.html#method_Route[consumes]`.
...
By using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.Route.html#method_Route[produces]` you define which MIME type(s) the route produces, e.g. the
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html#method_RoutingContext[getAcceptableContentType]`to find out the actual MIME type that
was accepted.
...
You can disable a route with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.Route.html#method_Route[disable]`. A disabled route will be ignored when matching.

You can re-enable a disabled route with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.Route.html#method_Route[enable]`

== Context data

You can use the context data in the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html[RoutingContext]` to maintain any data that you
...
You can use the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html#method_RoutingContext[put]` to put any object, and
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html#method_RoutingContext[get]`to retrieve any object from the context data.
...
The main method `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html#method_RoutingContext[acceptableLocales]` will return the ordered list of locales the
user understands, if you're only interested in the user prefered locale then the helper:
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html#method_RoutingContext[preferredLocale]`will return the 1st element of the list or `null` if no
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html#method_RoutingContext[fail]`specifying an HTTP status code to deliberately signal a failure.
...
The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.BodyHandler.html[BodyHandler]` allows you to retrieve request bodies, limit body sizes and handle
file uploads.
...
If you know the request body is JSON, then you can use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html#method_RoutingContext[getBodyAsJson]`,
if you know it's a string you can use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html#method_RoutingContext[getBodyAsString]`, or to
retrieve it as a buffer use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html#method_RoutingContext[getBody]`.

=== Limiting body size

To limit the size of a request body, create the body handler then use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.BodyHandler.html#method_BodyHandler[setBodyLimit]`
...
you can use disable it with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.BodyHandler.html#method_BodyHandler[setMergeFormAttributes]`.
...
context with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html#method_RoutingContext[fileUploads]`.
...
Each file upload is described by a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.FileUpload.html[FileUpload]` instance, which allows various properties
such as the name, file-name and size to be accessed.

== Handling cookies

Vert.x-Web has cookies support using the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.CookieHandler.html[CookieHandler]`.
...
You use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html#method_RoutingContext[getCookie]` to retrieve
a cookie by name, or use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html#method_RoutingContext[cookies]` to retrieve the entire set.

To remove a cookie, use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html#method_RoutingContext[removeCookie]`.

To add a cookie use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html#method_RoutingContext[addCookie]`.
...
Cookies are described by instances of `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.Cookie.html[Cookie]`. This allows you to retrieve the name,
...
To enable sessions in your application you must have a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.SessionHandler.html[SessionHandler]`
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.sstore.LocalSessionStore.html#method_LocalSessionStore[LocalSessionStore::create]`.

Here are some examples of creating a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.sstore.LocalSessionStore.html[LocalSessionStore]`
...
Here are some examples of creating a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.sstore.ClusteredSessionStore.html[ClusteredSessionStore]`
...
You'll also need to include a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.CookieHandler.html[CookieHandler]` as the session handler uses cookies to
...
In your handlers you can access the session instance with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html#method_RoutingContext[session]`.

You put data into the session with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.Session.html#method_Session[put]`,
you get data from the session with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.Session.html#method_Session[get]`, and you remove
data from the session with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.Session.html#method_Session[remove]`.

The keys for items in the session are always strings. The values can be any type for a local session store, and for
a clustered session store they can be any basic type, or `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.buffer.Buffer.html[Buffer]`, `JsonObject`,
...
You can manually destroy a session using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.Session.html#method_Session[destroy]`. This will remove the session
...
You can also use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.Session.html#method_Session[setAccessed]` to manually mark a session as accessed.
...
To create an auth handler you need an instance of `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.AuthProvider.html[AuthProvider]`. Auth provider is
...
If the auth handler has successfully authenticated and authorised the user it will inject a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.User.html[User]`
object into the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html[RoutingContext]` so it's available in your handlers with:
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html#method_RoutingContext[user]`.
...
If you want to cause the user to be logged out you can call `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html#method_RoutingContext[clearUser]`
...
When the basic auth handler receives this information, it calls the configured `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.AuthProvider.html[AuthProvider]`
...
To use redirect auth you configure an instance of `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.RedirectAuthHandler.html[RedirectAuthHandler]` instead of a
basic auth handler.

You will also need to setup handlers to serve your actual login page, and a handler to handle the actual login itself.
To handle the login we provide a prebuilt handler `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.FormLoginHandler.html[FormLoginHandler]` for the purpose.
...
use the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.ChainAuthHandler.html[ChainAuthHandler]`. The chain auth handler will attempt to perform
...
* The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.JWTAuthHandler.html[JWTAuthHandler]` requires `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.jwt.JWTAuth.html[JWTAuth]`.
* The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.DigestAuthHandler.html[DigestAuthHandler]` requires `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.htdigest.HtdigestAuth.html[HtdigestAuth]`.
* The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.OAuth2AuthHandler.html[OAuth2AuthHandler]` requires `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.oauth2.OAuth2Auth.html[OAuth2Auth]`.
...
* The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.BasicAuthHandler.html[BasicAuthHandler]` can take any provider.
* The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.RedirectAuthHandler.html[RedirectAuthHandler]` can take any provider.
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.StaticHandler.html[StaticHandler]`.
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.StaticHandler.html#method_StaticHandler[setMaxAgeSeconds]`if required.
...
If handling of cache headers is not required, it can be disabled with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.StaticHandler.html#method_StaticHandler[setCachingEnabled]`.
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.StaticHandler.html#method_StaticHandler[setFilesReadOnly]`.

To enable the maximum number of entries that can be cached in memory at any one time you can use
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.StaticHandler.html#method_StaticHandler[setMaxCacheSize]`.

To configure the expiry time of cache entries you can use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.StaticHandler.html#method_StaticHandler[setCacheEntryTimeout]`.
...
This can be configured with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.StaticHandler.html#method_StaticHandler[setIndexPage]`.

=== Changing the web root

By default static resources will be served from the directory `webroot`. To configure this use
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.StaticHandler.html#method_StaticHandler[setWebRoot]`.

=== Serving hidden files

By default the serve will serve hidden files (files starting with `.`).

If you do not want hidden files to be served you can configure it with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.StaticHandler.html#method_StaticHandler[setIncludeHidden]`.

=== Directory listing

The server can also perform directory listing. By default directory listing is disabled. To enabled it use
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.StaticHandler.html#method_StaticHandler[setDirectoryListing]`.
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.StaticHandler.html#method_StaticHandler[setDirectoryTemplate]`.
...
Vert.x-Web includes a handler `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.CorsHandler.html[CorsHandler]` that handles the CORS protocol for you.
...
Template engines are described by `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.templ.TemplateEngine.html[TemplateEngine]`. In order to render a template
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.templ.TemplateEngine.html#method_TemplateEngine[render]`is used.

The simplest way to use templates is not to call the template engine directly but to use the
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.TemplateHandler.html[TemplateHandler]`.
...
The routing context `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html[RoutingContext]` is available
...
Instead, the context `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html#method_RoutingContext[data]` is available in the template.
...
The handler is `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.ErrorHandler.html[ErrorHandler]`. To use the error handler just set it as a
failure handler for any paths that you want covered.

== Request logger

Vert.x-Web includes a handler `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.LoggerHandler.html[LoggerHandler]` that you can use to log HTTP requests.


By default requests are logged to the Vert.x logger which can be configured to use JUL logging, log4j or SLF4J.

See `link:../dataobjects.adoc#LoggerFormat[LoggerFormat]`.

== Serving favicons

Vert.x-Web includes the handler `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.FaviconHandler.html[FaviconHandler]` especially for serving favicons.
...
This is configured using an instance of `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.TimeoutHandler.html[TimeoutHandler]`.
...
The handler gets the approriate content type from `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html#method_RoutingContext[getAcceptableContentType]`.
...
Vert.x provides an out of the box handler called `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.sockjs.SockJSHandler.html[SockJSHandler]` for
using SockJS in your Vert.x-Web applications.

You should create one handler per SockJS application using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.sockjs.SockJSHandler.html#method_SockJSHandler[SockJSHandler::create]`.
You can also specify configuration options when creating the instance. The configuration options are described with
an instance of `link:../enums.adoc#SockJSHandlerOptions[SockJSHandlerOptions]`.
...
The object passed into the handler is a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.sockjs.SockJSSocket.html[SockJSSocket]`. This has a familiar
socket-like interface which you can read and write to similarly to a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.net.NetSocket.html[NetSocket]` or
a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.WebSocket.html[WebSocket]`. It also implements `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.streams.ReadStream<T>.html[ReadStream]` and
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.streams.WriteStream<T>.html[WriteStream]`so you can pump it to and from other read and write streams.
...
The handler can be configured with various options using `link:../enums.adoc#SockJSHandlerOptions[SockJSHandlerOptions]`.
...
terminating at at a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.sockjs.SockJSHandler.html[SockJSHandler]` on the server-side.

A special SockJS socket handler is then installed on the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.sockjs.SockJSHandler.html[SockJSHandler]` which
handles the SockJS data and bridges it to and from the server side event bus.

To activate the bridge you simply call
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.sockjs.SockJSHandler.html#method_SockJSHandler[bridge]`on the
SockJS handler.
...
`link:../enums.adoc#BridgeOptions[BridgeOptions]`that you pass in when calling bridge.

Each match is a `link:../enums.adoc#PermittedOptions[PermittedOptions]` object:

`link:../enums.adoc#PermittedOptions#method_PermittedOptions[setAddress]`:: This represents the exact address the message is being sent to. If you want to allow messages based on
an exact address you use this field.
`link:../enums.adoc#PermittedOptions#method_PermittedOptions[setAddressRegex]`:: This is a regular expression that will be matched against the address. If you want to allow messages
based on a regular expression you use this field. If the `address` field is specified this field will be ignored.
`link:../enums.adoc#PermittedOptions#method_PermittedOptions[setMatch]`:: This allows you to allow messages based on their structure. Any fields in the match must exist in the
...
`link:../enums.adoc#PermittedOptions#method_PermittedOptions[setRequiredAuthority]`field.
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.sockjs.SockJSHandler.html#method_SockJSHandler[bridge]`.

Whenever an event occurs on the bridge it will be passed to the handler. The event is described by an instance of
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.sockjs.BridgeEvent.html[BridgeEvent]`.
...
The event enables you to retrieve the type using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.bridge.BaseBridgeEvent.html#method_BaseBridgeEvent[type]` and
inspect the raw message of the event using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.bridge.BaseBridgeEvent.html#method_BaseBridgeEvent[getRawMessage]`.
...
The event is also an instance of `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.Future<T>.html[Future]`. When you are finished handling the event you can
...
Vert.x-Web includes a handler `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.CSRFHandler.html[CSRFHandler]` that you can use to prevent cross site
...
* Azure Active Directory `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.oauth2.providers.AzureADAuth.html[AzureADAuth]`
* Box.com `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.oauth2.providers.BoxAuth.html[BoxAuth]`
* Dropbox `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.oauth2.providers.DropboxAuth.html[DropboxAuth]`
* Facebook `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.oauth2.providers.FacebookAuth.html[FacebookAuth]`
* Foursquare `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.oauth2.providers.FoursquareAuth.html[FoursquareAuth]`
* Github `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.oauth2.providers.GithubAuth.html[GithubAuth]`
* Google `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.oauth2.providers.GoogleAuth.html[GoogleAuth]`
* Instagram `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.oauth2.providers.InstagramAuth.html[InstagramAuth]`
* Keycloak `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.oauth2.providers.KeycloakAuth.html[KeycloakAuth]`
* LinkedIn `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.oauth2.providers.LinkedInAuth.html[LinkedInAuth]`
* Mailchimp `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.oauth2.providers.MailchimpAuth.html[MailchimpAuth]`
* Salesforce `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.oauth2.providers.SalesforceAuth.html[SalesforceAuth]`
* Shopify `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.oauth2.providers.ShopifyAuth.html[ShopifyAuth]`
* Soundcloud `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.oauth2.providers.SoundcloudAuth.html[SoundcloudAuth]`
* Stripe `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.oauth2.providers.StripeAuth.html[StripeAuth]`
* Twitter `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.oauth2.providers.TwitterAuth.html[TwitterAuth]`
