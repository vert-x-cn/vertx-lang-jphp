...
If you don't end the response in your handler, you should call `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html#method_next[next]` so another
matching route can handle the request (if any).

You don't have to call `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html#method_next[next]` before the handler has finished executing.
...
You set a blocking handler on a route with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.Route.html#method_blockingHandler[blockingHandler]`.
Here's an example:
...
false using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.Route.html#method_blockingHandler[blockingHandler]`.
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpServerRequest.html#method_params[params]`.
...
If you want a route to only match for a specific HTTP method you can use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.Route.html#method_method[method]`
...
If you want to route for a specific HTTP method you can also use the methods such as `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.Router.html#method_get[get]`,
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.Router.html#method_post[post]`and `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.Router.html#method_put[put]` named after the HTTP
...
If you want to specify a route will match for more than HTTP method you can call `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.Route.html#method_method[method]`
multiple times:
...
If the handler subsequently calls `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html#method_next[next]` the handler for the next
...
If you want to override the default ordering for routes, you can do so using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.Route.html#method_order[order]`,
...
You can also specify that a route is handled last, with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.Route.html#method_last[last]`

== Routing based on MIME type of request

You can specify that a route will match against matching request MIME types using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.Route.html#method_consumes[consumes]`.

In this case, the request will contain a `content-type` header specifying the MIME type of the request body.
This will be matched against the value specified in `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.Route.html#method_consumes[consumes]`.
...
By using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.Route.html#method_produces[produces]` you define which MIME type(s) the route produces, e.g. the
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html#method_getAcceptableContentType[getAcceptableContentType]`to find out the actual MIME type that
was accepted.
...
You can disable a route with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.Route.html#method_disable[disable]`. A disabled route will be ignored when matching.

You can re-enable a disabled route with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.Route.html#method_enable[enable]`
...
You can use the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html#method_put[put]` to put any object, and
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html#method_get[get]`to retrieve any object from the context data.
...
The main method `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html#method_acceptableLocales[acceptableLocales]` will return the ordered list of locales the
user understands, if you're only interested in the user prefered locale then the helper:
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html#method_preferredLocale[preferredLocale]`will return the 1st element of the list or `null` if no
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html#method_fail[fail]`specifying an HTTP status code to deliberately signal a failure.
...
If you know the request body is JSON, then you can use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html#method_getBodyAsJson[getBodyAsJson]`,
if you know it's a string you can use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html#method_getBodyAsString[getBodyAsString]`, or to
retrieve it as a buffer use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html#method_getBody[getBody]`.

=== Limiting body size

To limit the size of a request body, create the body handler then use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.BodyHandler.html#method_setBodyLimit[setBodyLimit]`
...
you can use disable it with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.BodyHandler.html#method_setMergeFormAttributes[setMergeFormAttributes]`.
...
context with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html#method_fileUploads[fileUploads]`.
...
You use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html#method_getCookie[getCookie]` to retrieve
a cookie by name, or use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html#method_cookies[cookies]` to retrieve the entire set.

To remove a cookie, use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html#method_removeCookie[removeCookie]`.

To add a cookie use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html#method_addCookie[addCookie]`.
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.sstore.LocalSessionStore.html#method_create[LocalSessionStore::create]`.
...
In your handlers you can access the session instance with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html#method_session[session]`.

You put data into the session with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.Session.html#method_put[put]`,
you get data from the session with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.Session.html#method_get[get]`, and you remove
data from the session with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.Session.html#method_remove[remove]`.
...
You can manually destroy a session using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.Session.html#method_destroy[destroy]`. This will remove the session
...
You can also use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.Session.html#method_setAccessed[setAccessed]` to manually mark a session as accessed.
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html#method_user[user]`.
...
If you want to cause the user to be logged out you can call `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html#method_clearUser[clearUser]`
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.StaticHandler.html#method_setMaxAgeSeconds[setMaxAgeSeconds]`if required.
...
If handling of cache headers is not required, it can be disabled with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.StaticHandler.html#method_setCachingEnabled[setCachingEnabled]`.
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.StaticHandler.html#method_setFilesReadOnly[setFilesReadOnly]`.

To enable the maximum number of entries that can be cached in memory at any one time you can use
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.StaticHandler.html#method_setMaxCacheSize[setMaxCacheSize]`.

To configure the expiry time of cache entries you can use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.StaticHandler.html#method_setCacheEntryTimeout[setCacheEntryTimeout]`.
...
This can be configured with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.StaticHandler.html#method_setIndexPage[setIndexPage]`.

=== Changing the web root

By default static resources will be served from the directory `webroot`. To configure this use
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.StaticHandler.html#method_setWebRoot[setWebRoot]`.

=== Serving hidden files

By default the serve will serve hidden files (files starting with `.`).

If you do not want hidden files to be served you can configure it with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.StaticHandler.html#method_setIncludeHidden[setIncludeHidden]`.

=== Directory listing

The server can also perform directory listing. By default directory listing is disabled. To enabled it use
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.StaticHandler.html#method_setDirectoryListing[setDirectoryListing]`.
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.StaticHandler.html#method_setDirectoryTemplate[setDirectoryTemplate]`.
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.templ.TemplateEngine.html#method_render[render]`is used.
...
Instead, the context `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html#method_data[data]` is available in the template.
...
The handler gets the approriate content type from `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.RoutingContext.html#method_getAcceptableContentType[getAcceptableContentType]`.
...
You should create one handler per SockJS application using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.sockjs.SockJSHandler.html#method_create[SockJSHandler::create]`.
...
a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.WebSocket.html[WebSocket]`. It also implements `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.streams.ReadStream.html[ReadStream]` and
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.streams.WriteStream.html[WriteStream]`so you can pump it to and from other read and write streams.
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.sockjs.SockJSHandler.html#method_bridge[bridge]`on the
SockJS handler.
...
`link:../enums.adoc#PermittedOptions#method_setAddress[setAddress]`:: This represents the exact address the message is being sent to. If you want to allow messages based on
an exact address you use this field.
`link:../enums.adoc#PermittedOptions#method_setAddressRegex[setAddressRegex]`:: This is a regular expression that will be matched against the address. If you want to allow messages
based on a regular expression you use this field. If the `address` field is specified this field will be ignored.
`link:../enums.adoc#PermittedOptions#method_setMatch[setMatch]`:: This allows you to allow messages based on their structure. Any fields in the match must exist in the
...
`link:../enums.adoc#PermittedOptions#method_setRequiredAuthority[setRequiredAuthority]`field.
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.handler.sockjs.SockJSHandler.html#method_bridge[bridge]`.
...
The event enables you to retrieve the type using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.bridge.BaseBridgeEvent.html#method_type[type]` and
inspect the raw message of the event using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.bridge.BaseBridgeEvent.html#method_getRawMessage[getRawMessage]`.
...
The event is also an instance of `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.Future.html[Future]`. When you are finished handling the event you can
