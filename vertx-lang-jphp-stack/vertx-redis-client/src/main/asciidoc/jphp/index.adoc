...
In order to connect to Redis there is a config required. This config is provided in the form of `link:../vertx-redis-jphp/enums.adoc#RedisOptions[RedisOptions]`
...
If you do not do this and manually call the `link:https://vertx.okou.tk/phpdoc/vertx-redis-jphp/classes/io.vertx.jphp.redis.RedisClient.html#method_auth[auth]`
or `link:https://vertx.okou.tk/phpdoc/vertx-redis-jphp/classes/io.vertx.jphp.redis.RedisClient.html#method_select[select]` then the client will not know how to recover
...
`link:https://vertx.okou.tk/phpdoc/vertx-redis-jphp/classes/io.vertx.jphp.redis.sentinel.RedisSentinel.html[RedisSentinel]`.
