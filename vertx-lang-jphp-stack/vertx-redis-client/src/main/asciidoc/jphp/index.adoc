...
If you do not do this and manually call the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.redis.RedisClient.html#method_RedisClient[auth]`
or `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.redis.RedisClient.html#method_RedisClient[select]` then the client will not know how to recover
