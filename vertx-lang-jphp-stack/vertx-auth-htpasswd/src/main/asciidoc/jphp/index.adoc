...
<p>
We provide an implementation of `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.AuthProvider.html[AuthProvider]` which uses the Apache htpasswd file format
...
<p>
Once you've got one of these you can create a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.htpasswd.HtpasswdAuth.html[HtpasswdAuth]` instance as follows:
<p>
[source,php]
----
<?php
