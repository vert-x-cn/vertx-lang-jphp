...
The first call to `link:https://vertx.okou.tk/phpdoc/vertx-mysql-postgresql-jphp/classes/io.vertx.jphp.ext.asyncsql.MySQLClient.html#method_createShared[MySQLClient::createShared]`
or `link:https://vertx.okou.tk/phpdoc/vertx-mysql-postgresql-jphp/classes/io.vertx.jphp.ext.asyncsql.PostgreSQLClient.html#method_createShared[PostgreSQLClient::createShared]`
...
In that case you can use `link:https://vertx.okou.tk/phpdoc/vertx-mysql-postgresql-jphp/classes/io.vertx.jphp.ext.asyncsql.MySQLClient.html#method_createNonShared[MySQLClient::createNonShared]`
or `link:https://vertx.okou.tk/phpdoc/vertx-mysql-postgresql-jphp/classes/io.vertx.jphp.ext.asyncsql.PostgreSQLClient.html#method_createNonShared[PostgreSQLClient::createNonShared]`
...
This is equivalent to calling `link:https://vertx.okou.tk/phpdoc/vertx-mysql-postgresql-jphp/classes/io.vertx.jphp.ext.asyncsql.MySQLClient.html#method_createShared[MySQLClient::createShared]`
or `link:https://vertx.okou.tk/phpdoc/vertx-mysql-postgresql-jphp/classes/io.vertx.jphp.ext.asyncsql.PostgreSQLClient.html#method_createShared[PostgreSQLClient::createShared]`
...
it, you should close it using `link:https://vertx.okou.tk/phpdoc/vertx-sql-jphp/classes/io.vertx.jphp.ext.sql.SQLClient.html#method_close[close]` or
`link:https://vertx.okou.tk/phpdoc/vertx-sql-jphp/classes/io.vertx.jphp.ext.sql.SQLClient.html#method_close[close]`

== Getting a connection

Use `link:https://vertx.okou.tk/phpdoc/vertx-sql-jphp/classes/io.vertx.jphp.ext.sql.SQLClient.html#method_getConnection[getConnection]` to get a connection.
...
The connection is an instance of `link:https://vertx.okou.tk/phpdoc/vertx-sql-jphp/classes/io.vertx.jphp.ext.sql.SQLConnection.html[SQLConnection]` which is a common interface used by
other SQL clients.
...
so any call to `link:https://vertx.okou.tk/phpdoc/vertx-sql-jphp/classes/io.vertx.jphp.ext.sql.SQLClient.html#method_getConnection[getConnection]`
