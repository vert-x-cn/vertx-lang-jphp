...
For these cases, clients provide a boilerplate-less API `link:https://vertx.okou.tk/phpdoc/vertx-sql-jphp/classes/io.vertx.jphp.ext.sql.SQLOperations.html[SQLOperations]`. This interface will
...
* `link:https://vertx.okou.tk/phpdoc/vertx-sql-jphp/classes/io.vertx.jphp.ext.sql.SQLClient.html#method_query[query]`
* `link:https://vertx.okou.tk/phpdoc/vertx-sql-jphp/classes/io.vertx.jphp.ext.sql.SQLClient.html#method_queryWithParams[queryWithParams]`
* `link:https://vertx.okou.tk/phpdoc/vertx-sql-jphp/classes/io.vertx.jphp.ext.sql.SQLOperations.html#method_querySingle[querySingle]`
* `link:https://vertx.okou.tk/phpdoc/vertx-sql-jphp/classes/io.vertx.jphp.ext.sql.SQLOperations.html#method_querySingleWithParams[querySingleWithParams]`
* `link:https://vertx.okou.tk/phpdoc/vertx-sql-jphp/classes/io.vertx.jphp.ext.sql.SQLClient.html#method_update[update]`
* `link:https://vertx.okou.tk/phpdoc/vertx-sql-jphp/classes/io.vertx.jphp.ext.sql.SQLClient.html#method_updateWithParams[updateWithParams]`
* `link:https://vertx.okou.tk/phpdoc/vertx-sql-jphp/classes/io.vertx.jphp.ext.sql.SQLClient.html#method_call[call]`
* `link:https://vertx.okou.tk/phpdoc/vertx-sql-jphp/classes/io.vertx.jphp.ext.sql.SQLClient.html#method_callWithParams[callWithParams]`

For further details on these API please refer to the `link:https://vertx.okou.tk/phpdoc/vertx-sql-jphp/classes/io.vertx.jphp.ext.sql.SQLOperations.html[SQLOperations]` interface.


== The SQL Connection

A connection to the database is represented by `link:https://vertx.okou.tk/phpdoc/vertx-sql-jphp/classes/io.vertx.jphp.ext.sql.SQLConnection.html[SQLConnection]`.
...
`link:https://vertx.okou.tk/phpdoc/vertx-sql-jphp/classes/io.vertx.jphp.ext.sql.SQLConnection.html#method_setAutoCommit[setAutoCommit]`.
...
To execute a query use `link:https://vertx.okou.tk/phpdoc/vertx-sql-jphp/classes/io.vertx.jphp.ext.sql.SQLConnection.html#method_query[query]`

The query string is raw SQL that is passed through without changes to the actual database.

The handler will be called with the results, represented by `link:../vertx-sql-jphp/enums.adoc#ResultSet[ResultSet]` when the query has
been run.
...
The `link:../vertx-sql-jphp/enums.adoc#ResultSet[ResultSet]` instance represents the results of a query.

The list of column names are available with `link:../vertx-sql-jphp/enums.adoc#ResultSet#method_getColumnNames[getColumnNames]`, and the actual results
available with `link:../vertx-sql-jphp/enums.adoc#ResultSet#method_getResults[getResults]`
...
You can also retrieve the rows as a list of Json object instances with `link:../vertx-sql-jphp/enums.adoc#ResultSet#method_getRows[getRows]` -
this can give you a somewhat simpler API to work with, but please be aware that SQL results can contain duplicate
column names - if that's the case you should use `link:../vertx-sql-jphp/enums.adoc#ResultSet#method_getResults[getResults]` instead.
...
`link:https://vertx.okou.tk/phpdoc/vertx-sql-jphp/classes/io.vertx.jphp.ext.sql.SQLConnection.html#method_queryWithParams[queryWithParams]`.
...
To execute an operation which updates the database use `link:https://vertx.okou.tk/phpdoc/vertx-sql-jphp/classes/io.vertx.jphp.ext.sql.SQLConnection.html#method_update[update]`.

The update string is raw SQL that is passed through without changes to the actual database.

The handler will be called with the results, represented by `link:../vertx-sql-jphp/enums.adoc#UpdateResult[UpdateResult]` when the update has
been run.

The update result holds the number of rows updated with `link:../vertx-sql-jphp/enums.adoc#UpdateResult#method_getUpdated[getUpdated]`, and
if the update generated keys, they are available with `link:../vertx-sql-jphp/enums.adoc#UpdateResult#method_getKeys[getKeys]`.
...
`link:https://vertx.okou.tk/phpdoc/vertx-sql-jphp/classes/io.vertx.jphp.ext.sql.SQLConnection.html#method_updateWithParams[updateWithParams]`.
...
`link:https://vertx.okou.tk/phpdoc/vertx-sql-jphp/classes/io.vertx.jphp.ext.sql.SQLConnection.html#method_callWithParams[callWithParams]`.
...
* Batched statements `link:https://vertx.okou.tk/phpdoc/vertx-sql-jphp/classes/io.vertx.jphp.ext.sql.SQLConnection.html#method_batch[batch]`
* Batched prepared statements `link:https://vertx.okou.tk/phpdoc/vertx-sql-jphp/classes/io.vertx.jphp.ext.sql.SQLConnection.html#method_batchWithParams[batchWithParams]`
* Batched callable statements `link:https://vertx.okou.tk/phpdoc/vertx-sql-jphp/classes/io.vertx.jphp.ext.sql.SQLConnection.html#method_batchCallableWithParams[batchCallableWithParams]`
...
`link:https://vertx.okou.tk/phpdoc/vertx-sql-jphp/classes/io.vertx.jphp.ext.sql.SQLConnection.html#method_execute[execute]`.
...
To use transactions first set auto-commit to false with `link:https://vertx.okou.tk/phpdoc/vertx-sql-jphp/classes/io.vertx.jphp.ext.sql.SQLConnection.html#method_setAutoCommit[setAutoCommit]`.

You then do your transactional operations and when you want to commit or rollback use
`link:https://vertx.okou.tk/phpdoc/vertx-sql-jphp/classes/io.vertx.jphp.ext.sql.SQLConnection.html#method_commit[commit]`or
`link:https://vertx.okou.tk/phpdoc/vertx-sql-jphp/classes/io.vertx.jphp.ext.sql.SQLConnection.html#method_rollback[rollback]`.
...
When you've done with the connection you should return it to the pool with `link:https://vertx.okou.tk/phpdoc/vertx-sql-jphp/classes/io.vertx.jphp.ext.sql.SQLConnection.html#method_close[close]`.