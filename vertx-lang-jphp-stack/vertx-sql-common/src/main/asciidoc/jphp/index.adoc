...
* `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.sql.SQLClient.html#method_SQLClient[query]`
* `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.sql.SQLClient.html#method_SQLClient[queryWithParams]`
* `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.sql.SQLOperations.html#method_SQLOperations[querySingle]`
* `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.sql.SQLOperations.html#method_SQLOperations[querySingleWithParams]`
* `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.sql.SQLClient.html#method_SQLClient[update]`
* `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.sql.SQLClient.html#method_SQLClient[updateWithParams]`
* `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.sql.SQLClient.html#method_SQLClient[call]`
* `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.sql.SQLClient.html#method_SQLClient[callWithParams]`
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.sql.SQLConnection.html#method_SQLConnection[setAutoCommit]`.
...
To execute a query use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.sql.SQLConnection.html#method_SQLConnection[query]`
...
The list of column names are available with `link:../enums.adoc#ResultSet#method_ResultSet[getColumnNames]`, and the actual results
available with `link:../enums.adoc#ResultSet#method_ResultSet[getResults]`
...
You can also retrieve the rows as a list of Json object instances with `link:../enums.adoc#ResultSet#method_ResultSet[getRows]` -
this can give you a somewhat simpler API to work with, but please be aware that SQL results can contain duplicate
column names - if that's the case you should use `link:../enums.adoc#ResultSet#method_ResultSet[getResults]` instead.
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.sql.SQLConnection.html#method_SQLConnection[queryWithParams]`.
...
To execute an operation which updates the database use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.sql.SQLConnection.html#method_SQLConnection[update]`.
...
The update result holds the number of rows updated with `link:../enums.adoc#UpdateResult#method_UpdateResult[getUpdated]`, and
if the update generated keys, they are available with `link:../enums.adoc#UpdateResult#method_UpdateResult[getKeys]`.
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.sql.SQLConnection.html#method_SQLConnection[updateWithParams]`.
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.sql.SQLConnection.html#method_SQLConnection[callWithParams]`.
...
* Batched statements `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.sql.SQLConnection.html#method_SQLConnection[batch]`
* Batched prepared statements `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.sql.SQLConnection.html#method_SQLConnection[batchWithParams]`
* Batched callable statements `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.sql.SQLConnection.html#method_SQLConnection[batchCallableWithParams]`
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.sql.SQLConnection.html#method_SQLConnection[execute]`.
...
To use transactions first set auto-commit to false with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.sql.SQLConnection.html#method_SQLConnection[setAutoCommit]`.

You then do your transactional operations and when you want to commit or rollback use
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.sql.SQLConnection.html#method_SQLConnection[commit]`or
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.sql.SQLConnection.html#method_SQLConnection[rollback]`.
...
When you've done with the connection you should return it to the pool with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.sql.SQLConnection.html#method_SQLConnection[close]`.