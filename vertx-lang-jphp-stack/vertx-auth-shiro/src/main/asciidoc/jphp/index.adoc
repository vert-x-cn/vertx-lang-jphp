...
The default role prefix is `role:`. You can change this with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.shiro.ShiroAuth.html#method_setRolePrefix[setRolePrefix]`.
...
with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.shiro.ShiroAuth.html#method_setRolePrefix[setRolePrefix]`.
