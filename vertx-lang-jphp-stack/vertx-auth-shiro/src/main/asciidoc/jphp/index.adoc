...
To create an instance of the provider you use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.shiro.ShiroAuth.html[ShiroAuth]`. You specify the type of
Shiro auth provider that you want with `link:../dataobjects.adoc#ShiroAuthRealmType[ShiroAuthRealmType]`, and you specify the
...
The default role prefix is `role:`. You can change this with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.shiro.ShiroAuth.html#method_ShiroAuth[setRolePrefix]`.
...
with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.shiro.ShiroAuth.html#method_ShiroAuth[setRolePrefix]`.
