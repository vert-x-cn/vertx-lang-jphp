...
You can call `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.kafka.admin.AdminUtils.html#method_createTopic[createTopic]` to create a topic.
...
You can call `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.kafka.admin.AdminUtils.html#method_deleteTopic[deleteTopic]` to delete a topic.
...
you can call `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.kafka.admin.AdminUtils.html#method_changeTopicConfig[changeTopicConfig]` to update a topic.
...
If you want to check if a topic exists, you can call `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.kafka.admin.AdminUtils.html#method_topicExists[topicExists]`.
Parameters are: topic name, and the usual callback to handle the result.
It might return an error, e.g. if the topic does not exist.
