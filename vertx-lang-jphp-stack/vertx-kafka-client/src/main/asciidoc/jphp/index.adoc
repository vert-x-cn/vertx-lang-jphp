...
static creation methods exposed by `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.kafka.client.consumer.KafkaConsumer<K,V>.html[KafkaConsumer]` and
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.kafka.client.producer.KafkaProducer<K,V>.html[KafkaProducer]`
...
In the above example, a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.kafka.client.consumer.KafkaConsumer<K,V>.html[KafkaConsumer]` instance is created using
...
Here the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.kafka.client.producer.KafkaProducer<K,V>.html[KafkaProducer]` instance is created in using a `Properties` for
specifying Kafka nodes list to connect (just one) and the acknowledgment mode; the key and value deserializers are
specified as parameters of `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.kafka.client.producer.KafkaProducer<K,V>.html#method_KafkaProducer[KafkaProducer::create]`.
endif::[]
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.kafka.client.consumer.KafkaConsumer<K,V>.html#method_KafkaConsumer[subscribe]`method for
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.kafka.client.consumer.KafkaConsumer<K,V>.html#method_KafkaConsumer[handler]`.
...
You can register handlers on a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.kafka.client.consumer.KafkaConsumer<K,V>.html[KafkaConsumer]` to be notified
of the partitions revocations and assignments by the Kafka cluster using
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.kafka.client.consumer.KafkaConsumer<K,V>.html#method_KafkaConsumer[partitionsRevokedHandler]`and
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.kafka.client.consumer.KafkaConsumer<K,V>.html#method_KafkaConsumer[partitionsAssignedHandler]`.
...
not get messages anymore using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.kafka.client.consumer.KafkaConsumer<K,V>.html#method_KafkaConsumer[unsubscribe]`
...
You can use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.kafka.client.consumer.KafkaConsumer<K,V>.html#method_KafkaConsumer[assign]`
...
Calling `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.kafka.client.consumer.KafkaConsumer<K,V>.html#method_KafkaConsumer[assignment]` provides
...
You can call the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.kafka.client.consumer.KafkaConsumer<K,V>.html#method_KafkaConsumer[partitionsFor]` to get information about
...
In addition `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.kafka.client.consumer.KafkaConsumer<K,V>.html#method_KafkaConsumer[listTopics]` provides all available topics
...
Manual offset commit, can be achieved with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.kafka.client.consumer.KafkaConsumer<K,V>.html#method_KafkaConsumer[commit]`.
...
You can use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.kafka.client.consumer.KafkaConsumer<K,V>.html#method_KafkaConsumer[seek]` to change the offset for reading at a specific
position
...
When the consumer needs to re-read the stream from the beginning, it can use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.kafka.client.consumer.KafkaConsumer<K,V>.html#method_KafkaConsumer[seekToBeginning]`
...
Finally `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.kafka.client.consumer.KafkaConsumer<K,V>.html#method_KafkaConsumer[seekToEnd]` can be used to come back at the end of the partition
...
for a given partition. In contrast to `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.kafka.client.consumer.KafkaConsumer<K,V>.html#method_KafkaConsumer[seekToBeginning]`,
...
for a given partition. In contrast to `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.kafka.client.consumer.KafkaConsumer<K,V>.html#method_KafkaConsumer[seekToEnd]`,
it does not change the consumer's offset.
...
To achieve that you can use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.kafka.client.consumer.KafkaConsumer<K,V>.html#method_KafkaConsumer[pause]` and
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.kafka.client.consumer.KafkaConsumer<K,V>.html#method_KafkaConsumer[resume]`.
...
You can use  `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.kafka.client.producer.KafkaProducer<K,V>.html#method_KafkaProducer[write]` to send messages (records) to a topic.
...
Calling `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.kafka.client.producer.KafkaProducer<K,V>.html#method_KafkaProducer[KafkaProducer::createShared]`
...
You can call the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.kafka.client.producer.KafkaProducer<K,V>.html#method_KafkaProducer[partitionsFor]` to get information about
partitions for a specified topic:
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.kafka.client.consumer.KafkaConsumer<K,V>.html#method_KafkaConsumer[exceptionHandler]`or
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.kafka.client.producer.KafkaProducer<K,V>.html#method_KafkaProducer[exceptionHandler]`
