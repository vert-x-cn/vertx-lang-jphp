...
`link:https://vertx.okou.tk/phpdoc/vertx-redis-jphp/classes/io.vertx.jphp.redis.RedisClient.html[RedisClient]`. check the documentation of the Vert.x Redis Client
for further details.
