...
configuration is passed as a Json Object using `link:../enums.adoc#ConfigStoreOptions#method_setConfig[setConfig]`
...
It's a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.streams.ReadStream.html[ReadStream]` of `JsonObject`. By registering the right
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.streams.ReadStream.html#method_endHandler[endHandler]`is called).
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.Future.html[Future]`:
