...
Once done, you first need to instantiate the `link:https://vertx.okou.tk/phpdoc/vertx-config-jphp/classes/io.vertx.jphp.config.ConfigRetriever.html[ConfigRetriever]`:
...
configuration is passed as a Json Object using `link:../vertx-config-jphp/enums.adoc#ConfigStoreOptions#method_setConfig[setConfig]`
...
<?php
    ...
    $retriever = ConfigRetriever::create(Vertx::vertx(), $options);
...
----
<?php
    $last = $retriever->getCachedConfig();

----

== Reading configuration as a stream

The `link:https://vertx.okou.tk/phpdoc/vertx-config-jphp/classes/io.vertx.jphp.config.ConfigRetriever.html[ConfigRetriever]` provide a way to access the stream of configuration.
It's a `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.streams.ReadStream.html[ReadStream]` of `JsonObject`. By registering the right
...
`link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.streams.ReadStream.html#method_endHandler[endHandler]`is called).
...
The `link:https://vertx.okou.tk/phpdoc/vertx-config-jphp/classes/io.vertx.jphp.config.ConfigRetriever.html[ConfigRetriever]` provide a way to retrieve the configuration as a
`link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.Future.html[Future]`:

[source, php]
----
<?php
    use io\vertx\jphp\config\ConfigRetriever;
    $future = ConfigRetriever::getConfigAsFuture($retriever);
