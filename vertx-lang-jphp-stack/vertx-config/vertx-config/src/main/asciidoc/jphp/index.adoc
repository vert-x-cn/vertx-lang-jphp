...
Once done, you first need to instantiate the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.config.ConfigRetriever.html[ConfigRetriever]`:
...
configuration is passed as a Json Object using `link:../enums.adoc#ConfigStoreOptions#method_ConfigStoreOptions[setConfig]`
...
The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.config.ConfigRetriever.html[ConfigRetriever]` provide a way to access the stream of configuration.
It's a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.streams.ReadStream<T>.html[ReadStream]` of `JsonObject`. By registering the right
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.streams.ReadStream<T>.html#method_ReadStream[endHandler]`is called).
...
The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.config.ConfigRetriever.html[ConfigRetriever]` provide a way to retrieve the configuration as a
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.Future<T>.html[Future]`:
