...
To create an instance of the provider you use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.jwt.JWTAuth.html[JWTAuth]`. You specify the configuration
in a JSON object.
