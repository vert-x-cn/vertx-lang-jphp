...
The client API is represented by `link:https://vertx.okou.tk/phpdoc/vertx-consul-jphp/classes/io.vertx.jphp.ext.consul.ConsulClient.html[ConsulClient]`. The API is very similar to Consul's
