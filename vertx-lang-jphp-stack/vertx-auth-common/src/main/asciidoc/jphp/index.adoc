...
To authenticate a user you use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.AuthProvider.html#method_AuthProvider[authenticate]`.
...
to check if a user has a specific authority you use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.User.html#method_User[isAuthorised]`.
...
In order to clear the internal cache you can use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.User.html#method_User[clearCache]`.

=== The User Principal

You can get the Principal corresponding to the authenticated user with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.User.html#method_User[principal]`.
