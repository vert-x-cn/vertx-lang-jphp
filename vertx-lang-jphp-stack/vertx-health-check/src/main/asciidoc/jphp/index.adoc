...
The central object is `link:https://vertx.okou.tk/phpdoc/vertx-health-checks-jphp/classes/io.vertx.jphp.ext.healthchecks.HealthChecks.html[HealthChecks]`. You can create a new instance using:
...
* using an existing instance of `link:https://vertx.okou.tk/phpdoc/vertx-health-checks-jphp/classes/io.vertx.jphp.ext.healthchecks.HealthChecks.html[HealthChecks]`
...
Procedure registration can be directly made on the `link:https://vertx.okou.tk/phpdoc/vertx-health-checks-jphp/classes/io.vertx.jphp.ext.healthchecks.HealthCheckHandler.html[HealthCheckHandler]`
instance. Alternatively, if you have created the `link:https://vertx.okou.tk/phpdoc/vertx-health-checks-jphp/classes/io.vertx.jphp.ext.healthchecks.HealthChecks.html[HealthChecks]` instance
...
`link:../vertx-health-checks-jphp/enums.adoc#Status[Status]`indicating whether or not the test has passed or failed. This function
must not block and report to the given `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.Future.html[Future]` whether or not it succeed.
...
* if the future is completed successfully but without a `link:../vertx-health-checks-jphp/enums.adoc#Status[Status]`, the check
is considered as _OK_.
* if the future is completed successfully with a `link:../vertx-health-checks-jphp/enums.adoc#Status[Status]` marked as _OK_,
the check is considered as _OK_.
* if the future is completed successfully with a `link:../vertx-health-checks-jphp/enums.adoc#Status[Status]` marked as _KO_,
the check is considered as _KO_.

`link:../vertx-health-checks-jphp/enums.adoc#Status[Status]`can also provide additional data:
...
`link:https://vertx.okou.tk/phpdoc/vertx-health-checks-jphp/classes/io.vertx.jphp.ext.healthchecks.HealthCheckHandler.html[HealthCheckHandler]`.
...
When using the Vert.x web handler, you can pass a `link:https://vertx.okou.tk/phpdoc/vertx-auth-common-jphp/classes/io.vertx.jphp.ext.auth.AuthProvider.html[AuthProvider]` use to authenticate the
