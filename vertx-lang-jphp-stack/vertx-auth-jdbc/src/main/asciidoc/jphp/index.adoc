...
We provide an implementation of `link:https://vertx.okou.tk/phpdoc/vertx-auth-common-jphp/classes/io.vertx.jphp.ext.auth.AuthProvider.html[AuthProvider]` which uses the Vert.x `link:https://vertx.okou.tk/phpdoc/vertx-jdbc-jphp/classes/io.vertx.jphp.ext.jdbc.JDBCClient.html[JDBCClient]`
...
To create an instance you first need an instance of `link:https://vertx.okou.tk/phpdoc/vertx-jdbc-jphp/classes/io.vertx.jphp.ext.jdbc.JDBCClient.html[JDBCClient]`. To learn how to create one
of those please consult the documentation for the JDBC client.

Once you've got one of those you can create a `link:https://vertx.okou.tk/phpdoc/vertx-auth-jdbc-jphp/classes/io.vertx.jphp.ext.auth.jdbc.JDBCAuth.html[JDBCAuth]` instance as follows:
...
with the operations `link:https://vertx.okou.tk/phpdoc/vertx-auth-jdbc-jphp/classes/io.vertx.jphp.ext.auth.jdbc.JDBCAuth.html#method_setAuthenticationQuery[setAuthenticationQuery]`,
`link:https://vertx.okou.tk/phpdoc/vertx-auth-jdbc-jphp/classes/io.vertx.jphp.ext.auth.jdbc.JDBCAuth.html#method_setPermissionsQuery[setPermissionsQuery]`and
`link:https://vertx.okou.tk/phpdoc/vertx-auth-jdbc-jphp/classes/io.vertx.jphp.ext.auth.jdbc.JDBCAuth.html#method_setRolesQuery[setRolesQuery]`, if you want to use them with a different
database schema.
...
`link:https://vertx.okou.tk/phpdoc/vertx-auth-jdbc-jphp/classes/io.vertx.jphp.ext.auth.jdbc.JDBCAuth.html#method_setHashStrategy[setHashStrategy]`.
...
The default role prefix is `role:`. You can change this with `link:https://vertx.okou.tk/phpdoc/vertx-auth-jdbc-jphp/classes/io.vertx.jphp.ext.auth.jdbc.JDBCAuth.html#method_setRolePrefix[setRolePrefix]`.
