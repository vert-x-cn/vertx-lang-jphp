...
with the operations `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.jdbc.JDBCAuth.html#method_JDBCAuth[setAuthenticationQuery]`,
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.jdbc.JDBCAuth.html#method_JDBCAuth[setPermissionsQuery]`and
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.jdbc.JDBCAuth.html#method_JDBCAuth[setRolesQuery]`, if you want to use them with a different
database schema.
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.jdbc.JDBCAuth.html#method_JDBCAuth[setHashStrategy]`.
...
The default role prefix is `role:`. You can change this with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.jdbc.JDBCAuth.html#method_JDBCAuth[setRolePrefix]`.
