...
`link:../../vertx-service-discovery/vertx-service-discovery-jphp/enums.adoc#Record[Record]`are created from Kubernetes Service. The service type is deduced from the `service.type` label. If
