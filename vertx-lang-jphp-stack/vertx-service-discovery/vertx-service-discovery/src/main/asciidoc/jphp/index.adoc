...
* lookup services
* bind to a selected service (it gets a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.servicediscovery.ServiceReference.html[ServiceReference]`) and use it
* release the service once the consumer is done with it
* listen for arrival, departure and modification of services.

Consumer would 1) lookup a service record matching their need, 2) retrieve the
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.servicediscovery.ServiceReference.html[ServiceReference]`that give access to the service, 3) get a service object to access
...
`link:../enums.adoc#Record[records]`.

Providers and consumers must create their own `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.servicediscovery.ServiceDiscovery.html[ServiceDiscovery]` instance. These
...
A service `link:../enums.adoc#Record[Record]` is an object that describes a service published by a service
...
`link:../enums.adoc#Record[Record]`. From these records, a consumer can retrieve a
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.servicediscovery.ServiceReference.html[ServiceReference]`, representing the binding between the consumer and the provider.
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.servicediscovery.ServiceDiscovery.html#method_getReference[getReference]`or released with
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.servicediscovery.ServiceReference.html#method_release[release]`, events are emitted on the event bus to track the
service usages.
...
be populated with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.servicediscovery.spi.ServiceImporter.html[ServiceImporter]`s. Since 3.5.0, you can use a local
...
Publishers and consumers must create their own `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.servicediscovery.ServiceDiscovery.html[ServiceDiscovery]`
...
To create records, you can either use the `link:../enums.adoc#Record[Record]` class, or use convenient methods
...
1. A function taking a `link:../enums.adoc#Record[Record]` as parameter and returning a boolean (it's a
predicate)
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.servicediscovery.ServiceDiscovery.html#method_getRecords[getRecords]`.
...
Once you have chosen the `link:../enums.adoc#Record[Record]`, you can retrieve a
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.servicediscovery.ServiceReference.html[ServiceReference]`and then the service object:
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.servicediscovery.ServiceReference.html#method_getAs[getAs]`. The parameter is the type of
object you expect to get. If you are using Java, you can use
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.servicediscovery.ServiceReference.html#method_get[get]`. However in the other language you must pass the expected
type.
...
* `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.servicediscovery.types.HttpEndpoint.html[HttpEndpoint]` - for REST API's, the service object is a
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpClient.html[HttpClient]`configured on the host and port (the location is the url).
* `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.servicediscovery.types.EventBusService.html[EventBusService]` - for service proxies, the service object is a proxy. Its
type is the proxies interface (the location is the address).
* `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.servicediscovery.types.MessageSource.html[MessageSource]` - for message sources (publisher), the service object is a
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.eventbus.MessageConsumer.html[MessageConsumer]`(the location is the address).
* `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.servicediscovery.types.JDBCDataSource.html[JDBCDataSource]` - for JDBC data sources, the service object is a
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.jdbc.JDBCClient.html[JDBCClient]`(the configuration of the client is computed from the location, metadata and
consumer configuration).
* `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.servicediscovery.types.RedisDataSource.html[RedisDataSource]` - for Redis data sources, the service object is a
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.redis.RedisClient.html[RedisClient]`(the configuration of the client is computed from the location, metadata and
consumer configuration).
* `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.servicediscovery.types.MongoDataSource.html[MongoDataSource]` - for Mongo data sources, the service object is a
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.mongo.MongoClient.html[MongoClient]`(the configuration of the client is computed from the location, metadata and
consumer configuration).
...
`metadata` of the `link:../enums.adoc#Record[Record]`.
...
objects are `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpClient.html[HttpClient]` configured with the host, port and ssl.

==== Publishing a HTTP endpoint

To publish a HTTP endpoint, you need a `link:../enums.adoc#Record[Record]`. You can create the record using
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.servicediscovery.types.HttpEndpoint.html#method_createRecord[HttpEndpoint::createRecord]`.

The next snippet illustrates hot to create a `link:../enums.adoc#Record[Record]` from
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.servicediscovery.types.HttpEndpoint.html[HttpEndpoint]`:
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.http.HttpClient.html[HttpClient]`with a port and host configured:
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.servicediscovery.types.HttpEndpoint.html#method_getClient[HttpEndpoint::getClient]`
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.servicediscovery.ServiceDiscovery.html#method_releaseServiceObject[ServiceDiscovery::releaseServiceObject]`,
so you don't need to keep the service reference.

Since Vert.x 3.4.0, another client has been provided. This higher-level client, named `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.client.WebClient.html[WebClient]`
tends to be easier to use. You can retrieve a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.client.WebClient.html[WebClient]` instances using:
...
methods from `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.servicediscovery.types.EventBusService.html[EventBusService]`.
...
To publish an event bus service, you need to create a `link:../enums.adoc#Record[Record]`:
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.servicediscovery.types.EventBusService.html[EventBusService]`interface that combines the two operations in one call.
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.eventbus.MessageConsumer.html[MessageConsumer]`.
...
1. create a record, using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.servicediscovery.types.MessageSource.html[MessageSource]`
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.servicediscovery.types.MessageSource.html[MessageSource]`class to retrieve the service is one call.
...
When, using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.servicediscovery.types.MessageSource.html[MessageSource]`, it becomes:
...
using a JDBC driver. The client of a JDBC data source service is a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.jdbc.JDBCClient.html[JDBCClient]`.

==== Publishing a JDBC service

As for the other service types, publishing a JDBC data source is a 2-step process:

1. create a record, using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.servicediscovery.types.JDBCDataSource.html[JDBCDataSource]`
2. publish the record
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.jdbc.JDBCClient.html[JDBCClient]`, you can merge configuration: the record location, the metadata and a json object provided by
the consumer:
...
You can also use the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.jdbc.JDBCClient.html[JDBCClient]` class to the lookup and retrieval in one call:
...
The client of a Redis data source service is a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.redis.RedisClient.html[RedisClient]`.

==== Publishing a Redis service

Publishing a Redis data source is a 2-step process:

1. create a record, using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.servicediscovery.types.RedisDataSource.html[RedisDataSource]`
2. publish the record
...
As stated in the previous section, how to access a data source depends on the data source itself. To build the
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.redis.RedisClient.html[RedisClient]`, you can merge configuration: the record location, the metadata and a json object provided by
the consumer:
...
You can also use the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.servicediscovery.types.RedisDataSource.html[RedisDataSource]` class to the lookup and retrieval in one call:
...
The client of a Mongo data source service is a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.mongo.MongoClient.html[MongoClient]`.

==== Publishing a Mongo service

Publishing a Mongo data source is a 2-step process:

1. create a record, using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.servicediscovery.types.MongoDataSource.html[MongoDataSource]`
2. publish the record
...
As stated in the previous section, how to access a data source depends on the data source itself. To build the
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.mongo.MongoClient.html[MongoClient]`, you can merge configuration: the record location, the metadata and a json object
...
You can also use the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.servicediscovery.types.MongoDataSource.html[MongoDataSource]` class to the lookup and retrieval in one call:
...
This address is configurable from the `link:../enums.adoc#ServiceDiscoveryOptions[ServiceDiscoveryOptions]`.
...
.discovery.usage_ address. This address is configurable from the `link:../enums.adoc#ServiceDiscoveryOptions[ServiceDiscoveryOptions]`.
...
This `id` is configurable from the `link:../enums.adoc#ServiceDiscoveryOptions[ServiceDiscoveryOptions]`. By default it's "localhost" on
...
`link:../enums.adoc#ServiceDiscoveryOptions#method_setUsageAddress[setUsageAddress]`.
...
You can provide your own bridge by implementing the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.servicediscovery.spi.ServiceImporter.html[ServiceImporter]` interface and
register it using
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.servicediscovery.ServiceDiscovery.html#method_registerServiceImporter[registerServiceImporter]`.

The second parameter can provide an optional configuration for the bridge.

When the bridge is registered the

`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.servicediscovery.spi.ServiceImporter.html[#start)]`
method is called. It lets you configure the bridge. When the bridge is configured, ready and has imported /
exported the initial services, it must complete the given `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.Future.html[Future]`. If the bridge starts
method is blocking, it must use an
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.Vertx.html#method_executeBlocking[executeBlocking]`construct, and
complete the given future object.

When the service discovery is stopped, the bridge is stopped. The
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.servicediscovery.spi.ServiceImporter.html#method_close[close]`
method is called that provides the opportunity to cleanup resources, removed imported / exported services... This
method must complete the given `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.Future.html[Future]` to notify the caller of the completion.
