...
Telnet terms are configured by `link:../enums.adoc#ShellServiceOptions#method_setTelnetOptions[setTelnetOptions]`,
...
SSH terms are configured by `link:../enums.adoc#ShellServiceOptions#method_setSSHOptions[setSSHOptions]`:

- `link:../enums.adoc#SSHTermOptions#method_setPort[setPort]`: port
- `link:../enums.adoc#SSHTermOptions#method_setHost[setHost]`: host
...
- `link:../enums.adoc#SSHTermOptions#method_setAuthOptions[setAuthOptions]`: configures user authentication

The server key configuration reuses the key pair store configuration scheme provided by _Vert.x Core_:

- `link:../enums.adoc#SSHTermOptions#method_setKeyPairOptions[setKeyPairOptions]`: set `.jks` key pair store
- `link:../enums.adoc#SSHTermOptions#method_setPfxKeyPairOptions[setPfxKeyPairOptions]`: set `.pfx` key pair store
- `link:../enums.adoc#SSHTermOptions#method_setPemKeyPairOptions[setPemKeyPairOptions]`: set `.pem` key pair store
...
HTTP terms are configured by `link:../enums.adoc#ShellServiceOptions#method_setHttpOptions[setHttpOptions]`, the http options
...
- `link:../enums.adoc#HttpTermOptions#method_setAuthOptions[setAuthOptions]`: configures user authentication
- `link:../enums.adoc#HttpTermOptions#method_setSockJSHandlerOptions[setSockJSHandlerOptions]`: configures SockJS
- `link:../enums.adoc#HttpTermOptions#method_setSockJSPath[setSockJSPath]`: the SockJS path in the router
...
- `link:../enums.adoc#TelnetTermOptions#method_setIntputrc[setIntputrc]`
- `link:../enums.adoc#SSHTermOptions#method_setIntputrc[setIntputrc]`
- `link:../enums.adoc#HttpTermOptions#method_setIntputrc[setIntputrc]`
...
A command is created by the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.command.CommandBuilder.html#method_command[CommandBuilder::command]` method: the command process handler is called
by the shell when the command is executed, this handler can be set with the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.command.CommandBuilder.html#method_processHandler[processHandler]`
method:
...
A command is registered until it is unregistered with the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.command.CommandRegistry.html#method_unregisterCommand[unregisterCommand]`.
...
The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.command.CommandProcess.html#method_args[args]` returns the command arguments:
...
The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.term.Tty.html#method_stdinHandler[stdinHandler]` handler is used to be notified when the terminal
...
A command can use the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.term.Tty.html#method_write[write]` to write to the standard output.
...
The current terminal size can be obtained using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.term.Tty.html#method_width[width]` and
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.term.Tty.html#method_height[height]`.
...
When the size of the terminal changes the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.term.Tty.html#method_resizehandler[resizehandler]`
is called, the new terminal size can be obtained with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.term.Tty.html#method_width[width]` and
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.term.Tty.html#method_height[height]`.
...
The terminal type is useful for sending escape codes to the remote terminal: `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.term.Tty.html#method_type[type]`
...
used in commands to scope data. A command can get the session with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.command.CommandProcess.html#method_session[session]`:
...
Calling `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.command.CommandProcess.html#method_end[end]` ends the current process. It can be called directly
...
The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.command.CommandProcess.html#method_interruptHandler[interruptHandler]` is called when the process
...
The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.command.CommandProcess.html#method_suspendHandler[suspendHandler]` is called when the process
...
The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.command.CommandProcess.html#method_resumeHandler[resumeHandler]` is called when the process
...
The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.command.CommandProcess.html#method_endHandler[endHandler]` (io.vertx.core.Handler)} is
...
The end handler is called even when the command invokes `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.command.CommandProcess.html#method_end[end]`.
...
Like the process handler, the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.command.CommandBuilder.html#method_completionHandler[completion
handler]` is non blocking because the implementation may use Vert.x services, e.g the file system.

The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.cli.Completion.html#method_lineTokens[lineTokens]` returns a list of `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.cli.CliToken.html[tokens]`
from the beginning of the line to the cursor position. The list can be empty if the cursor when the cursor is at the
beginning of the line.

The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.cli.Completion.html#method_rawLine[rawLine]` returns the current completed from the beginning
of the line to the cursor position, in raw format, i.e without any char escape performed.

Completion ends with a call to `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.cli.Completion.html#method_complete[complete]`.
...
In process shell session can be created with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.ShellServer.html#method_createShell[createShell]`:
...
The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.system.JobController.html#method_close[close]` closes the shell, it will terminate all jobs in the current shell
session.
...
Alternatively, an `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.AuthProvider.html[AuthProvider]` can be `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.term.TermServer.html#method_authProvider[set]`
...
The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.term.TermServer.html#method_createHttpTermServer[TermServer::createHttpTermServer]` method creates an HTTP term server, built
