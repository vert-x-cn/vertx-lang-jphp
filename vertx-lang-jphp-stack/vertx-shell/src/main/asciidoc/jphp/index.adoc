...
Vert.x Shell is a Vert.x Service and can be started programmatically via the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.ShellService.html[ShellService]`
...
The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.ShellService.html[ShellService]` takes care of starting an instance of Vert.x Shell.
...
The `link:../enums.adoc#TelnetTermOptions[TelnetTermOptions]` extends the Vert.x Core `NetServerOptions` as the Telnet server
...
These options can be created directly using directly `link:../../vertx-auth-common/enums.adoc#AuthOptions[AuthOptions]`:

- `link:../../vertx-auth-shiro/enums.adoc#ShiroAuthOptions[ShiroAuthOptions]` for Shiro
- `link:../../vertx-auth-jdbc/enums.adoc#JDBCAuthOptions[JDBCAuthOptions]` for JDBC
- `link:../../vertx-auth-mongo/enums.adoc#MongoAuthOptions[MongoAuthOptions]` for Mongo
...
Telnet terms are configured by `link:../enums.adoc#ShellServiceOptions#method_ShellServiceOptions[setTelnetOptions]`,
the `link:../enums.adoc#TelnetTermOptions[TelnetTermOptions]` extends the `link:../../vertx-core/enums.adoc#NetServerOptions[NetServerOptions]` so they
have the exact same configuration.

== SSH term configuration

SSH terms are configured by `link:../enums.adoc#ShellServiceOptions#method_ShellServiceOptions[setSSHOptions]`:

- `link:../enums.adoc#SSHTermOptions#method_SSHTermOptions[setPort]`: port
- `link:../enums.adoc#SSHTermOptions#method_SSHTermOptions[setHost]`: host
...
- `link:../enums.adoc#SSHTermOptions#method_SSHTermOptions[setAuthOptions]`: configures user authentication

The server key configuration reuses the key pair store configuration scheme provided by _Vert.x Core_:

- `link:../enums.adoc#SSHTermOptions#method_SSHTermOptions[setKeyPairOptions]`: set `.jks` key pair store
- `link:../enums.adoc#SSHTermOptions#method_SSHTermOptions[setPfxKeyPairOptions]`: set `.pfx` key pair store
- `link:../enums.adoc#SSHTermOptions#method_SSHTermOptions[setPemKeyPairOptions]`: set `.pem` key pair store
...
HTTP terms are configured by `link:../enums.adoc#ShellServiceOptions#method_ShellServiceOptions[setHttpOptions]`, the http options
extends the `link:../../vertx-core/enums.adoc#HttpServerOptions[HttpServerOptions]` so they expose the exact same configuration.

In addition there are extra options for configuring an HTTP term:

- `link:../enums.adoc#HttpTermOptions#method_HttpTermOptions[setAuthOptions]`: configures user authentication
- `link:../enums.adoc#HttpTermOptions#method_HttpTermOptions[setSockJSHandlerOptions]`: configures SockJS
- `link:../enums.adoc#HttpTermOptions#method_HttpTermOptions[setSockJSPath]`: the SockJS path in the router
...
- `link:../enums.adoc#TelnetTermOptions#method_TelnetTermOptions[setIntputrc]`
- `link:../enums.adoc#SSHTermOptions#method_SSHTermOptions[setIntputrc]`
- `link:../enums.adoc#HttpTermOptions#method_HttpTermOptions[setIntputrc]`
...
A command is created by the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.command.CommandBuilder.html#method_CommandBuilder[CommandBuilder::command]` method: the command process handler is called
by the shell when the command is executed, this handler can be set with the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.command.CommandBuilder.html#method_CommandBuilder[processHandler]`
method:
...
After a command is created, it needs to be registed to a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.command.CommandRegistry.html[CommandRegistry]`. The
command registry holds all the commands for a Vert.x instance.

A command is registered until it is unregistered with the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.command.CommandRegistry.html#method_CommandRegistry[unregisterCommand]`.
...
The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.command.CommandProcess.html[CommandProcess]` object can be used for interacting with the shell.

=== Command arguments

The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.command.CommandProcess.html#method_CommandProcess[args]` returns the command arguments:
...
Besides it is also possible to create commands using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.core.cli.CLI.html[Vert.x CLI]`: it makes easier to
...
When the command executes the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.command.CommandProcess.html[process]` is provided for interacting
with the shell. A `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.command.CommandProcess.html[CommandProcess]` extends `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.term.Tty.html[Tty]`
...
The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.term.Tty.html#method_Tty[stdinHandler]` handler is used to be notified when the terminal
...
A command can use the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.term.Tty.html#method_Tty[write]` to write to the standard output.
...
The current terminal size can be obtained using `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.term.Tty.html#method_Tty[width]` and
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.term.Tty.html#method_Tty[height]`.
...
When the size of the terminal changes the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.term.Tty.html#method_Tty[resizehandler]`
is called, the new terminal size can be obtained with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.term.Tty.html#method_Tty[width]` and
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.term.Tty.html#method_Tty[height]`.
...
The terminal type is useful for sending escape codes to the remote terminal: `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.term.Tty.html#method_Tty[type]`
...
used in commands to scope data. A command can get the session with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.command.CommandProcess.html#method_CommandProcess[session]`:
...
Calling `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.command.CommandProcess.html#method_CommandProcess[end]` ends the current process. It can be called directly
...
The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.command.CommandProcess.html#method_CommandProcess[interruptHandler]` is called when the process
...
The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.command.CommandProcess.html#method_CommandProcess[suspendHandler]` is called when the process
...
The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.command.CommandProcess.html#method_CommandProcess[resumeHandler]` is called when the process
...
The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.command.CommandProcess.html#method_CommandProcess[endHandler]` (io.vertx.core.Handler)} is
...
The end handler is called even when the command invokes `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.command.CommandProcess.html#method_CommandProcess[end]`.
...
Like the process handler, the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.command.CommandBuilder.html#method_CommandBuilder[completion
handler]` is non blocking because the implementation may use Vert.x services, e.g the file system.

The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.cli.Completion.html#method_Completion[lineTokens]` returns a list of `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.cli.CliToken.html[tokens]`
from the beginning of the line to the cursor position. The list can be empty if the cursor when the cursor is at the
beginning of the line.

The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.cli.Completion.html#method_Completion[rawLine]` returns the current completed from the beginning
of the line to the cursor position, in raw format, i.e without any char escape performed.

Completion ends with a call to `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.cli.Completion.html#method_Completion[complete]`.
...
When more flexibility is needed, a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.ShellServer.html[ShellServer]` can be used instead of the service.
...
In process shell session can be created with `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.ShellServer.html#method_ShellServer[createShell]`:
...
The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.term.Pty.html[Pty]` pseudo terminal is the main interface for interacting with the command
when it's running:

- uses standard input/output for writing or reading strings
- resize the terminal

The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.system.JobController.html#method_JobController[close]` closes the shell, it will terminate all jobs in the current shell
session.
...
A `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.term.Term.html[Term]` handler must be set on a term server before starting it. This handler will
handle each term when the user connects.

An `link:../../vertx-auth-common/enums.adoc#AuthOptions[AuthOptions]` can be set on `link:../enums.adoc#SSHTermOptions[SSHTermOptions]` and `link:../enums.adoc#HttpTermOptions[HttpTermOptions]`.
Alternatively, an `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.auth.AuthProvider.html[AuthProvider]` can be `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.term.TermServer.html#method_TermServer[set]`
directly on the term server before starting it.

=== SSH term

The terminal server `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.term.Term.html[Term]` handler accepts incoming terminal connections.
When a remote terminal connects, the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.term.Term.html[Term]` can be used to interact with connected
terminal.
...
The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.term.Term.html[Term]` is also a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.term.Tty.html[Tty]`, this section explains
how to use the tty.
...
The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.term.TermServer.html#method_TermServer[TermServer::createHttpTermServer]` method creates an HTTP term server, built
...
An HTTP term can start its own HTTP server, or it can reuse an existing Vert.x Web `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.web.Router.html[Router]`.
...
This is only valid for the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.ShellService.html[ShellService]`. `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.shell.ShellServer.html[ShellServer]`
