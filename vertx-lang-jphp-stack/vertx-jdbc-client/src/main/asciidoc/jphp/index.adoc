...
The first call to `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.jdbc.JDBCClient.html#method_JDBCClient[JDBCClient::createShared]`
...
In that case you can use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.jdbc.JDBCClient.html#method_JDBCClient[JDBCClient::createNonShared]`.
...
This is equivalent to calling `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.jdbc.JDBCClient.html#method_JDBCClient[JDBCClient::createShared]`
...
Once you've created a client you use `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.ext.sql.SQLClient.html#method_SQLClient[getConnection]` to get
a connection.
