...
The web client does not deprecate the Vert.x Core `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.http.HttpClient.html[HttpClient]`, indeed it is based on
this client and inherits its configuration and great features like pooling, HTTP/2 support, pipelining support, etc...
The `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.http.HttpClient.html[HttpClient]` should be used when fine grained control over the HTTP
requests/responses is necessary.

The web client does not provide a WebSocket API, the Vert.x Core `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.http.HttpClient.html[HttpClient]` should
...
`link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.http.HttpClient.html[HttpClient]`using Vert.x core, if you're not already.

== Creating a web client

You create an `link:https://vertx.okou.tk/phpdoc/vertx-web-client-jphp/classes/io.vertx.jphp.ext.web.client.WebClient.html[WebClient]` instance with default options as follows
...
Use `link:https://vertx.okou.tk/phpdoc/vertx-web-client-jphp/classes/io.vertx.jphp.ext.web.client.HttpRequest.html#method_sendBuffer[sendBuffer]` to send a buffer body
...
`link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.file.AsyncFile.html[AsyncFile]`is a ReadStream<Buffer>`) with the `link:https://vertx.okou.tk/phpdoc/vertx-web-client-jphp/classes/io.vertx.jphp.ext.web.client.HttpRequest.html#method_sendStream[sendStream]` method
...
use the `link:https://vertx.okou.tk/phpdoc/vertx-web-client-jphp/classes/io.vertx.jphp.ext.web.client.HttpRequest.html#method_sendJsonObject[sendJsonObject]`
...
In Java, Groovy or Kotlin, you can use the `link:https://vertx.okou.tk/phpdoc/vertx-web-client-jphp/classes/io.vertx.jphp.ext.web.client.HttpRequest.html#method_sendJson[sendJson]` method that maps
...
You can send http form submissions bodies with the `link:https://vertx.okou.tk/phpdoc/vertx-web-client-jphp/classes/io.vertx.jphp.ext.web.client.HttpRequest.html#method_sendForm[sendForm]`
variant.
...
If you want to upload files and send attributes, you can create a `link:https://vertx.okou.tk/phpdoc/vertx-web-common-jphp/classes/io.vertx.jphp.ext.web.multipart.MultipartForm.html[MultipartForm]` and
use `link:https://vertx.okou.tk/phpdoc/vertx-web-client-jphp/classes/io.vertx.jphp.ext.web.client.HttpRequest.html#method_sendMultipartForm[sendMultipartForm]`.
...
The headers are an instance of `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.MultiMap.html[MultiMap]` which provides operations for adding,
...
The `link:https://vertx.okou.tk/phpdoc/vertx-web-client-jphp/classes/io.vertx.jphp.ext.web.client.HttpRequest.html#method_send[send]` method can be called multiple times
safely, making it very easy to configure and reuse `link:https://vertx.okou.tk/phpdoc/vertx-web-client-jphp/classes/io.vertx.jphp.ext.web.client.HttpRequest.html[HttpRequest]` objects
...
Beware though that `link:https://vertx.okou.tk/phpdoc/vertx-web-client-jphp/classes/io.vertx.jphp.ext.web.client.HttpRequest.html[HttpRequest]` instances are mutable.
Therefore you should call the `link:https://vertx.okou.tk/phpdoc/vertx-web-client-jphp/classes/io.vertx.jphp.ext.web.client.HttpRequest.html#method_copy[copy]` method before modifying a cached instance.
...
You can set a timeout for a specific http request using `link:https://vertx.okou.tk/phpdoc/vertx-web-client-jphp/classes/io.vertx.jphp.ext.web.client.HttpRequest.html#method_timeout[timeout]`.
...
When the web client sends a request you always deal with a single async result `link:https://vertx.okou.tk/phpdoc/vertx-web-client-jphp/classes/io.vertx.jphp.ext.web.client.HttpResponse.html[HttpResponse]`.
...
WARNING: responses are fully buffered, use `link:https://vertx.okou.tk/phpdoc/vertx-web-common-jphp/classes/io.vertx.jphp.ext.web.codec.BodyCodec.html#method_pipe[BodyCodec::pipe]`
...
Custom response body decoding can be achieved using `link:https://vertx.okou.tk/phpdoc/vertx-web-common-jphp/classes/io.vertx.jphp.ext.web.codec.BodyCodec.html[BodyCodec]`:

* Plain String
* Json object
* Json mapped POJO
* `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.streams.WriteStream.html[WriteStream]`
...
Use `link:https://vertx.okou.tk/phpdoc/vertx-web-common-jphp/classes/io.vertx.jphp.ext.web.codec.BodyCodec.html#method_jsonObject[BodyCodec::jsonObject]` To decode a Json object:
...
When large response are expected, use the `link:https://vertx.okou.tk/phpdoc/vertx-web-common-jphp/classes/io.vertx.jphp.ext.web.codec.BodyCodec.html#method_pipe[BodyCodec::pipe]`.
This body codec pumps the response body buffers to a `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.streams.WriteStream.html[WriteStream]`
...
Finally if you are not interested at all by the response content, the `link:https://vertx.okou.tk/phpdoc/vertx-web-common-jphp/classes/io.vertx.jphp.ext.web.codec.BodyCodec.html#method_none[BodyCodec::none]`
...
By default the client follows redirections, you can configure the default behavior in the `link:../vertx-web-client-jphp/enums.adoc#WebClientOptions[WebClientOptions]`:
...
Vert.x web client can be configured to use HTTPS in exactly the same way as the Vert.x `link:https://vertx.okou.tk/phpdoc/vertx-jphp/classes/io.vertx.jphp.core.http.HttpClient.html[HttpClient]`.
