...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttServer.html[MqttServer]`instance is created and the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttServer.html#method_MqttServer[endpointHandler]` method is used to specify the handler called
when a remote client sends a CONNECT message for connecting to the server itself. The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttEndpoint.html[MqttEndpoint]`
...
Inside that handler, the _endpoint_ instance provides the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttEndpoint.html#method_MqttEndpoint[accept]` method
for replying to the remote client with the corresponding CONNACK message : in this way, the connection is established.
Finally, the server is started using the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttServer.html#method_MqttServer[listen]` method with
...
The same _endpoint_ instance provides the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttEndpoint.html#method_MqttEndpoint[disconnectHandler]`
...
In order to do that, the `link:../enums.adoc#MqttServerOptions[MqttServerOptions]` class provides the `link:../enums.adoc#MqttServerOptions#method_MqttServerOptions[setSsl]` method
...
`link:../enums.adoc#MqttServerOptions#method_MqttServerOptions[setKeyCertOptions]`method is used in order to
pass the certificates in PEM format. This method requires an instance of the possible implementations of the
`KeyCertOptions`interface and in this case the `link:../../vertx-core/enums.adoc#PemKeyCertOptions[PemKeyCertOptions]` class
is used in order to provide the path for the server certificate and the private key with the correspondent
`link:../enums.adoc#PemKeyCertOptions#method_PemKeyCertOptions[setCertPath]`and
`link:../enums.adoc#PemKeyCertOptions#method_PemKeyCertOptions[setKeyPath]`methods.
...
using the SUBSCRIBE message. The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttEndpoint.html[MqttEndpoint]` interface allows to specify an handler for the
incoming subscription request using the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttEndpoint.html#method_MqttEndpoint[subscribeHandler]` method.
Such handler receives an instance of the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.messages.MqttSubscribeMessage.html[MqttSubscribeMessage]` interface which brings
the list of topics with related QoS levels as desired by the client.
Finally, the endpoint instance provides the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttEndpoint.html#method_MqttEndpoint[subscribeAcknowledge]` method
...
In the same way, it's possible to use the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttEndpoint.html#method_MqttEndpoint[unsubscribeHandler]` method
...
an instance of the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.messages.MqttUnsubscribeMessage.html[MqttUnsubscribeMessage]` interface as parameter with the list of topics to unsubscribe.
Finally, the endpoint instance provides the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttEndpoint.html#method_MqttEndpoint[unsubscribeAcknowledge]` method
...
In order to handle incoming messages published by the remote client, the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttEndpoint.html[MqttEndpoint]` interface provides
the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttEndpoint.html#method_MqttEndpoint[publishHandler]` method for specifying the handler called
when the client sends a PUBLISH message. This handler receives an instance of the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.messages.MqttPublishMessage.html[MqttPublishMessage]`
...
available `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttEndpoint.html#method_MqttEndpoint[publishAcknowledge]` method.

If the QoS level is 2 (EXACTLY_ONCE), the endpoint needs to reply with a PUBREC message using the
available `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttEndpoint.html#method_MqttEndpoint[publishReceived]` method; in this case the same endpoint should handle
...
and it can do that specifying the handler through the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttEndpoint.html#method_MqttEndpoint[publishReleaseHandler]` method.
In order to close the QoS level 2 delivery, the endpoint can use the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttEndpoint.html#method_MqttEndpoint[publishComplete]` method
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttEndpoint.html#method_MqttEndpoint[publish]`method
...
in order to receive final acknowledge of delivery. It's possible using the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttEndpoint.html#method_MqttEndpoint[publishAcknowledgeHandler]` method
...
The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttEndpoint.html#method_MqttEndpoint[publishReceivedHandler]` method allows to specify
the handler for that. Inside that handler, the endpoint can use the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttEndpoint.html#method_MqttEndpoint[publishRelease]` method
...
as final acknowledge for the published message; it's possible using the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttEndpoint.html#method_MqttEndpoint[publishCompletionHandler]`
...
Even if there is no need for the high level application to handle that, the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttEndpoint.html[MqttEndpoint]` interface
provides the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttEndpoint.html#method_MqttEndpoint[pingHandler]` method for specifying an handler
...
The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttServer.html[MqttServer]` interface provides the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttServer.html#method_MqttServer[close]` method
...
to connect to passing instance of `link:../enums.adoc#MqttClientOptions[MqttClientOptions]` as a param through constructor.

This example shows how you could connect to a server and disconnect from it using Vert.x MQTT client
and calling `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttClient.html#method_MqttClient[connect]` and `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttClient.html#method_MqttClient[disconnect]` methods.
[source,php]
----
<?php
...
----
NOTE: default address of server provided by `link:../enums.adoc#MqttClientOptions[MqttClientOptions]` is localhost:1883 and localhost:8883 if you are using SSL/TSL.
...
Here we have the example of usage of `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttClient.html#method_MqttClient[subscribe]` method. In order to receive messages from rpi2/temp topic we call `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttClient.html#method_MqttClient[subscribe]` method.
...
As this example shows, handler could be provided via `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttClient.html#method_MqttClient[publishHandler]` method.

=== Publishing message to a topic

If you would like to publish some message into topic then `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttClient.html#method_MqttClient[publish]` should be called.
...
The right way to keep connection alive is a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttClient.html#method_MqttClient[ping]` method.

IMPORTANT: by default you client keep connections with server automatically. That means that you don't need to call `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttClient.html#method_MqttClient[ping]` in order to keep connections with server.
The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttClient.html[MqttClient]` will do it for you.

If you want to disable this feature then you should call `link:../enums.adoc#MqttClientOptions#method_MqttClientOptions[setAutoKeepAlive]` with {@code false} as argument:
[source,php]
----
<?php
...
+
You could provide handler by calling `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttClient.html#method_MqttClient[publishCompletionHandler]`. The handler will be called each time publish is completed.
