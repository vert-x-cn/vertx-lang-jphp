...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttServer.html[MqttServer]`instance is created and the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttServer.html#method_endpointHandler[endpointHandler]` method is used to specify the handler called
...
Inside that handler, the _endpoint_ instance provides the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttEndpoint.html#method_accept[accept]` method
for replying to the remote client with the corresponding CONNACK message : in this way, the connection is established.
Finally, the server is started using the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttServer.html#method_listen[listen]` method with
...
The same _endpoint_ instance provides the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttEndpoint.html#method_disconnectHandler[disconnectHandler]`
...
In order to do that, the `link:../enums.adoc#MqttServerOptions[MqttServerOptions]` class provides the `link:../enums.adoc#MqttServerOptions#method_setSsl[setSsl]` method
...
`link:../enums.adoc#MqttServerOptions#method_setKeyCertOptions[setKeyCertOptions]`method is used in order to
...
`link:../enums.adoc#PemKeyCertOptions#method_setCertPath[setCertPath]`and
`link:../enums.adoc#PemKeyCertOptions#method_setKeyPath[setKeyPath]`methods.
...
incoming subscription request using the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttEndpoint.html#method_subscribeHandler[subscribeHandler]` method.
...
Finally, the endpoint instance provides the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttEndpoint.html#method_subscribeAcknowledge[subscribeAcknowledge]` method
...
In the same way, it's possible to use the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttEndpoint.html#method_unsubscribeHandler[unsubscribeHandler]` method
...
Finally, the endpoint instance provides the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttEndpoint.html#method_unsubscribeAcknowledge[unsubscribeAcknowledge]` method
...
the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttEndpoint.html#method_publishHandler[publishHandler]` method for specifying the handler called
...
available `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttEndpoint.html#method_publishAcknowledge[publishAcknowledge]` method.

If the QoS level is 2 (EXACTLY_ONCE), the endpoint needs to reply with a PUBREC message using the
available `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttEndpoint.html#method_publishReceived[publishReceived]` method; in this case the same endpoint should handle
...
and it can do that specifying the handler through the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttEndpoint.html#method_publishReleaseHandler[publishReleaseHandler]` method.
In order to close the QoS level 2 delivery, the endpoint can use the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttEndpoint.html#method_publishComplete[publishComplete]` method
...
`link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttEndpoint.html#method_publish[publish]`method
...
in order to receive final acknowledge of delivery. It's possible using the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttEndpoint.html#method_publishAcknowledgeHandler[publishAcknowledgeHandler]` method
...
The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttEndpoint.html#method_publishReceivedHandler[publishReceivedHandler]` method allows to specify
the handler for that. Inside that handler, the endpoint can use the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttEndpoint.html#method_publishRelease[publishRelease]` method
...
as final acknowledge for the published message; it's possible using the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttEndpoint.html#method_publishCompletionHandler[publishCompletionHandler]`
...
provides the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttEndpoint.html#method_pingHandler[pingHandler]` method for specifying an handler
...
The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttServer.html[MqttServer]` interface provides the `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttServer.html#method_close[close]` method
...
and calling `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttClient.html#method_connect[connect]` and `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttClient.html#method_disconnect[disconnect]` methods.
[source,php]
----
<?php
...
Here we have the example of usage of `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttClient.html#method_subscribe[subscribe]` method. In order to receive messages from rpi2/temp topic we call `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttClient.html#method_subscribe[subscribe]` method.
...
As this example shows, handler could be provided via `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttClient.html#method_publishHandler[publishHandler]` method.

=== Publishing message to a topic

If you would like to publish some message into topic then `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttClient.html#method_publish[publish]` should be called.
...
The right way to keep connection alive is a `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttClient.html#method_ping[ping]` method.

IMPORTANT: by default you client keep connections with server automatically. That means that you don't need to call `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttClient.html#method_ping[ping]` in order to keep connections with server.
The `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttClient.html[MqttClient]` will do it for you.

If you want to disable this feature then you should call `link:../enums.adoc#MqttClientOptions#method_setAutoKeepAlive[setAutoKeepAlive]` with {@code false} as argument:
[source,php]
----
<?php
...
+
You could provide handler by calling `link:https://vertx.okou.tk/phpdoc/classes/io.vertx.jphp.mqtt.MqttClient.html#method_publishCompletionHandler[publishCompletionHandler]`. The handler will be called each time publish is completed.
